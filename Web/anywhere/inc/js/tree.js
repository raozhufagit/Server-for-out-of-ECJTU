...
var gz_postfix = "";
LoadScript('/anywhere/inc/js/ispirit.js');
LoadScript('/anywhere/inc/js/jquery/jquery.min.js' + gz_postfix);
LoadScript('/anywhere/inc/js/jquery/jquery-ui.custom.min.js' + gz_postfix);
LoadScript('/anywhere/inc/js/jquery/jquery.cookie.js' + gz_postfix);
LoadScript('/anywhere/inc/js/jquery/jquery.dynatree.min.js' + gz_postfix);

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="OutSchoolDemand.aspx.cs" Inherits="OutSchoolDemand_OutSchoolDemand" %>
     ...
     <table style="width: 100%" border="0" cellpadding="0" cellspacing="0">            
            <tr>
                ...
                <td align="right" valign="middle" style="border-bottom: #006633 1px dashed; height: 30px;">
					查询：<asp:TextBox ID="TextBox1" runat="server" Width="80px"></asp:TextBox><asp:ImageButton ID="ImageButton4" runat="server" ImageAlign="AbsMiddle" ImageUrl="../images/Button/BtnSerch.jpg"
                    ...
                    <asp:ImageButton ID="ImageButton5" runat="server" Visible="false" ImageAlign="AbsMiddle" ImageUrl="../images/Button/BtnModify.jpg"
        ...
        <table style="width: 100%">
            ...
            <td ><asp:GridView ID="GVData" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="DemandType" HeaderText="需求类型"  ></asp:BoundField>  
					<asp:BoundField DataField="DemandName"  HeaderText ="需求标题"    > </asp:BoundField>  
                    <asp:BoundField DataField="ID" HeaderText="需求ID"  ></asp:BoundField> 
                    <asp:BoundField DataField="PubCompany" HeaderText="发布单位"  ></asp:BoundField>     
					<asp:BoundField DataField="PubTime" HeaderText="发布时间"  ></asp:BoundField>   
                    <asp:BoundField DataField="DemandState" HeaderText="需求状态"  ></asp:BoundField>     
					<asp:BoundField DataField="Teacher" HeaderText="校内负责人" ></asp:BoundField> 
                    </Columns>

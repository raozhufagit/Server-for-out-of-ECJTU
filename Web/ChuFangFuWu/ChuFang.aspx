<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ChuFang.aspx.cs" Inherits="ChuFangFuWu_ChuFang" %>
     ...
     <table style="width: 100%" border="0" cellpadding="0" cellspacing="0">            
            <tr>
                ...
                <td align="right" valign="middle" style="border-bottom: #006633 1px dashed; height: 30px;">
                    ...
                    &nbsp;<asp:ImageButton ID="ImageButton2" runat="server" ImageUrl="../images/Button/BtnReport.jpg" ImageAlign="AbsMiddle" OnClick="ImageButton2_Click" /><img src="../images/Button/JianGe.jpg" /><img class="HerCss" onclick="javascript:window.history.go(-1)" src="../images/Button/BtnExit.jpg" />&nbsp;
            </tr>
        </table>
        
    </div>
          <p align="center"><asp:Label ID="Total" runat="server" Text="Label"></asp:Label></p>
        <table style="width: 100%">
            ...
            <td ><asp:GridView ID="GVData" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False"
                    ...
                    <Columns>
					  ...
					  <asp:TemplateField HeaderText="出访事件编号">
                                <ItemTemplate>
                                    <asp:HyperLink ID="HyperLink1" runat="server" Font-Underline="True" NavigateUrl='<%# "ChuFangView.aspx?ID="+ DataBinder.Eval(Container.DataItem, "ID")%>'><%# DataBinder.Eval(Container.DataItem, "ID")%></asp:HyperLink>
                                </ItemTemplate>
                            </asp:TemplateField>  
					<asp:BoundField DataField="LeadPerson" HeaderText="领队"  ></asp:BoundField>  
                    <asp:BoundField DataField="FlowPerson" HeaderText="随行人员"  ></asp:BoundField>     
					<asp:BoundField DataField="VisitDepartment" HeaderText="地点"  ></asp:BoundField>   
                    <asp:BoundField DataField="VisitDate" HeaderText="出访时间"  ></asp:BoundField>     
					<asp:BoundField DataField="VisitLenth" HeaderText="时长" ></asp:BoundField> 
                    <asp:BoundField DataField="VisitGoal" HeaderText="出访目的" ></asp:BoundField>              
                    <asp:BoundField DataField="ApprovalPerson" HeaderText="审批人员" ></asp:BoundField>
                    <asp:BoundField DataField="ApprovalOpinion" HeaderText="审批意见" ></asp:BoundField>
                     <asp:BoundField DataField="Visitstat" HeaderText="出访事件状态" ></asp:BoundField>
                    </Columns>
        ...
        <tr>
            <td style="border-top: #000000 1px solid;border-bottom: #000000 1px solid">
                ...
                行每页 &nbsp; 转到第<asp:TextBox ID="GoPage" runat="server" CssClass="TextBoxCssUnder2"
                    Height="20px" Width="33px" OnTextChanged="GoPage_TextChanged"></asp:TextBox>
                页&nbsp;

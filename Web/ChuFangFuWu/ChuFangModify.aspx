<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ChuFangModify.aspx.cs" Inherits="ChuFangFuWu_ChuFangModify" %>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td norwap="norwap" style="border-color: rgb(255, 0, 0); -ms-word-break: break-all;" class="auto-style13">
                            <asp:TextBox ID="RelationCOA" runat="server"  class="auto-style4"  ></asp:TextBox>
                        ...
                        <td norwap="norwap" class="auto-style6" style="border-color: rgb(255, 0, 0); -ms-word-break: break-all;">
                            <asp:TextBox ID="RelationCoPro" runat="server"  class="auto-style4" ></asp:TextBox>

...
public partial class GongGao_GongGaoAdd : System.Web.UI.Page
{
    ...
    protected void ImageButton1_Click(object sender, ImageClickEventArgs e)
    {
        ...
        if (Request.QueryString["Type"].ToString() != "单位")
        {
            Model.UserBuMen = LCX.Common.PublicMethod.GetSessionValue("Department");
        }
        else
        {
        ...
        LCX.Common.MessageBox.ShowAndRedirect(this, "公告通知信息添加成功！", "GongGao.aspx?Type=" + Request.QueryString["Type"].ToString());
    }

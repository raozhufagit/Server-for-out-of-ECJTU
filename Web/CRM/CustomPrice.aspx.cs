...
public partial class CRM_CustomPrice : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!Page.IsPostBack)
        {
            ...
            //设定按钮权限            
            ImageButton3.Visible = LCX.Common.PublicMethod.StrIFIn("|C013D|", LCX.Common.PublicMethod.GetSessionValue("QuanXian"));
            ImageButton2.Visible = LCX.Common.PublicMethod.StrIFIn("|C013E|", LCX.Common.PublicMethod.GetSessionValue("QuanXian"));
            DataBindToGridview();
        }
    }

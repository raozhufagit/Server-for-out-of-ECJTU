...
public partial class CRM_CustomAdd : System.Web.UI.Page
{
    ...
    {
        if (LCX.Common.PublicMethod.IFExists("CustomName", "LCXCustomInfo", 0, this.txtCustomName.Text) == true)
        {
            ...
            LCX.Common.MessageBox.ShowAndRedirect(this, "客户信息添加成功！", "MyCustom.aspx");
        }
        else
        {

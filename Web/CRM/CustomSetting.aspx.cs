...
public partial class CRM_CustomSetting : System.Web.UI.Page
{
    ...
    {
        GVData.DataSource = LCX.DBUtility.DbHelperSQL.GetDataTable("select * from LCXCrmSet where TableName='" + this.DropDownList1.SelectedItem.Value + "' and LieName='"+this.DropDownList2.SelectedItem.Value+"' order by ID desc");
    ...
    protected void GVData_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        if (e.CommandName == "Delete")
        {
            ...
            string SqlStr = "delete from LCXCrmSet where ID=" + ID.ToString();
    ...
    {
        string sqlstr = "update LCXCrmSet set CanShuName='"
    ...
    protected void ImageButton1_Click(object sender, ImageClickEventArgs e)
    {
        ...
        {
            LCX.DBUtility.DbHelperSQL.ExecuteSQL("insert into LCXCrmSet(TableName,LieName,CanShuName) values('" + this.DropDownList1.SelectedItem.Value + "','" + this.DropDownList2.SelectedItem.Value + "','" + this.TextBox1.Text + "')");
            LCX.Common.MessageBox.Show(this, "参数内容添加成功！");
            this.TextBox1.Text = "";
            DataBindToGridview();
        }
    }

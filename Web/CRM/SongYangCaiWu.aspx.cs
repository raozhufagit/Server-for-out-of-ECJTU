...
public partial class CRM_SongYangCaiWu : System.Web.UI.Page
{
    ...
    {
        LCX.DBUtility.DbHelperSQL.ExecuteSQL("update LCXSongYang set SongYangDanJia='" + this.txtSongYangDanJia.Text.Trim() + "',SongYangJinE='"+this.txtSongYangJinE.Text.Trim()+"' where ID="+Request.QueryString["ID"].ToString());
        ...
        LCX.Common.MessageBox.ShowAndRedirect(this, "送样记录财务信息输入成功！", "SongYang.aspx");
    }
}
<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MyCustomBack.aspx.cs" Inherits="CRM_MyCustomBack" %>
        ...
        <table style="width: 100%">
            ...
            <td ><asp:GridView ID="GVData" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="HuiFangType" HeaderText="回访类型" >
                        </asp:BoundField> 
                        <asp:BoundField DataField="HuiFangResult" HeaderText="回访结果" >
                        </asp:BoundField> 
                        <asp:BoundField DataField="HuiFangTime" HeaderText="回访时间" >
                        </asp:BoundField>                  
                    </Columns>
        ...
        <tr>
            <td style="border-top: #000000 1px solid;border-bottom: #000000 1px solid">
                ...
                <img align="absMiddle" src="../images/TreeImages/test.gif" /><asp:HyperLink ID="HyperLink2"
                    runat="server" Font-Bold="True" Font-Underline="True" ForeColor="Red" NavigateUrl="~/CRM/CustomBack.aspx?Type=Share">查看共享业务数据</asp:HyperLink></td>
        </tr>
        </table>
    </form>
</body>

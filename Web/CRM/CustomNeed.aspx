<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CustomNeed.aspx.cs" Inherits="CRM_CustomNeed" %>
            ...
            <td ><asp:GridView ID="GVData" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="JingZhengDuiShou" HeaderText="竞争对手" >
                         ...
                         <asp:BoundField DataField="UserName" HeaderText="所属业务员" >
                        </asp:BoundField>                 
                    </Columns>

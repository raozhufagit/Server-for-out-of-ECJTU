<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MyCustomLinkMan.aspx.cs" Inherits="CRM_MyCustomLinkMan" %>
    ...
    <div>    
     <table style="width: 100%" border="0" cellpadding="0" cellspacing="0">            
            <tr>
                ...
                <a class="hei" href="../Main/MyDesk.aspx">桌面</a>&nbsp;>>&nbsp;客户管理&nbsp;>>&nbsp;客户联系人
                </td>
                <td align="right" valign="middle" style="border-bottom: #006633 1px dashed; height: 30px;">
                    过滤条件：<asp:DropDownList ID="DropDownList1" runat="server">
                        ...
                        <asp:ListItem Value="SuoChuJiaoSe">所处角色</asp:ListItem>
                        <asp:ListItem Value="ZhiWu">职务</asp:ListItem>
                        <asp:ListItem Value="IFShare">共享人员</asp:ListItem>
                        <asp:ListItem Value="UserName">业务员</asp:ListItem>
                    </asp:DropDownList>
                    过滤内容：<asp:TextBox ID="TextBox1" runat="server" Height="20px" Width="65px"></asp:TextBox><img class="HerCss" onclick="var wName;var RadNum=Math.random();wName=window.showModalDialog('../Main/SelectCondition.aspx?GetType=My&TableName=LCXLinkMan&LieName='+document.getElementById('DropDownList1').value+'&Radstr='+RadNum,'','dialogWidth:350px;DialogHeight=400px;status:no;help:no;resizable:yes;');if(wName==null){}else{document.getElementById('TextBox1').value=wName;}"
            ...
            <td ><asp:GridView ID="GVData" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="CustomName" HeaderText="单位名称" >
                         ...
                         <asp:BoundField DataField="DanWeiChuanZhen" HeaderText="单位传真" >
                        </asp:BoundField> 
                         <asp:BoundField DataField="JiaTingZhuZhi" HeaderText="单位地址" >
                        </asp:BoundField> 
                        <asp:BoundField DataField="SuoChuJiaoSe" HeaderText="所处角色" >
                        </asp:BoundField> 
                        <asp:BoundField DataField="DanWieDianHua" HeaderText="单位电话" >
                        </asp:BoundField> 

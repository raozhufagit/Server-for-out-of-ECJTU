<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CustomInfo.aspx.cs" Inherits="CRM_CustomInfo" %>
<html>
	<head>
     ...
     <table style="width: 100%" border="0" cellpadding="0" cellspacing="0">            
        ...
        <tr>
            <td style="border-top: #000000 1px solid;border-bottom: #000000 1px solid">
                ...
                &nbsp;&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; 目的业务员：<asp:TextBox ID="TextBox4" runat="server"
                    Height="20px" Width="71px"></asp:TextBox><img
                     class="HerCss" onclick="var wName;var RadNum=Math.random();wName=window.showModalDialog('../Main/SelectUser.aspx?TableName=LCXUser&LieName=UserName&Radstr='+RadNum,'','dialogWidth:350px;DialogHeight=400px;status:no;help:no;resizable:yes;');if(wName==null){}else{document.getElementById('TextBox4').value=wName;}"
                     src="../images/Button/search.gif" />
                <img src="../images/TreeImages/@sms.gif" /><asp:LinkButton ID="LinkButton1" runat="server"
                    Font-Bold="True" ForeColor="Red" OnClick="LinkButton1_Click" OnClientClick="javascript:return CheckDel1();">客户批量转移</asp:LinkButton></td>
        </tr>
        </table>
    </form>
</body>

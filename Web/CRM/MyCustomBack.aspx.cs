...
public partial class CRM_MyCustomBack : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!Page.IsPostBack)
        {
            ...
            DataBindToGridview();
            //设定按钮权限            
            ImageButton1.Visible = LCX.Common.PublicMethod.StrIFIn("|C007A|", LCX.Common.PublicMethod.GetSessionValue("QuanXian"));
            ImageButton5.Visible = LCX.Common.PublicMethod.StrIFIn("|C007M|", LCX.Common.PublicMethod.GetSessionValue("QuanXian"));
            ImageButton3.Visible = LCX.Common.PublicMethod.StrIFIn("|C007D|", LCX.Common.PublicMethod.GetSessionValue("QuanXian"));
            ImageButton2.Visible = LCX.Common.PublicMethod.StrIFIn("|C007E|", LCX.Common.PublicMethod.GetSessionValue("QuanXian"));
        }
    }
    /// <summary>
    ...
    {
        LCX.BLL.LCXC_FeedBack MyModel = new LCX.BLL.LCXC_FeedBack();
    ...
    protected void ImageButton3_Click(object sender, ImageClickEventArgs e)
    {
        ...
        if (LCX.DBUtility.DbHelperSQL.ExecuteSQL("delete from LCXC_FeedBack where ID in (" + IDlist + ")") == -1)
        {
    ...
    protected void ImageButton2_Click(object sender, ImageClickEventArgs e)
    {
        ...
        LCX.Common.DataToExcel.GridViewToExcel(LCX.DBUtility.DbHelperSQL.GetDataSet("select CustomName,HuiFangTitle,HuiFangType,HuiFangResult,HuiFangTime from LCXC_FeedBack where ID in (" + IDList + ") order by ID desc"), MyTable, "Excel报表");
    }

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TechnologyPurchaseMange.aspx.cs" Inherits="TechnologyPurchase_TechnologyPurchaseMange" %>
<html>
	<head>
    ...
    <div>    
     <table style="width: 100%" border="0" cellpadding="0" cellspacing="0">            
            <tr>
                ...
                <a class="hei" href="../Main/MyDesk.aspx">桌面</a>&nbsp;>>&nbsp;技术求购信息管理&nbsp;>>&nbsp;技术求购信息
                </td>
        ...
        <table style="width: 100%">
            ...
            <td ><asp:GridView ID="GVData" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="求购技术名">
                            <ItemTemplate>                                
                                <asp:HyperLink ID="HyperLink1" runat="server" Font-Underline="True"
                                    NavigateUrl='<%# "TechnologyPurchaseView.aspx?ID="+ DataBinder.Eval(Container.DataItem, "ID")%>'><%# DataBinder.Eval(Container.DataItem, "TechnologyName")%></asp:HyperLink>
                            </ItemTemplate>                            
                            <ItemStyle HorizontalAlign="Left" />
                        
                        </asp:TemplateField> 
                        <asp:BoundField DataField="PubCompany" HeaderText="求购单位名称" >
                        </asp:BoundField>  
                        <asp:BoundField DataField="TechnologyType" HeaderText="求购技术类型" >
                        </asp:BoundField> 
                        <asp:BoundField DataField="PubTime" HeaderText="求购信息发布时间" >
                        </asp:BoundField> 
                        <asp:BoundField DataField="RequiredProfession" HeaderText="要求专业" >
                        </asp:BoundField>     
                        <asp:BoundField DataField="TechnologyPurchaseState" HeaderText="求购信息状态" >
                        </asp:BoundField>  
                    </Columns>

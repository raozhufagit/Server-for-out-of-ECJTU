<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TechnologyPurchaseModify.aspx.cs" Inherits="TechnologyPurchase_TechnologyPurchaseModify" %>
<html>
	<head>
...
<table style="width: 100%" bgcolor="#999999" border="0" cellpadding="2" cellspacing="1">
	...
	<td style="padding-left: 5px; height: 25px; background-color: #ffffff" >
		<asp:TextBox id="TechnologyName" runat="server" Width="241px"></asp:TextBox>
        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="TechnologyName"
	...
	<td style="padding-left: 5px; background-color: #ffffff" class="auto-style3" >
		<asp:DropDownList ID="TechnologyType" runat="server" CssClass="auto-style1" Height="35px" Width="241px">
	...
	<td style="padding-left: 5px; height: 25px; background-color: #ffffff" >
		<asp:TextBox id="TechnologyDetail" runat="server" Width="245px" Height="90px" TextMode="MultiLine"></asp:TextBox>&nbsp;
	    <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ControlToValidate="TechnologyDetail"

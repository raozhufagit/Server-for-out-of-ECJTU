<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PublicSeal.aspx.cs" Inherits="WorkFlow_PublicSeal" %>
<html>
	<head>
    ...
    <div>    
     <table style="width: 100%" border="0" cellpadding="0" cellspacing="0">            
            <tr>
                ...
                <a class="hei" href="../Main/MyDesk.aspx">桌面</a>&nbsp;>>&nbsp;审批流程&nbsp;>>&nbsp;<%=Request.QueryString["Type"].ToString() %>
                </td>
                        ...
                        <asp:TemplateField HeaderText="印章名称">
                            <ItemTemplate>                                
                                <asp:HyperLink ID="HyperLink1" runat="server" Font-Underline="True"
                                    NavigateUrl='<%# "YinZhangView.aspx?ID="+ DataBinder.Eval(Container.DataItem, "ID")%>'><%# DataBinder.Eval(Container.DataItem, "YinZhangName")%></asp:HyperLink>
                            </ItemTemplate>                            
                            <ItemStyle HorizontalAlign="Left" />
                        </asp:TemplateField>                       
                         <asp:BoundField DataField="YinZhangLeiBie" HeaderText="印章类别" >
                        </asp:BoundField>  

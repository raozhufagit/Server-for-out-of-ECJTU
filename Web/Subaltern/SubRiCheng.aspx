<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SubRiCheng.aspx.cs" Inherits="Subaltern_SubRiCheng" %>
<html>
	<head>
		<title>磊创科技企业综合管理平台</title>
    ...
    <div>    
     <table style="width: 100%" border="0" cellpadding="0" cellspacing="0">            
            <tr>
                ...
                <a class="hei" href="../Main/MyDesk.aspx">桌面</a>&nbsp;>>&nbsp;下属日程安排
                </td>
                <td align="right" valign="middle" style="border-bottom: #006633 1px dashed; height: 30px;">
                    ...
                    <asp:ImageButton
                        ...
                        OnClick="ImageButton4_Click" />&nbsp;&nbsp;<asp:ImageButton ID="ImageButton3" runat="server"
                            ...
                            OnClientClick="javascript:return CheckDel();" />&nbsp;
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="主题">
                            <ItemTemplate><asp:HyperLink ID="HyperLink1" runat="server" Font-Underline="True"
                                    NavigateUrl='<%# "../Work/RiChengView.aspx?ID="+ DataBinder.Eval(Container.DataItem, "ID")%>'><%# DataBinder.Eval(Container.DataItem, "TitleStr")%></asp:HyperLink>
                            </ItemTemplate>                            
                            <ItemStyle HorizontalAlign="Left" />
                        </asp:TemplateField> 
                        <asp:BoundField DataField="TypeStr" HeaderText="类型">
                            
                        </asp:BoundField>                
                        
                        <asp:BoundField DataField="GongXiangWho" HeaderText="当前状态">
                        ...
                        <asp:BoundField DataField="TimeTiXing" HeaderText="提醒时间" >

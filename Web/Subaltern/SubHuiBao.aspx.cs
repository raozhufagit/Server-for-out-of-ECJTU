...
public partial class Subaltern_SubHuiBao : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!Page.IsPostBack)
        {
            ...
            //设定按钮权限
            ImageButton3.Visible = LCX.Common.PublicMethod.StrIFIn("|137D|", LCX.Common.PublicMethod.GetSessionValue("QuanXian"));
            ImageButton2.Visible = LCX.Common.PublicMethod.StrIFIn("|137E|", LCX.Common.PublicMethod.GetSessionValue("QuanXian"));
        }
    }

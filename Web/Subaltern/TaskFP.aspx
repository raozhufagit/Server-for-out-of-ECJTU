<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TaskFP.aspx.cs" Inherits="Subaltern_TaskFP" %>
<html>
	<head>
    ...
    <div>    
     <table style="width: 100%" border="0" cellpadding="0" cellspacing="0">            
            <tr>
                ...
                <a class="hei" href="../Main/MyDesk.aspx">桌面</a>&nbsp;>>&nbsp;任务分配
                </td>
        ...
        <table style="width: 100%">
            ...
            <td ><asp:GridView ID="GVData" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False"
					...
					<asp:TemplateField HeaderText="任务标题"> <ItemTemplate> <asp:HyperLink ID="HyperLink1" runat="server" Font-Underline="True" NavigateUrl='<%# "TaskFPView.aspx?ID="+ DataBinder.Eval(Container.DataItem, "ID")%>'><%# DataBinder.Eval(Container.DataItem, "TaskTitle")%></asp:HyperLink> 
					
					<asp:HyperLink ID="HyperLink3" runat="server" Font-Underline="True" ForeColor="Blue"
                                    NavigateUrl='<%# "TaskPS.aspx?ID="+ DataBinder.Eval(Container.DataItem, "ID") %>'>[任务批示]</asp:HyperLink>

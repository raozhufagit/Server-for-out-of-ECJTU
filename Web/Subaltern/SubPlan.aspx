<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SubPlan.aspx.cs" Inherits="Subaltern_SubPlan" %>
<html>
	<head>
    ...
    <div>    
     <table style="width: 100%" border="0" cellpadding="0" cellspacing="0">            
            <tr>
                ...
                <a class="hei" href="../Main/MyDesk.aspx">桌面</a>&nbsp;>>&nbsp;工作计划&nbsp;>>&nbsp;下属计划
                </td>
                        ...
                        <asp:TemplateField HeaderText="计划主题">
                            <ItemTemplate>                                
                                <asp:HyperLink ID="HyperLink1" runat="server" Font-Underline="True"
                                    NavigateUrl='<%# "../WorkPlan/WorkPlanView.aspx?ID="+ DataBinder.Eval(Container.DataItem, "ID")%>'><%# DataBinder.Eval(Container.DataItem, "TitleStr")%></asp:HyperLink>
                            </ItemTemplate>                            

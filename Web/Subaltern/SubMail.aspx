<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SubMail.aspx.cs" Inherits="Subaltern_SubMail" %>
<html>
	<head>
    ...
    <div>    
     <table style="width: 100%" border="0" cellpadding="0" cellspacing="0">            
            <tr>
                ...
                <a class="hei" href="../Main/MyDesk.aspx">桌面</a>&nbsp;>>&nbsp;内部邮件&nbsp;>>&nbsp;下属邮件
                </td>
                <td align="right" valign="middle" style="border-bottom: #006633 1px dashed; height: 30px;">
                    主题：<asp:TextBox ID="TextBox1" runat="server" Height="20px" Width="60px"></asp:TextBox>
                    用户：<asp:TextBox
                    ...
                    状态：<asp:TextBox ID="TextBox3" runat="server" Height="20px" Width="60px"></asp:TextBox><img
                        ...
                        <asp:TemplateField HeaderText="邮件主题">
                            <ItemTemplate>
                                <asp:HyperLink ID="HyperLink1" runat="server" Font-Underline="True"
                                    NavigateUrl='<%# "../LanEmail/EmailView.aspx?ID="+ DataBinder.Eval(Container.DataItem, "ID")%>'><%# DataBinder.Eval(Container.DataItem, "EmailTitle")%></asp:HyperLink>
                            </ItemTemplate>
                            <ItemStyle HorizontalAlign="Left" />
                        </asp:TemplateField>
                        <asp:BoundField DataField="ToUser" HeaderText="用户名" >                           

...
public partial class Subaltern_SubCustom : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!Page.IsPostBack)
        {
            ...
            //设定按钮权限            
            ImageButton3.Visible = LCX.Common.PublicMethod.StrIFIn("|139D|", LCX.Common.PublicMethod.GetSessionValue("QuanXian"));
            ImageButton2.Visible = LCX.Common.PublicMethod.StrIFIn("|139E|", LCX.Common.PublicMethod.GetSessionValue("QuanXian"));
    ...
    protected void ImageButton2_Click(object sender, ImageClickEventArgs e)
    {
        ...
        LCX.Common.DataToExcel.GridViewToExcel(LCX.DBUtility.DbHelperSQL.GetDataSet("select CustomName,CustomSerils,ChargeMan,TelStr,XingZhi,LaiYuan,QuYu,ZhuangTai,LeiBie,JiBie,HangYe,TimeStr from LCXCustomInfo where ID in (" + IDList + ") order by ID desc"), MyTable, "Excel报表");
    }
}
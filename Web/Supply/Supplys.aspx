<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Supplys.aspx.cs" Inherits="Supply_Supplys" %>
<html>
	<head>
    ...
    <div>    
     <table style="width: 100%" border="0" cellpadding="0" cellspacing="0">            
            <tr>
                ...
                <a class="hei" href="../Main/MyDesk.aspx">桌面</a>&nbsp;>>&nbsp;供应商管理&nbsp;>>&nbsp;供应商管理
                </td>
        ...
        <table style="width: 100%">
            ...
            <td ><asp:GridView ID="GVData" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="供应商名称">
                            <ItemTemplate>                                
                                <asp:HyperLink ID="HyperLink1" runat="server" Font-Underline="True"
                                    NavigateUrl='<%# "SupplysView.aspx?ID="+ DataBinder.Eval(Container.DataItem, "ID")%>'><%# DataBinder.Eval(Container.DataItem, "SupplysName")%></asp:HyperLink>
                            </ItemTemplate>                            
                            <ItemStyle HorizontalAlign="Left" />
                        </asp:TemplateField>                       
                         <asp:BoundField DataField="Serils" HeaderText="供应商编码" >
                        </asp:BoundField>                             
                        ...
                        <asp:BoundField DataField="ChuanZhen" HeaderText="传真号码" >
                        </asp:BoundField>  
                        <asp:BoundField DataField="DiQu" HeaderText="地区" >
                        </asp:BoundField>               
                    </Columns>

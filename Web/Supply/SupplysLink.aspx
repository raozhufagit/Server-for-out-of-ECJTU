<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SupplysLink.aspx.cs" Inherits="Supply_SupplysLink" %>
    ...
    <div>    
     <table style="width: 100%" border="0" cellpadding="0" cellspacing="0">            
            <tr>
                ...
                <a class="hei" href="../Main/MyDesk.aspx">桌面</a>&nbsp;>>&nbsp;供应商管理&nbsp;>>&nbsp;供应商联系人
                </td>
        ...
        <table style="width: 100%">
            ...
            <td ><asp:GridView ID="GVData" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="联系人名称">
                            <ItemTemplate>                                
                                <asp:HyperLink ID="HyperLink1" runat="server" Font-Underline="True"
                                    NavigateUrl='<%# "SupplyLinkView.aspx?ID="+ DataBinder.Eval(Container.DataItem, "ID")%>'><%# DataBinder.Eval(Container.DataItem, "LinkManName")%></asp:HyperLink>
                            </ItemTemplate>                            
                            <ItemStyle HorizontalAlign="Left" />
                        </asp:TemplateField>                       
                         <asp:BoundField DataField="SupplysName" HeaderText="供应商名称" >
                        </asp:BoundField>                             
                        <asp:BoundField DataField="ZhiWei" HeaderText="职位" >
                        </asp:BoundField>  
                        <asp:BoundField DataField="Sex" HeaderText="性别" >
                        </asp:BoundField>                                
                        <asp:BoundField DataField="IFFirstLink" HeaderText="传真" >
                        </asp:BoundField>  
                        <asp:BoundField DataField="JobTel" HeaderText="工作电话" >
                        </asp:BoundField>  
                        <asp:BoundField DataField="MobTel" HeaderText="手机号码" >
                        </asp:BoundField>     
                        <asp:BoundField DataField="QQorMsn" HeaderText="QQ/MSN" >
                        </asp:BoundField>             
                    </Columns>

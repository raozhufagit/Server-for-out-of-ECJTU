<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SupplysAdd.aspx.cs" Inherits="Supply_SupplysAdd" %>
<html>
	<head>
    ...
    <div>    
     <table id="PrintHide" style="width: 100%" border="0" cellpadding="0" cellspacing="0">            
            <tr>
                ...
                <a class="hei" href="../Main/MyDesk.aspx">桌面</a>&nbsp;>>&nbsp;供应商管理&nbsp;>>&nbsp;添加供应商信息
                </td>

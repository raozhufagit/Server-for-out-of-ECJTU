...
public partial class Supply_FK : System.Web.UI.Page
{
    ...
    public void DataBindToGridview()
    {
        ...
        var T = context.LCXRecive.Where(p => p.ID > 0 && p.NowState == "F");
    ...
    protected void ImageButton5_Click(object sender, ImageClickEventArgs e)
    {
        ...
        Response.Redirect("FKModify.aspx?ID=" + CheckStrArray[0].ToString());
    }
}
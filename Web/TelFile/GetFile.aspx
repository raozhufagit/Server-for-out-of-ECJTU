<%@ Page Language="C#" AutoEventWireup="true" CodeFile="GetFile.aspx.cs" Inherits="TelFile_GetFile" %>
<html>
	<head>
    ...
    <div>    
     <table style="width: 100%" border="0" cellpadding="0" cellspacing="0">            
            <tr>
                ...
                <a class="hei" href="../Main/MyDesk.aspx">桌面</a>&nbsp;>>&nbsp;公文收发&nbsp;>>&nbsp;接收文件
                    &nbsp;
            ...
            <td ><asp:GridView ID="GVData" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="签收状态">                            
                            ...
                            <ItemTemplate>
                                <asp:Label ID="Label111" runat="server" Text='<%# Bind("YiJieShouRen") %>'></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
                    </Columns>

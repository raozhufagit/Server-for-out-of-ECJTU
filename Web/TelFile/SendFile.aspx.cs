...
public partial class TelFile_SendFile : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!Page.IsPostBack)
        {
            ...
            //设定按钮权限
            ImageButton1.Visible = LCX.Common.PublicMethod.StrIFIn("|102A|", LCX.Common.PublicMethod.GetSessionValue("QuanXian"));
            ImageButton3.Visible = LCX.Common.PublicMethod.StrIFIn("|102D|", LCX.Common.PublicMethod.GetSessionValue("QuanXian"));
            ImageButton2.Visible = LCX.Common.PublicMethod.StrIFIn("|102E|", LCX.Common.PublicMethod.GetSessionValue("QuanXian"));
        }
    }
    ...
    public void DataBindToGridview()
    {
        ...
        GVData.DataSource = MyLCXTelFile.GetList("TitleStr like '%" + this.TextBox1.Text.Trim() + "%' and FromUser='" + LCX.Common.PublicMethod.GetSessionValue("UserName") + "' and " + GetDicNameCondition() + " order by ID desc");
        GVData.DataBind();
    ...
    protected void ImageButton3_Click(object sender, ImageClickEventArgs e)
    {
        ...
        if (LCX.DBUtility.DbHelperSQL.ExecuteSQL("delete LCXTelFile where ID in (" + IDlist + ")") == -1)
        {

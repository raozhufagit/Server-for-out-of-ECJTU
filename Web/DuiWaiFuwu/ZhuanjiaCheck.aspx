<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ZhuanjiaCheck.aspx.cs" Inherits="DuiWaiFuwu_ZhuanjiaCheck" %>
    ...
    <div>
        ...
        <table style="width: 1000px" bgcolor="#999999" border="0" cellpadding="2" cellspacing="1">
            ...
            <tr>
                ...
                <td style="padding-left: 5px; height: 25px; background-color: #ffffff">
                    <asp:Label ID="lblStates" runat="server" Width="145px"></asp:Label>
            ...
            <tr>
             ...
             <tr>
                ...
                <td style="padding-left: 5px; height: 25px; background-color: #ffffff" colspan="5">
                    <asp:TextBox ID="txtCheckAdvision" runat="server" Width="100%" Rows="3" TextMode="MultiLine"></asp:TextBox>

...
public partial class DuiWaiFuwu_LCXScientificResearchModify : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!Page.IsPostBack)
        {
            ...
            {
                LCX.Common.MessageBox.ShowAndRedirect(this, "审核过后的科研信息不能修改！", "LCXScientificResearch.aspx");
                return;
            }
        }
    }

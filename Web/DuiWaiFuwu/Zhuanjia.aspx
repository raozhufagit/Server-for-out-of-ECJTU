<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Zhuanjia.aspx.cs" Inherits="DuiWaiFuwu_Zhuanjia" %>
<html>
	<head>
    ...
    <div>    
     <table style="width: 100%" border="0" cellpadding="0" cellspacing="0">            
            <tr>
                ...
                <a class="hei" href="../Main/MyDesk.aspx">桌面</a>&nbsp;>>&nbsp;专家信息
                </td>
                <td align="right" valign="middle" style="border-bottom: #006633 1px dashed; height: 30px;">
					查询：<asp:DropDownList ID="DropDownList2" runat="server">
					<asp:ListItem Value="XingMing">专家姓名</asp:ListItem>
        ...
        <table style="width: 100%">
            ...
            <td ><asp:GridView ID="GVData" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False"
					...
					<asp:TemplateField HeaderText="专家姓名"> <ItemTemplate> <asp:HyperLink ID="HyperLink1" runat="server" Font-Underline="True" NavigateUrl='<%# "ZhuanjiaView.aspx?ID="+ DataBinder.Eval(Container.DataItem, "ID")%>'><%# DataBinder.Eval(Container.DataItem, "XingMing")%></asp:HyperLink> </ItemTemplate>   <ItemStyle HorizontalAlign="Left" />  </asp:TemplateField> 
					<asp:BoundField DataField="BuMen" HeaderText="部门" ></asp:BoundField>     
					<asp:BoundField DataField="XueKe" HeaderText="学科"  ></asp:BoundField> 
                    <asp:BoundField DataField="ZhiWu" HeaderText="职务" ></asp:BoundField> 
                    <asp:BoundField DataField="YanJiuLingYu" HeaderText="研究领域" ></asp:BoundField>     
					<asp:BoundField DataField="ZhiCheng" HeaderText="职称"  ></asp:BoundField>

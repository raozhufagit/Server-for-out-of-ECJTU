<%@ Page Language="C#" AutoEventWireup="true" CodeFile="LCXEquipmentRent.aspx.cs" Inherits="DuiWaiFuwu_LCXEquipmentRent" %>
    ...
    <div>    
     <table style="width: 100%" border="0" cellpadding="0" cellspacing="0">            
            <tr>
                ...
                <a class="hei" href="../Main/MyDesk.aspx">桌面</a>&nbsp;>>&nbsp;对外服务信息&nbsp;>>&nbsp;设备仪器租借记录
                </td>
                <td align="right" valign="middle" style="border-bottom: #006633 1px dashed; height: 30px;">
					查询：<asp:TextBox ID="TextBox3" runat="server" Width="80px"></asp:TextBox><asp:ImageButton ID="ImageButton4" runat="server" ImageAlign="AbsMiddle" ImageUrl="../images/Button/BtnSerch.jpg"
        ...
        <table style="width: 100%">
            ...
            <td ><asp:GridView ID="GVData" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False"
					...
					<asp:TemplateField HeaderText="设备名称"> <ItemTemplate> <asp:HyperLink ID="HyperLink1" runat="server" Font-Underline="True" NavigateUrl='<%# "LCXEquipmentRentView.aspx?ID="+ DataBinder.Eval(Container.DataItem, "ID")%>'><%# DataBinder.Eval(Container.DataItem, "EquipmentName")%></asp:HyperLink> </ItemTemplate>   <ItemStyle HorizontalAlign="Left" />  </asp:TemplateField> 
					<asp:BoundField DataField="EquipmentNo" HeaderText="设备编号" ></asp:BoundField>     
					<asp:BoundField DataField="BorrowType" HeaderText="租借类型"  ></asp:BoundField> 
                    
                    <asp:BoundField DataField="BorrowDept" HeaderText="租借单位" ></asp:BoundField>     
                    ...
                    <asp:BoundField DataField="EndTime" HeaderText="结束时间"  DataFormatString="{0:yyyy-MM-dd}"></asp:BoundField>
                         <asp:BoundField DataField="SubTime" HeaderText="提交时间"   DataFormatString="{0:yyyy-MM-dd}">

                        </asp:BoundField> 
                        <asp:BoundField DataField="States" HeaderText="申请状态" HeaderStyle-Width="100px"></asp:BoundField>
                        <asp:BoundField DataField="RentStates" HeaderText="归还登记" HeaderStyle-Width="100px"></asp:BoundField>
					</Columns>

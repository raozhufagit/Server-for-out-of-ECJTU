<%@ Page Language="C#" AutoEventWireup="true" CodeFile="LCXEquipment.aspx.cs" Inherits="DuiWaiFuwu_LCXEquipment" %>
     ...
     <table style="width: 100%" border="0" cellpadding="0" cellspacing="0">            
            <tr>
                ...
                <td align="right" valign="middle" style="border-bottom: #006633 1px dashed; height: 30px;">
					...
					<asp:ListItem Value="EquipmentName">设备名称</asp:ListItem>
					<asp:ListItem Value="EquipmentNo">设备编号</asp:ListItem>
					
					<asp:ListItem Value="EquipmentType">设备类别</asp:ListItem>
					
					<asp:ListItem Value="FactoryNo">出厂编号</asp:ListItem>
					<asp:ListItem Value="BelongDept">所属部门</asp:ListItem>
					<asp:ListItem Value="FactoryName">生产厂家</asp:ListItem>
					<asp:ListItem Value="Manager">管理人</asp:ListItem>
					<asp:ListItem Value="Checker">核对人</asp:ListItem>
        ...
        <table style="width: 100%">
            ...
            <td ><asp:GridView ID="GVData" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False"
					...
					<asp:TemplateField HeaderText="设备名称"> <ItemTemplate> <asp:HyperLink ID="HyperLink1" runat="server" Font-Underline="True" NavigateUrl='<%# "LCXEquipmentView.aspx?ID="+ DataBinder.Eval(Container.DataItem, "ID")%>'><%# DataBinder.Eval(Container.DataItem, "EquipmentName")%></asp:HyperLink> </ItemTemplate>   <ItemStyle HorizontalAlign="Left" />  </asp:TemplateField> 
					<asp:BoundField DataField="EquipmentNo" HeaderText="设备编号" ></asp:BoundField>   
					<asp:BoundField DataField="EquipmentModel" HeaderText="型号" ></asp:BoundField>     
					     
					<asp:BoundField DataField="FactoryNo" HeaderText="出厂编号" ></asp:BoundField>  
					<asp:BoundField DataField="StoragePosition" HeaderText="存放位置" ></asp:BoundField>     
					<asp:BoundField DataField="Manager" HeaderText="管理人" ></asp:BoundField>  
					<asp:BoundField DataField="CheckStates" HeaderText="设备状态" HeaderStyle-Width="100px"></asp:BoundField>     
					<asp:BoundField DataField="EquipStates" HeaderText="租赁状态" HeaderStyle-Width="100px"></asp:BoundField>
</Columns>

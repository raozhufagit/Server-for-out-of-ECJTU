...
public partial class DuiWaiFuwu_LCXInnovationPlat : System.Web.UI.Page
{
    ...
    {
        LCX.BLL.LCXInnovationPlat MyModel = new LCX.BLL.LCXInnovationPlat();
    ...
    {
        Response.Redirect("LCXInnovationPlatAdd.aspx");
    }
    protected void ImageButton3_Click(object sender, ImageClickEventArgs e)
    {
        string IDlist = LCX.Common.PublicMethod.CheckCbx(this.GVData, "CheckSelect", "LabVisible");
        if (LCX.DBUtility.DbHelperSQL.ExecuteSQL("delete from LCXInnovationPlat where ID in (" + IDlist + ")") == -1)
        {
        ...
        else
        {
            ...
            MyRiZhi.DoSomething = "用户删除创新平台信息";
    ...
    protected void ImageButton2_Click(object sender, ImageClickEventArgs e)
    {
        ...
        MyTable.Add("PlatFormName", "平台名称");
        MyTable.Add("Manager", "负责人");
        MyTable.Add("TeacherGroup", "教师队伍");
        MyTable.Add("ResearchFind", "研究成果");
        MyTable.Add("TeamIntr", "团队介绍");
        MyTable.Add("ServiceContent", "对外服务");
        MyTable.Add("Remarks", "备注");
       

        LCX.Common.DataToExcel.GridViewToExcel(LCX.DBUtility.DbHelperSQL.GetDataSet("select  PlatFormName,Manager,TeacherGroup,ResearchFind,TeamIntr,ServiceContent,Remarks LCXInnovationPlat where ID in (" + IDList + ") order by ID desc"), MyTable, "Excel报表");
    }
    protected void ImageButton5_Click(object sender, ImageClickEventArgs e)
    {
        string CheckStr = LCX.Common.PublicMethod.CheckCbx(this.GVData, "CheckSelect", "LabVisible");
        string[] CheckStrArray = CheckStr.Split(',');
        Response.Redirect("LCXInnovationPlatModify.aspx?ID=" + CheckStrArray[0].ToString());
    }
}
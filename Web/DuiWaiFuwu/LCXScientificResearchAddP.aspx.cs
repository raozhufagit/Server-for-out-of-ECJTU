...
public partial class DuiWaiFuwu_LCXScientificResearchAddP : System.Web.UI.Page
{
    ...
    protected void ImageButton1_Click(object sender, ImageClickEventArgs e)
    {
        ...
        if (DbHelperSQL.Exists("select * from  LCXUser where UserName='" + username + "' and TrueName='" + this.txtHostPerson.Text.ToString() + "'"))
        {
            Model.Add();
            //写系统日志
            ...
            LCX.Common.MessageBox.ShowAndRedirect(this, "科研信息添加成功！", "LCXScientificResearchP.aspx");
        }
        else
        {
            LCX.Common.MessageBox.Show(this, "对不起，您不是主持人，不能添加信息！");
        }
        //Model.Add();

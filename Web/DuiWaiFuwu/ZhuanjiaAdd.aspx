<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ZhuanjiaAdd.aspx.cs" Inherits="DuiWaiFuwu_ZhuanjiaAdd" %>
        ...
        <table id="PrintHide" style="width: 100%" border="0" cellpadding="0" cellspacing="0" margin-left="0 !important">
            <tr>
                <td valign="middle" style="border-bottom: #006633 1px dashed; height: 30px;">
                    ...
                    <a class="hei" href="../Main/MyDesk.aspx">桌面</a>&nbsp;>>&nbsp;专家信息&nbsp;>>&nbsp;添加信息
                </td>
        ...
        <table style="width: 1100px" bgcolor="#999999" border="0" cellpadding="2" cellspacing="1">
            <tr>
                ...
                <td style="padding-left: 5px; height: 25px; background-color: #ffffff">
                    <asp:TextBox ID="txtXingMing" runat="server" Width="145px"></asp:TextBox>
            ...
            <tr>
                ...
                <td style="padding-left: 5px; height: 25px; background-color: #ffffff">
                    <asp:TextBox ID="txtXingBie" runat="server" Width="145px"></asp:TextBox>
                ...
                <td style="padding-left: 5px; height: 25px; background-color: #ffffff">
                    <asp:TextBox ID="txtNation" runat="server" Width="145px"></asp:TextBox>

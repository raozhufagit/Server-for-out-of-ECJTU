<%@ Page Language="C#" AutoEventWireup="true" CodeFile="LCXEquipmentRepair.aspx.cs" Inherits="DuiWaiFuwu_LCXEquipmentRepair" %>
    ...
    <div>    
     <table style="width: 100%" border="0" cellpadding="0" cellspacing="0">            
            <tr>
                ...
                <a class="hei" href="../Main/MyDesk.aspx">桌面</a>&nbsp;>>&nbsp;对外服务信息&nbsp;>>&nbsp;设备仪器维修记录
                </td>
        ...
        <table style="width: 100%">
            ...
            <td ><asp:GridView ID="GVData" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False"
					...
					<asp:TemplateField HeaderText="设备名称"> <ItemTemplate> <asp:HyperLink ID="HyperLink1" runat="server" Font-Underline="True" NavigateUrl='<%# "LCXEquipmentRepairView.aspx?ID="+ DataBinder.Eval(Container.DataItem, "ID")%>'><%# DataBinder.Eval(Container.DataItem, "EquipmentName")%></asp:HyperLink> </ItemTemplate>   <ItemStyle HorizontalAlign="Left" />  </asp:TemplateField> 
					<asp:BoundField DataField="EquipmentNo" HeaderText="设备编号" ></asp:BoundField>     
					<asp:BoundField DataField="RepairDept" HeaderText="维修单位"  ></asp:BoundField> 
                    
                    <asp:BoundField DataField="RepairTime" HeaderText="维修时间" DataFormatString="{0:yyyy-MM-dd}"></asp:BoundField>     
					<asp:BoundField DataField="RepairCost" HeaderText="维修花费"  ></asp:BoundField>
                    <asp:BoundField DataField="Checker" HeaderText="核查人"  ></asp:BoundField>
                         </Columns>

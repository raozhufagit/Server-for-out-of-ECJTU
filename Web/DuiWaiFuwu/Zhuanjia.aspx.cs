...
public partial class DuiWaiFuwu_Zhuanjia : System.Web.UI.Page
{
    ...
    protected void GVData_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            {
                e.Row.Cells[7].Text = "<a class=\"bbk button small-long-btn\" href=\"ZhuanjiaCheck.aspx?ID=" + DataBinder.Eval(e.Row.DataItem, "ID").ToString() +"\">等待审核</a>";
            }
        }
    }
	...
	{
		Response.Redirect("ZhuanjiaAdd.aspx");
	}
	...
	protected void ImageButton5_Click(object sender, ImageClickEventArgs e)
	{
		...
		Response.Redirect("ZhuanjiaModify.aspx?ID=" + CheckStrArray[0].ToString());
	}
}

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="LCXScientificResearchModifyP.aspx.cs" Inherits="DuiWaiFuwu_LCXScientificResearchModifyP" %>
        ...
        <table id="PrintHide" style="width: 100%" border="0" cellpadding="0" cellspacing="0" margin-left="0 !important">
            <tr>
                <td valign="middle" style="border-bottom: #006633 1px dashed; height: 30px;">
                    ...
                    <a class="hei" href="../Main/MyDesk.aspx">桌面</a>&nbsp;>>&nbsp;个人信息管理&nbsp;>>&nbsp;修改科研信息
                </td>

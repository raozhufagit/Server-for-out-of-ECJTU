<%@ Page Language="C#" AutoEventWireup="true" CodeFile="LCXEquipmentRentAdd.aspx.cs" Inherits="DuiWaiFuwu_LCXEquipmentRentAdd" %>
        ...
        <table style="width: 80%" bgcolor="#999999" border="0" cellpadding="2" cellspacing="1">
            ...
            <tr>
                ...
                <td style="padding-left: 5px; height: 45px; background-color: #ffffff">
                   ...
                   <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ControlToValidate="txtReturnTime"
                        ErrorMessage="*该项不可以为空"></asp:RequiredFieldValidator>
                </td>
            </tr>

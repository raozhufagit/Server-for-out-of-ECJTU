<%@ Page Language="C#" AutoEventWireup="true" CodeFile="LCXScientificResearchP.aspx.cs" Inherits="DuiWaiFuwu_LCXScientificResearchP" %>
     ...
     <table style="width: 100%" border="0" cellpadding="0" cellspacing="0">            
        ...
        <table style="width: 100%">
            ...
            <td ><asp:GridView ID="GVData" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False"
					...
					<asp:TemplateField HeaderText="科研名称"> <ItemTemplate> <asp:HyperLink ID="HyperLink1" runat="server" Font-Underline="True" NavigateUrl='<%# "LCXScientificResearchView.aspx?ID="+ DataBinder.Eval(Container.DataItem, "ID")%>'><%# DataBinder.Eval(Container.DataItem, "ScientificName")%></asp:HyperLink> </ItemTemplate>   <ItemStyle HorizontalAlign="Left" />  </asp:TemplateField> 
					<asp:BoundField DataField="ScientificNo" HeaderText="编号" ></asp:BoundField>     
					<asp:BoundField DataField="ScientificType" HeaderText="类型"  ></asp:BoundField> 
                    
                    <asp:BoundField DataField="HostPerson" HeaderText="主持人" ></asp:BoundField>     
					<asp:BoundField DataField="StartTime" HeaderText="开始时间" DataFormatString="{0:yyyy-MM-dd}" ></asp:BoundField>
                    <asp:BoundField DataField="EndTime" HeaderText="结束时间"  DataFormatString="{0:yyyy-MM-dd}"></asp:BoundField>
                         <asp:BoundField DataField="States" HeaderText="审核状态"   HeaderStyle-Width="100px">

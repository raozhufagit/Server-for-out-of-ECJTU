...
public partial class DuiWaiFuwu_ZhuanjiaPersonModify : System.Web.UI.Page
{
    ...
    protected void ImageButton1_Click(object sender, ImageClickEventArgs e)
    {
        ...
        {
            LCX.Common.MessageBox.ShowAndRedirect(this, "审核过后的专家信息不能修改！", "ZhuanJiaPerson.aspx");
            return;
        }
        else
        {
            if (DbHelperSQL.Exists("select * from  ZhuanJia where XingMing=(select TrueName from LCXUser where UserName='" + username + "') and XingMing='" + this.txtXingMing.Text.ToString() + "'"))
            {
                Model.Update();
                //写系统日志
                ...
                LCX.Common.MessageBox.ShowAndRedirect(this, "专家信息修改成功！", "ZhuanjiaPerson.aspx");
            }
            else
            {
                LCX.Common.MessageBox.ShowAndRedirect(this, "对不起，请您把姓名与基本信息中的真实姓名保持一致！", "ZhuanjiaPerson.aspx");
            }
        }
        ...
        LCX.Common.MessageBox.ShowAndRedirect(this, "专家信息添加成功！", "ZhuanjiaPerson.aspx");
    }

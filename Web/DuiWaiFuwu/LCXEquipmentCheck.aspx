<%@ Page Language="C#" AutoEventWireup="true" CodeFile="LCXEquipmentCheck.aspx.cs" Inherits="DuiWaiFuwu_LCXEquipmentCheck" %>
...
<td style="width: 10%; height: 45px; background-color: #D6E2F3" align="right">
	...
	<td style="padding-left: 5px; background-color: #ffffff" class="auto-style3" >
		<asp:label id="lblBuyTime" runat="server" Width="150px"></asp:label>
	</td> 
	</tr>
	...
	<td style="padding-left: 5px; background-color: #ffffff" class="auto-style3" >
		<asp:label id="lblCheckTime" runat="server" Width="150px"></asp:label>
	</td>
        <td style="width: 10%px; height: 45px; background-color: #D6E2F3" align="right">
		存放位置：
	</td>

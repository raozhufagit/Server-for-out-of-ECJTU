<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ProjectJinDu.aspx.cs" Inherits="Project_ProjectJinDu" %>
    ...
    <div>    
     <table style="width: 100%" border="0" cellpadding="0" cellspacing="0">            
            <tr>
                ...
                <a class="hei" href="../Main/MyDesk.aspx">桌面</a>&nbsp;>>&nbsp;项目管理&nbsp;>>&nbsp;项目进度
                </td>
                        ...
                        <asp:TemplateField HeaderText="项目名称">
                            <ItemTemplate>                                
                                <asp:HyperLink ID="HyperLink1" runat="server" Font-Underline="True"
                                    NavigateUrl='<%# "JinDuView.aspx?ID="+ DataBinder.Eval(Container.DataItem, "ID")%>'><%# DataBinder.Eval(Container.DataItem, "ProjectName")%></asp:HyperLink>
                            </ItemTemplate>                            
                            <ItemStyle HorizontalAlign="Left" />
                        </asp:TemplateField>                       
                         <asp:BoundField DataField="ProjectSerils" HeaderText="项目编号" >
                        </asp:BoundField>     
                        <asp:BoundField DataField="JieDuanName" HeaderText="阶段名称" >
                        </asp:BoundField>      
                        <asp:BoundField DataField="StartTime" HeaderText="开始时间" DataFormatString="{0:yyyy-MM-dd}" HtmlEncode="False" >
                        </asp:BoundField>    
                        <asp:BoundField DataField="EndTime" HeaderText="结束时间" DataFormatString="{0:yyyy-MM-dd}" HtmlEncode="False">
                        </asp:BoundField> 
                        <asp:BoundField DataField="WanChengDu" HeaderText="完成度" >
                        </asp:BoundField>   
                    </Columns>

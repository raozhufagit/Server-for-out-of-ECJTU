<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BaoXiaoShenQing.aspx.cs" Inherits="Project_BaoXiaoShenQing" %>
    ...
    <div>    
     <table style="width: 100%" border="0" cellpadding="0" cellspacing="0">            
            <tr>
                ...
                <a class="hei" href="../Main/MyDesk.aspx">桌面</a>&nbsp;>>&nbsp;项目管理&nbsp;>>&nbsp;报销申请
                </td>
        ...
        <tr>
            <td style="border-top: #000000 1px solid;border-bottom: #000000 1px solid">
                ...
                &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; <span style="color: #ff0033">*</span> <span style="color: #666600">
                    已经通过审批的登记不可以删除。</span></td>
        </tr>
        </table>
    </form>
</body>

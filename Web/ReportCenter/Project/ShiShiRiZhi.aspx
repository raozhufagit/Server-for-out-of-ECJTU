<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ShiShiRiZhi.aspx.cs" Inherits="Project_ShiShiRiZhi" %>
    ...
    <div>    
     <table style="width: 100%" border="0" cellpadding="0" cellspacing="0">            
            <tr>
                ...
                <a class="hei" href="../Main/MyDesk.aspx">桌面</a>&nbsp;>>&nbsp;项目管理&nbsp;>>&nbsp;项目实施
                </td>
                        ...
                        <asp:TemplateField HeaderText="项目名称">
                            <ItemTemplate>                                
                                <asp:HyperLink ID="HyperLink1" runat="server" Font-Underline="True"
                                    NavigateUrl='<%# "ShiShiView.aspx?ID="+ DataBinder.Eval(Container.DataItem, "ID")%>'><%# DataBinder.Eval(Container.DataItem, "ProjectName")%></asp:HyperLink>
                            </ItemTemplate>                            
                            <ItemStyle HorizontalAlign="Left" />
                        </asp:TemplateField>                       
                         <asp:BoundField DataField="ProjectSerils" HeaderText="项目编号" >
                        </asp:BoundField>     
                        <asp:BoundField DataField="ShiShiTime" HeaderText="实施日期" >
                        </asp:BoundField>      
                        <asp:BoundField DataField="ShiShiRen" HeaderText="实施人员" >
                        </asp:BoundField>      
                        <asp:BoundField DataField="ShiShiContent" HeaderText="实施内容" >
                        </asp:BoundField> 
                        <asp:BoundField DataField="WanGongLiang" HeaderText="完工量" >
                        </asp:BoundField> 
                        <asp:BoundField DataField="PingJia" HeaderText="客户评价" >
                        </asp:BoundField> 

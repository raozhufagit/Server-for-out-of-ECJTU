<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ShouKuan.aspx.cs" Inherits="Project_ShouKuan" %>
    ...
    <div>    
     <table style="width: 100%" border="0" cellpadding="0" cellspacing="0">            
            <tr>
                ...
                <a class="hei" href="../Main/MyDesk.aspx">桌面</a>&nbsp;>>&nbsp;项目管理&nbsp;>>&nbsp;收款信息
                </td>
                        ...
                        <asp:TemplateField HeaderText="项目名称">
                            <ItemTemplate>                                
                                <asp:HyperLink ID="HyperLink1" runat="server" Font-Underline="True"
                                    NavigateUrl='<%# "ShouKuanView.aspx?ID="+ DataBinder.Eval(Container.DataItem, "ID")%>'><%# DataBinder.Eval(Container.DataItem, "ProjectName")%></asp:HyperLink>
                            </ItemTemplate>                            
                            <ItemStyle HorizontalAlign="Left" />
                        </asp:TemplateField>                       
                         <asp:BoundField DataField="ProjectSerils" HeaderText="项目编号" >
                        </asp:BoundField>     
                        <asp:BoundField DataField="JieDuanName" HeaderText="项目阶段" >
                        </asp:BoundField>      
                        <asp:BoundField DataField="ShouKuanE" HeaderText="收款金额" >
                        </asp:BoundField>
                        <asp:BoundField DataField="FaPiaoHao" HeaderText="发票号码" >
                        </asp:BoundField>  
                        <asp:BoundField DataField="ShouKuanDate" HeaderText="收款日期" >
                        </asp:BoundField>  
                        <asp:BoundField DataField="DaoKuanDate" HeaderText="到款日期" >
                        </asp:BoundField> 
                        <asp:BoundField DataField="ShengYuE" HeaderText="剩余金额" >
                        </asp:BoundField> 
                    </Columns>

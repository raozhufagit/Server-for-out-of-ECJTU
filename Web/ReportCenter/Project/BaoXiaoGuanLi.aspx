<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BaoXiaoGuanLi.aspx.cs" Inherits="Project_BaoXiaoGuanLi" %>
<html>
	<head>
    ...
    <div>    
     <table style="width: 100%" border="0" cellpadding="0" cellspacing="0">            
            <tr>
                ...
                <a class="hei" href="../Main/MyDesk.aspx">桌面</a>&nbsp;>>&nbsp;项目管理&nbsp;>>&nbsp;报销管理
                </td>
                <td align="right" valign="middle" style="border-bottom: #006633 1px dashed; height: 30px;">
                    ...
                    <asp:ImageButton ID="ImageButton1" runat="server"  OnClientClick="javascript:return CheckDel1();" ImageUrl="../images/Button/ShenPiOK.jpg" ImageAlign="AbsMiddle" OnClick="ImageButton1_Click" />&nbsp;
                    &nbsp;
                    <asp:ImageButton ID="ImageButton3" runat="server" OnClientClick="javascript:return CheckDel();" ImageUrl="../images/Button/ShenPiNo.jpg" ImageAlign="AbsMiddle" OnClick="ImageButton3_Click" />&nbsp;
        ...
        <table style="width: 100%">
            ...
            <td ><asp:GridView ID="GVData" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="FeiYongType" HeaderText="费用类别" >
                        </asp:BoundField>
                         <asp:BoundField DataField="ShenQingRen" HeaderText="申请人" >
                        </asp:BoundField>
                         <asp:BoundField DataField="ShenPiRen" HeaderText="审批人" >
                        </asp:BoundField>     
                        <asp:BoundField DataField="ShenQingContent" HeaderText="申请内容" >
                        </asp:BoundField>

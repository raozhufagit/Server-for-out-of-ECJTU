<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Report.aspx.cs" Inherits="ReportCenter_Report" %>
<html>
	<head>
     ...
     <table style="width: 100%" border="0" cellpadding="0" cellspacing="0">            
            <tr>
                <td valign="middle" style="border-bottom: #006633 1px dashed; height: 30px; ">&nbsp;<img src="../images/BanKuaiJianTou.gif" />
                    分类：<asp:Label ID="Label1" runat="server"></asp:Label></td>
                <td align="right" valign="middle" style="border-bottom: #006633 1px dashed; height: 30px;">
					查询：<asp:DropDownList ID="DropDownList2" runat="server">
					<asp:ListItem Value="ReportName">报表名称</asp:ListItem>
					<asp:ListItem Value="BackInfo">备注</asp:ListItem>
					<asp:ListItem Value="PaiXuStr">排序字符</asp:ListItem>
        ...
        <table style="width: 100%">
            ...
            <td ><asp:GridView ID="GVData" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False"
					...
					<asp:TemplateField HeaderText="报表名称"> <ItemTemplate> <asp:HyperLink ID="HyperLink1" runat="server" Font-Underline="True" NavigateUrl='<%# "ReportView.aspx?ID="+ DataBinder.Eval(Container.DataItem, "ID")%>'><%# DataBinder.Eval(Container.DataItem, "ReportName")%></asp:HyperLink> </ItemTemplate>   <ItemStyle HorizontalAlign="Left" />  </asp:TemplateField> 
					<asp:BoundField DataField="BackInfo" HeaderText="备注" ></asp:BoundField> 
					<asp:BoundField DataField="PaiXuStr" HeaderText="排序字符" ></asp:BoundField>     
					...
					<asp:TemplateField HeaderText="查看报表"> <ItemTemplate> [<asp:HyperLink ID="HyperLink10" runat="server" Font-Underline="True" NavigateUrl='<%# "ReportViewData.aspx?ID="+ DataBinder.Eval(Container.DataItem, "ID") %>' ForeColor="#0000C0">查看报表</asp:HyperLink>] </ItemTemplate>   <ItemStyle HorizontalAlign="Center" />  </asp:TemplateField> 

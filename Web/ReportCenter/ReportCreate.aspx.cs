...
public partial class ReportCenter_ReportCreate : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!Page.IsPostBack)
        {
            ...
            LCX.DBUtility.DbHelperSQL.BindDropDownList("select name from sysobjects where type='U' and name!='dtproperties' order by name", this.DropDownList1, "name", "name");
        }
    }
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        string PeportSQL = "";
        DataSet MYDT = LCX.DBUtility.DbHelperSQL.GetDataSet(SQLStr);

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="LCXCoopAgreementViewP.aspx.cs" Inherits="CooperationAgreement_LCXCoopAgreementViewP" %>
    ...
    <div>    
     <table id="PrintHide" style="width: 100%" border="0" cellpadding="0" cellspacing="0">            
            <tr>
                ...
                <a class="hei" href="../Main/MyDesk.aspx">桌面</a>&nbsp;>>&nbsp;与我相关 &gt;&gt; 查看战略合作协议信息
                </td>
...
<hr style="height:1px; color: #003333;">
    ...
    <IFRAME name="RMid" frameBorder="0" marginHeight="0" marginWidth="0" width="100%" height="500"
													BORDERCOLOR="#ffffFF"  src="LCXStrategicagreeImpleN.aspx?StrategicagreeName=<%=TitleStr%>" border="0"></IFRAME>

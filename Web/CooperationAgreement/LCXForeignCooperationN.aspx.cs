...
public partial class CooperationAgreement_LCXForeignCooperationN : System.Web.UI.Page
{
    ...
    public void DataBindToGridview()
    {
        ...
        GVData.DataSource = MyModel.GetList("StrategiCooperation Like '%" + this.TextBox3.Text + "%' order by ID desc");
        GVData.DataBind();

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="LCXStrategicagreeImple.aspx.cs" Inherits="CooperationAgreement_LCXStrategicagreeImple" %>
     ...
     <table style="width: 100%" border="0" cellpadding="0" cellspacing="0">            
            <tr>
                ...
                <td align="right" valign="middle" style="border-bottom: #006633 1px dashed; height: 30px;">
					...
					<asp:ListItem Value="StrategicagreeName">协议名称</asp:ListItem>
                    <asp:ListItem Value="ChargePerson">主持人</asp:ListItem>
					</asp:DropDownList><asp:TextBox ID="TextBox3" runat="server" Width="80px"></asp:TextBox><asp:ImageButton ID="ImageButton6" runat="server" ImageAlign="AbsMiddle" ImageUrl="../images/Button/BtnSerch.jpg"
         ...
         <table style="width: 100%">
            ...
            <td ><asp:GridView ID="GVData" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False"
					...
					<asp:TemplateField HeaderText="阶段名称"> <ItemTemplate> <asp:HyperLink ID="HyperLink1" runat="server" Font-Underline="True" NavigateUrl='<%# "LCXStrategicagreeImpleView.aspx?ID="+ DataBinder.Eval(Container.DataItem, "ID")%>'><%# DataBinder.Eval(Container.DataItem, "PhaseName")%></asp:HyperLink> </ItemTemplate>   <ItemStyle HorizontalAlign="Left" />  </asp:TemplateField> 
					<asp:BoundField DataField="StrategicagreeName" HeaderText="战略协议名称" ></asp:BoundField>     
					...
					<asp:BoundField DataField="CompletionDegree" HeaderText="完成度" ></asp:BoundField> 
                        <asp:BoundField DataField="ChargePerson" HeaderText="主持人" ></asp:BoundField> 

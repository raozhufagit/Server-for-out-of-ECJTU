<%@ Page Language="C#" AutoEventWireup="true" CodeFile="LCXContractManageNA.aspx.cs" Inherits="CooperationAgreement_LCXContractManageNA" %>
     ...
     <table style="width: 100%" border="0" cellpadding="0" cellspacing="0">            
            <tr>
                ...
                <td align="right" valign="middle" style="border-bottom: #006633 1px dashed; height: 30px;">
					查询：
					<asp:TextBox ID="TextBox3" runat="server" Width="80px"></asp:TextBox><asp:TextBox ID="TextBox4" runat="server" Width="80px" Visible="false"></asp:TextBox><asp:ImageButton ID="ImageButton6" runat="server" ImageAlign="AbsMiddle" ImageUrl="../images/Button/BtnSerch.jpg"

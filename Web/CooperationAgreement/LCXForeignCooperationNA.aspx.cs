...
public partial class CooperationAgreement_LCXForeignCooperationNA : System.Web.UI.Page
{
    ...
    {
        Response.Redirect("LCXForeignCoopAdd.aspx");
    }
    protected void ImageButton3_Click(object sender, ImageClickEventArgs e)
    {
        string IDlist = LCX.Common.PublicMethod.CheckCbx(this.GVData, "CheckSelect", "LabVisible");
        if (LCX.DBUtility.DbHelperSQL.ExecuteSQL("delete from LCXForeignCooperation where ID in (" + IDlist + ")") == -1)
        {
    ...
    protected void ImageButton2_Click(object sender, ImageClickEventArgs e)
    {
        ...
        MyTable.Add("StrategiCooperation", "所属战略协议");
    ...
    protected void ImageButton5_Click(object sender, ImageClickEventArgs e)
    {
        ...
        Response.Redirect("LCXForeignCoopModify.aspx?ID=" + CheckStrArray[0].ToString());
    }
}
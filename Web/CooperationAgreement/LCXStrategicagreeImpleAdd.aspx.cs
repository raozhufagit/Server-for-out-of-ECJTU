...
public partial class CooperationAgreement_LCXStrategicagreeImpleAdd : System.Web.UI.Page
{
    ...
    protected void ImageButton1_Click(object sender, ImageClickEventArgs e)
    {
        ...
        MyRiZhi.DoSomething = "用户添加协议进度信息(" + this.txtPhaseName.Text + ")";
        MyRiZhi.IpStr = System.Web.HttpContext.Current.Request.UserHostAddress.ToString();
        MyRiZhi.Add();
        LCX.Common.MessageBox.ShowAndRedirect(this, "战略协议进度信息添加成功！", "LCXStrategicagreeImple.aspx");

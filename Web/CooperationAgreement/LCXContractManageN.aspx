<%@ Page Language="C#" AutoEventWireup="true" CodeFile="LCXContractManageN.aspx.cs" Inherits="CooperationAgreement_LCXContractManageN" %>
    ...
    <div>    
     <table style="width: 100%" border="0" cellpadding="0" cellspacing="0">            
            <tr>
                ...
                <a class="hei" href="../Main/MyDesk.aspx">桌面</a>&nbsp;>>&nbsp;合同管理&nbsp;>>&nbsp;正式合同管理
                </td>
                <td align="right" valign="middle" style="border-bottom: #006633 1px dashed; height: 30px;">
					查询：<asp:DropDownList ID="DropDownList2" runat="server">
					
					<asp:ListItem Value="DepartmentA">校内单位</asp:ListItem>
                    <asp:ListItem Value="DepartmentB">校外单位</asp:ListItem>
					</asp:DropDownList><asp:TextBox ID="TextBox3" runat="server" Width="80px"></asp:TextBox><img class="HerCss"
					onclick="var wName;var RadNum=Math.random();wName=window.showModalDialog('../Main/SelectCondition.aspx?TableName=LCXDept&LieName='+document.getElementById('DropDownList2').value+'&Radstr='+RadNum,'','dialogWidth:350px;DialogHeight=400px;status:no;help:no;resizable:yes;');if(wName==null){}else{document.getElementById('TextBox3').value=wName;}"
					src="../images/Button/search.gif" /><asp:ImageButton ID="ImageButton6" runat="server" ImageAlign="AbsMiddle" ImageUrl="../images/Button/BtnSerch.jpg"
					OnClick="ImageButton4_Click" /><asp:ImageButton ID="ImageButton7" runat="server" ImageAlign="AbsMiddle" ImageUrl="../images/Button/ResultSerch.jpg" OnClick="ImageButton6_Click" />&nbsp; &nbsp;
         ...
         <table style="width: 100%">
            ...
            <td ><asp:GridView ID="GVData" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False"
					...
					<asp:TemplateField HeaderText="合同名称"> <ItemTemplate> <asp:HyperLink ID="HyperLink1" runat="server" Font-Underline="True" NavigateUrl='<%# "LCXContractManageViewNS.aspx?ID="+ DataBinder.Eval(Container.DataItem, "ID")%>'><%# DataBinder.Eval(Container.DataItem, "ContractName")%></asp:HyperLink> </ItemTemplate>   <ItemStyle HorizontalAlign="Left" />  </asp:TemplateField> 
                        <asp:BoundField DataField="ContractNo" HeaderText="合同编号" ></asp:BoundField>
                       
                        <asp:BoundField DataField="DepartmentA" HeaderText="校内单位" ></asp:BoundField> 
					<asp:BoundField DataField="DepartmentB" HeaderText="校外单位" ></asp:BoundField>     
					<asp:BoundField DataField="SignatoryA" HeaderText="校内单位签署人" ></asp:BoundField>  
					<asp:BoundField DataField="SignatoryB" HeaderText="校外单位签署人" ></asp:BoundField> 
                    <asp:BoundField DataField="SignTime" HeaderText="签署时间" DataFormatString="{0:yyyy-MM-dd}"></asp:BoundField> 
                    <asp:BoundField DataField="EndTime" HeaderText="结束时间" DataFormatString="{0:yyyy-MM-dd}"></asp:BoundField> 
                        <asp:BoundField DataField="Project" HeaderText="所属项目" ></asp:BoundField>  

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="LCXForeignCooperationN.aspx.cs" Inherits="CooperationAgreement_LCXForeignCooperationN" %>
    ...
    <div>    
     <table style="width: 100%" border="0" cellpadding="0" cellspacing="0">            
            <tr>
                ...
                <a class="hei" href="../Main/MyDesk.aspx">桌面</a>&nbsp;>>&nbsp;对外合作协议管理&nbsp;>>&nbsp;正式合作协议管理
                </td>
         ...
         <table style="width: 100%">
            ...
            <td ><asp:GridView ID="GVData" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False"
					...
					<asp:TemplateField HeaderText="协议名称"> <ItemTemplate> <asp:HyperLink ID="HyperLink1" runat="server" Font-Underline="True" NavigateUrl='<%# "LCXForeignCoopViewN.aspx?ID="+ DataBinder.Eval(Container.DataItem, "ID")%>'><%# DataBinder.Eval(Container.DataItem, "CAgreementName")%></asp:HyperLink> </ItemTemplate>   <ItemStyle HorizontalAlign="Left" />  </asp:TemplateField> 
                        <asp:BoundField DataField="CAgreementNo" HeaderText="协议编号" ></asp:BoundField>

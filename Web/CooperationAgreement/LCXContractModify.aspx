<%@ Page Language="C#" AutoEventWireup="true" CodeFile="LCXContractModify.aspx.cs" Inherits="CooperationAgreement_LCXContractModify" %>
        ...
        <table id="PrintHide" style="width: 100%" border="0" cellpadding="0" cellspacing="0">
            <tr>
                <td valign="middle" style="border-bottom: #006633 1px dashed; height: 30px;">
                    ...
                    <a class="hei" href="../Main/MyDesk.aspx">桌面</a>&nbsp;>>&nbsp;合同管理&nbsp;>>&nbsp;修改合同
                </td>

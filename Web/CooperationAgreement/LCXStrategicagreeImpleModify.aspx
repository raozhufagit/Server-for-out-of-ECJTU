<%@ Page Language="C#" AutoEventWireup="true" CodeFile="LCXStrategicagreeImpleModify.aspx.cs" Inherits="CooperationAgreement_LCXStrategicagreeImpleModify" %>
        ...
        <table style="width: 100%" bgcolor="#999999" border="0" cellpadding="2" cellspacing="1">
            <tr>
                ...
                <td style="padding-left: 5px; height: 25px; background-color: #ffffff">
                    <asp:TextBox ID="txtStrategicagreeName" runat="server" Width="350px"></asp:TextBox>
                    ...
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txtStrategicagreeName"

...
public partial class CooperationAgreement_LCXCAgreeTest : System.Web.UI.Page
{
    ...
    protected void ImageButton1_Click(object sender, ImageClickEventArgs e)
    {
        ...
        Model.CAgreementName = this.txtTitle.Text.ToString();
        ...
        MyRiZhi.DoSomething = "用户添加合作协议信息(" + this.txtTitle.Text + ")";
        MyRiZhi.IpStr = System.Web.HttpContext.Current.Request.UserHostAddress.ToString();
        MyRiZhi.Add();
        if (String.Compare(this.txtStates.Text.ToString(), "1") == 0)
        {
            LCX.Common.MessageBox.ShowAndRedirect(this, "合作协议信息添加成功！", "LCXCoopAgreement.aspx");
        }
        else
        {
            LCX.Common.MessageBox.ShowAndRedirect(this, "合作协议信息添加成功！", "LCXCoopAgreementN.aspx");
        }
    }

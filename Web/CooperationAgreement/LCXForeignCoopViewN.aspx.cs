...
public partial class CooperationAgreement_LCXForeignCoopViewN : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!Page.IsPostBack)
        {
            ...
            this.lblTitle.Text = model.CAgreementName;
            TitleStr = model.CAgreementName;
            ...
            MyRiZhi.DoSomething = "查看对外合作协议信息(" + this.lblTitle.Text + ")";

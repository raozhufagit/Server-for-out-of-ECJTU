...
public partial class CooperationAgreement_LCXForeignCoopModify : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!Page.IsPostBack)
        {
            ...
            this.txtCAgreementNo.Text = Model.CAgreementNo.ToString();
            this.txtCAgreementName.Text = Model.CAgreementName.ToString();
    ...
    protected void ImageButton1_Click(object sender, ImageClickEventArgs e)
    {
        ...
        Model.StrategiCooperation = this.txtStrategiCooperation.ToString();
        ...
        //MyRiZhi.DoSomething = "用户修改合作协议信息(" + this.txtCAgreementName.Text + ")";
        MyRiZhi.IpStr = System.Web.HttpContext.Current.Request.UserHostAddress.ToString();
        MyRiZhi.Add();
        //LCX.Common.MessageBox.ShowAndRedirect(this, "合作协议信息修改成功！", "LCXForeignCooperation.aspx");
        ...
        {
            LCX.Common.MessageBox.ShowAndRedirect(this, "合作协议信息修改成功！", "LCXForeignCooperationN.aspx");
        }

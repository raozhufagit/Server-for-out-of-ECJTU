...
public partial class CooperationAgreement_LCXStrategicagreeImpleModify : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!Page.IsPostBack)
        {
            ...
            this.txtStrategicagreeName.Text = Model.StrategicagreeName.ToString();
    ...
    protected void ImageButton1_Click(object sender, ImageClickEventArgs e)
    {
        ...
        Model.StrategicagreeName = this.txtStrategicagreeName.Text.ToString();
        ...
        MyRiZhi.DoSomething = "用户修改协议进度信息(" + this.txtPhaseName.Text + ")";
        MyRiZhi.IpStr = System.Web.HttpContext.Current.Request.UserHostAddress.ToString();
        MyRiZhi.Add();
        LCX.Common.MessageBox.ShowAndRedirect(this, "战略协议进度信息修改成功！", "LCXStrategicagreeImple.aspx");
    }

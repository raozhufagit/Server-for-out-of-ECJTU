<%@ Page Language="C#" AutoEventWireup="true" CodeFile="LCXForeignCoopAdd.aspx.cs" Inherits="CooperationAgreement_LCXForeignCoopAdd" %>
         ...
         <tr>
            ...
            <tr>
                ...
                <td style="padding-left: 5px; height: 25px; background-color: #ffffff">
                    ...
                    <img class="HerCss" onclick="var wName;var RadNum=Math.random();wName=window.showModalDialog('../Main/SelectCondition.aspx?TableName=LCXCooperation&LieName=Title&Radstr='+RadNum,'','dialogWidth:350px;DialogHeight=400px;status:no;help:no;resizable:yes;');if(wName==null){}else{document.getElementById('txtStrategiCooperation').value=wName;}"
                        src="../images/Button/search.gif" />

...
public partial class BBS_BanKuaiModify : System.Web.UI.Page
{
    ...
    {
        LCX.BLL.LCXBBSSection Model = new LCX.BLL.LCXBBSSection();
        ...
        string ImgNameStr = LCX.Common.PublicMethod.UploadFileIntoDir(this.FileUpload1, DateTime.Now.Ticks.ToString() + System.IO.Path.GetExtension(FileUpload1.PostedFile.FileName));
        ...
        LCX.Common.MessageBox.ShowAndRedirect(this, "论坛版块修改成功！", "SettingConfig.aspx");
    }
}
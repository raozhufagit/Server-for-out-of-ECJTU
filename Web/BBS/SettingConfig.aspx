<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SettingConfig.aspx.cs" Inherits="BBS_SettingConfig" %>
<html>
	<head>
    ...
    <div>    
     <table style="width: 100%" border="0" cellpadding="0" cellspacing="0">            
            <tr>
                ...
                <a class="hei" href="../Main/MyDesk.aspx">桌面</a>&nbsp;>>&nbsp;论坛BBS&nbsp;>>&nbsp;版块设置
                </td>
        ...
        <table style="width: 100%">
            ...
            <td ><asp:GridView ID="GVData" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="版块图片">
                            <ItemTemplate>                                
                                <a href='<%# "BanKuaiView.aspx?ID="+ DataBinder.Eval(Container.DataItem, "ID")%>'><img height="45" src='<%#"../UploadFile/"+DataBinder.Eval(Container.DataItem, "BanKuaiImg")%>' border="0" width="80" /></a>
                            </ItemTemplate>

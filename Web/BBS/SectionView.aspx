<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SectionView.aspx.cs" Inherits="BBS_BanKuaiView" %>
<html>
	<head>
    ...
    <div>    
     <table style="width: 100%" border="0" cellpadding="0" cellspacing="0">            
            <tr>
                ...
                <a class="hei" href="../Main/MyDesk.aspx">桌面</a>&nbsp;>>&nbsp;论坛BBS&nbsp;>>&nbsp;<%=BanKuaiName %></td>
                <td align="right" valign="middle" style="border-bottom: #006633 1px dashed; height: 30px;">
                    查询：<asp:TextBox ID="TextBox1" runat="server" Height="20px" Width="80px"></asp:TextBox><asp:ImageButton
                        ...
                        OnClick="ImageButton4_Click" />&nbsp;&nbsp; <asp:ImageButton ID="ImageButton6" runat="server" ImageUrl="../images/Button/Ding.jpg" ImageAlign="AbsMiddle" OnClick="ImageButton6_Click" />&nbsp;
                    <asp:ImageButton ID="ImageButton7" runat="server" ImageUrl="../images/Button/QuDing.jpg" ImageAlign="AbsMiddle" OnClick="ImageButton7_Click" />
        ...
        <table style="width: 100%">
            ...
            <td ><asp:GridView ID="GVData" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="帖子主题">
                            <ItemTemplate>                                
                                &nbsp;<img src="../images/child.gif" align="absMiddle" />&nbsp;<asp:HyperLink ID="HyperLink1" runat="server" Font-Underline="True"
                                    NavigateUrl='<%# "CardView.aspx?ID="+ DataBinder.Eval(Container.DataItem, "ID")%>'><%# DataBinder.Eval(Container.DataItem, "TitleStr")%></asp:HyperLink>
                        ...
                        <asp:BoundField DataField="ZuiHouTime" HeaderText="最后更新" >
                        </asp:BoundField>      
                        <asp:BoundField DataField="ZuiHouUser" HeaderText="最后回复" >
                        </asp:BoundField>                  
                    </Columns>

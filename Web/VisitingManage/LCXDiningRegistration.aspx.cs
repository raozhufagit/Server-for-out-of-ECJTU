...
public partial class VisitingManage_LCXDiningRegistration : System.Web.UI.Page
{
    ...
    {
        LCX.BLL.LCXDiningRegistration MyModel = new LCX.BLL.LCXDiningRegistration();
   ...
   /* public void DataBindToGridview(string IDList)
    ...
    {
        Response.Redirect("LCXDiningRegistrationAdd.aspx");
    }
    protected void ImageButton3_Click(object sender, ImageClickEventArgs e)
    {
        string IDlist = LCX.Common.PublicMethod.CheckCbx(this.GVData, "CheckSelect", "LabVisible");
        if (LCX.DBUtility.DbHelperSQL.ExecuteSQL("delete from LCXDiningRegistration where ID in (" + IDlist + ")") == -1)
        {
    ...
    protected void ImageButton2_Click(object sender, ImageClickEventArgs e)
    {
        ...
        MyTable.Add("DiningSite", "用餐地址");
        MyTable.Add("PeopleNum", "人数");
        MyTable.Add("CostNum", "费用");
        MyTable.Add("DiningTime", "用餐时间");
        MyTable.Add("Remarks", "备注");


        LCX.Common.DataToExcel.GridViewToExcel(LCX.DBUtility.DbHelperSQL.GetDataSet("select  OutVisiting,DiningSite,PeopleNum,CostNum,AccomTime,Remarks from LCXAccomRegistration where ID in (" + IDList + ") order by ID desc"), MyTable, "Excel报表");
    }
    protected void ImageButton5_Click(object sender, ImageClickEventArgs e)
    {
        string CheckStr = LCX.Common.PublicMethod.CheckCbx(this.GVData, "CheckSelect", "LabVisible");
        string[] CheckStrArray = CheckStr.Split(',');
        Response.Redirect("LCXDiningRegistrationModify.aspx?ID=" + CheckStrArray[0].ToString());
    }
}
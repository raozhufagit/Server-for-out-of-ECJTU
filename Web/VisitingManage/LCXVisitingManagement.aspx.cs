...
public partial class VisitingManage_LCXVisitingManagement : System.Web.UI.Page
{
        ...
        {
            LCX.BLL.LCXVisitingManagement MyModel = new LCX.BLL.LCXVisitingManagement();
        ...
        {
            Response.Redirect("LCXVisitingAdd.aspx");
        }
        protected void ImageButton3_Click(object sender, ImageClickEventArgs e)
        {
            string IDlist = LCX.Common.PublicMethod.CheckCbx(this.GVData, "CheckSelect", "LabVisible");
            if (LCX.DBUtility.DbHelperSQL.ExecuteSQL("delete from LCXVisitingManagement where ID in (" + IDlist + ")") == -1)
            {
        ...
        protected void ImageButton2_Click(object sender, ImageClickEventArgs e)
        {
            ...
            MyTable.Add("InVisitGroup", "参访单位");
            MyTable.Add("InVisitUnit", "来访单位");
            MyTable.Add("VisitPurpose", "来访目的");
            MyTable.Add("Receptionist", "接待人员");
            MyTable.Add("VisitTime", "来访时间");
            MyTable.Add("WorkReport", "工作报告");
            MyTable.Add("WorkProgress", "工作进度");
            MyTable.Add("Attchment", "附件");
            
            LCX.Common.DataToExcel.GridViewToExcel(LCX.DBUtility.DbHelperSQL.GetDataSet("select  InVisitGroup,InVisitUnit,VisitPurpose,Receptionist,VisitTime,WorkReport,WorkProgress,Attchment from LCXVisitingManagement where ID in (" + IDList + ") order by ID desc"), MyTable, "Excel报表");
        }
        protected void ImageButton5_Click(object sender, ImageClickEventArgs e)
        {
            string CheckStr = LCX.Common.PublicMethod.CheckCbx(this.GVData, "CheckSelect", "LabVisible");
            string[] CheckStrArray = CheckStr.Split(',');
            Response.Redirect("LCXVisitingModify.aspx?ID=" + CheckStrArray[0].ToString());
        }
 }
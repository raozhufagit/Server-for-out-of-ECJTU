<%@ Page Language="C#" AutoEventWireup="true" CodeFile="LCXVisitingManagement.aspx.cs" Inherits="VisitingManage_LCXVisitingManagement" %>
    ...
    <div>    
     <table style="width: 100%" border="0" cellpadding="0" cellspacing="0">            
            <tr>
                ...
                <a class="hei" href="../Main/MyDesk.aspx">桌面</a>&nbsp;>>&nbsp;来访管理&nbsp;>>&nbsp;来访管理
                </td>
                <td align="right" valign="middle" style="border-bottom: #006633 1px dashed; height: 30px;">
					查询：<asp:DropDownList ID="DropDownList2" runat="server">
					
					<asp:ListItem Value="InVisitGroup">校内单位</asp:ListItem>
                    <asp:ListItem Value="InVisitUnit">出访单位</asp:ListItem>
        ...
        <table style="width: 100%">
            ...
            <td ><asp:GridView ID="GVData" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False"
					...
					<asp:TemplateField HeaderText="来访标题"> <ItemTemplate> <asp:HyperLink ID="HyperLink1" runat="server" Font-Underline="True" NavigateUrl='<%# "LCXVisitingView.aspx?ID="+ DataBinder.Eval(Container.DataItem, "ID")%>'><%# DataBinder.Eval(Container.DataItem, "VisitingTitle")%></asp:HyperLink> </ItemTemplate>   <ItemStyle HorizontalAlign="Left" />  </asp:TemplateField> 
                         <asp:BoundField DataField="InVisitUnit" HeaderText="来访单位" ></asp:BoundField>
					<asp:BoundField DataField="InVisitGroup" HeaderText="校内单位" ></asp:BoundField>     
					<asp:BoundField DataField="VisitPurpose" HeaderText="来访目的" ></asp:BoundField>     
					<asp:BoundField DataField="Receptionist" HeaderText="接待人员" ></asp:BoundField>  
					<asp:BoundField DataField="VisitTime" HeaderText="来访时间" DataFormatString="{0:yyyy-MM-dd}"></asp:BoundField> 

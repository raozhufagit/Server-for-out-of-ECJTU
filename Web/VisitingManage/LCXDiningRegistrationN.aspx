<%@ Page Language="C#" AutoEventWireup="true" CodeFile="LCXDiningRegistrationN.aspx.cs" Inherits="VisitingManage_LCXDiningRegistrationN" %>
     ...
     <table style="width: 100%" border="0" cellpadding="0" cellspacing="0">            
         ...
         <table style="width: 100%">
            ...
            <td ><asp:GridView ID="GVData" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False"
					...
					<asp:BoundField DataField="DiningSite" HeaderText="用餐地址" ></asp:BoundField>  
					...
					<asp:BoundField DataField="DiningTime" HeaderText="入住时间" DataFormatString="{0:yyyy-MM-dd}" ></asp:BoundField>  

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="LCXAccomRegistrationN.aspx.cs" Inherits="VisitingManage_LCXAccomRegistrationN" %>
            ...
            <td ><asp:GridView ID="GVData" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False"
                    ...
                    <Columns>
                        <asp:TemplateField>
                           ...
                           <asp:BoundField DataField="OutVisiting" HeaderText="来访名称" ></asp:BoundField> 
					<asp:BoundField DataField="AccommationSite" HeaderText="住宿地址" ></asp:BoundField>  
					<asp:BoundField DataField="PeopleNum" HeaderText="人数" ></asp:BoundField>     
					<asp:BoundField DataField="CostNum" HeaderText="费用" ></asp:BoundField>     
					<asp:BoundField DataField="AccomTime" HeaderText="入住时间" DataFormatString="{0:yyyy-MM-dd}" ></asp:BoundField>  

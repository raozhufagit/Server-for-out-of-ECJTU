<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Contract.aspx.cs" Inherits="Sell_Contract" %>
        ...
        <table style="width: 100%" border="0" cellpadding="0" cellspacing="0">
            <tr>
                <td valign="middle" style="border-bottom: #006633 1px dashed; height: 30px;">
                    ...
                    <a class="hei" href="../Main/MyDesk.aspx">桌面</a>&nbsp;>>&nbsp;销售订单&nbsp;>>&nbsp;合同管理
                </td>
                <td align="right" valign="middle" style="border-bottom: #006633 1px dashed; height: 30px;">
                    ...
                    <asp:ImageButton ID="ImageButton1" OnClick="ImageButton1_Click" runat="server" ImageUrl="../images/Button/ShenPiOK.jpg"
                        ImageAlign="AbsMiddle" OnClientClick="javascript:return CheckDel1();"></asp:ImageButton>&nbsp;<asp:ImageButton
                            ...
                            ImageAlign="AbsMiddle" OnClientClick="javascript:return CheckDel1();"></asp:ImageButton>
                ...
                <asp:GridView ID="GVData" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="合同名称">
                            <ItemTemplate>
                                <asp:HyperLink ID="HyperLink1" runat="server" Font-Underline="True" NavigateUrl='<%# "ContractView.aspx?ID="+ DataBinder.Eval(Container.DataItem, "ID")%>'><%# DataBinder.Eval(Container.DataItem, "HeTongName")%></asp:HyperLink>
                            </ItemTemplate>
                            <ItemStyle HorizontalAlign="Left" />
                        </asp:TemplateField>
                        <asp:BoundField DataField="HeTongSerils" HeaderText="合同编码"></asp:BoundField>
                        <asp:BoundField DataField="HeTongLeiXing" HeaderText="合同类别"></asp:BoundField>
                        <asp:BoundField DataField="QianYueKeHu" HeaderText="签约客户"></asp:BoundField>
                        <asp:BoundField DataField="CreateUser" HeaderText="录入人"></asp:BoundField>
                        <asp:BoundField DataField="CreateTime" HeaderText="录入时间"></asp:BoundField>

...
public partial class Sell_Revice : System.Web.UI.Page
{
    ...
    public void DataBindToGridview()
    {
        ...
        var T = context.LCXRecive.Where(p => p.ID > 0 && p.NowState == "S");
    ...
    {
        Response.Redirect("ReviceAdd.aspx");
    }
    protected void ImageButton3_Click(object sender, ImageClickEventArgs e)
    {
        string IDlist = LCX.Common.PublicMethod.CheckCbx(this.GVData, "CheckSelect", "LabVisible");
        if (LCX.DBUtility.DbHelperSQL.ExecuteSQL("delete from LCXRecive where ID in (" + IDlist + ")") == -1)
        {
        ...
        else
        {
            ...
            MyRiZhi.DoSomething = "用户删除收款计划信息";
    ...
    protected void ImageButton2_Click(object sender, ImageClickEventArgs e)
    {
        ...
        LCX.Common.DataToExcel.GridViewToExcel(LCX.DBUtility.DbHelperSQL.GetDataSet("select HeTongName,QianYueKeHu,HTJE,TiXingDate,DaoKuanDate,CreateUser,CreateTime,NowState from LCXRecive where ID in (" + IDList + ") order by ID desc"), MyTable, "Excel报表");
    }
    protected void ImageButton5_Click(object sender, ImageClickEventArgs e)
    {
        string CheckStr = LCX.Common.PublicMethod.CheckCbx(this.GVData, "CheckSelect", "LabVisible");
        string[] CheckStrArray = CheckStr.Split(',');
        Response.Redirect("ReviceModify.aspx?ID=" + CheckStrArray[0].ToString());
    }
}
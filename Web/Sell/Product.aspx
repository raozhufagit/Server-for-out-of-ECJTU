<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Product.aspx.cs" Inherits="Sell_Product" %>
<html>
	<head>
    ...
    <div>    
     <table style="width: 100%" border="0" cellpadding="0" cellspacing="0">            
            <tr>
                ...
                <a class="hei" href="../Main/MyDesk.aspx">桌面</a>&nbsp;>>&nbsp;销售订单&nbsp;>>&nbsp;产品信息
                </td>
                        ...
                        <asp:TemplateField HeaderText="产品名称">
                            <ItemTemplate>                                
                                <asp:HyperLink ID="HyperLink1" runat="server" Font-Underline="True"
                                    NavigateUrl='<%# "ProductView.aspx?ID="+ DataBinder.Eval(Container.DataItem, "ID")%>'><%# DataBinder.Eval(Container.DataItem, "ProductName")%></asp:HyperLink>
                            </ItemTemplate>                            
                            <ItemStyle HorizontalAlign="Left" />
                        </asp:TemplateField>                       
                         <asp:BoundField DataField="ProductSerils" HeaderText="产品编码" >
                        </asp:BoundField>                             
                        <asp:BoundField DataField="ProductType" HeaderText="产品类别" >
                        </asp:BoundField>  
                        <asp:BoundField DataField="ChengBen" HeaderText="成本价" >
                        </asp:BoundField>  
                        <asp:BoundField DataField="ChuShou" HeaderText="出售价" >
                        </asp:BoundField>      
                        <asp:BoundField DataField="ChuKuSum" HeaderText="出库总量" >
                        </asp:BoundField>  
                        <asp:BoundField DataField="RuKuSum" HeaderText="入库总量" >
                        </asp:BoundField>  
                        <asp:BoundField DataField="NowKuCun" HeaderText="当前库存" >
                        </asp:BoundField>                 
                    </Columns>

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="YFModify.aspx.cs" Inherits="Financial_YFModify" %>
        ...
        <table id="PrintHide" style="width: 100%" border="0" cellpadding="0" cellspacing="0">
            <tr>
                <td valign="middle" style="border-bottom: #006633 1px dashed; height: 30px;">
                    ...
                    <a class="hei" href="../Main/MyDesk.aspx">桌面</a>&nbsp;>>&nbsp;财务信息&nbsp;>>&nbsp;修改应付信息
                </td>
        ...
        <table style="width: 100%" bgcolor="#999999" border="0" cellpadding="2" cellspacing="1">
            <tr>
                ...
                <td style="padding-left: 5px; height: 25px; background-color: #ffffff">
                    <asp:TextBox ID="txtHeTongName" runat="server" Width="350px" ReadOnly="true"></asp:TextBox>

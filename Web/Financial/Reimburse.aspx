<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Reimburse.aspx.cs" Inherits="Financial_Reimburse" %>
    ...
    <div>
        <table style="width: 100%" border="0" cellpadding="0" cellspacing="0">            
            <tr>
                ...
                <a class="hei" href="../Main/MyDesk.aspx">桌面</a>&nbsp;>>&nbsp;进销存类&nbsp;>>&nbsp;财务管理&nbsp;>>&nbsp;报销单
                </td>
                ...
                <asp:GridView ID="GVData" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="报销内容">
                            <ItemTemplate>
                                <asp:HyperLink ID="HyperLink1" runat="server" Font-Underline="True" NavigateUrl='<%# "ReimburseView.aspx?ID="+ DataBinder.Eval(Container.DataItem, "ID")%>'><%# DataBinder.Eval(Container.DataItem, "ReimburseContent")%></asp:HyperLink>
                            </ItemTemplate>
                            <ItemStyle HorizontalAlign="Left" />
                        </asp:TemplateField>
                        <asp:BoundField DataField="UserName" HeaderText="报销人"></asp:BoundField>
                        <asp:BoundField DataField="HeTongName" HeaderText="合同名称"></asp:BoundField>
                        <asp:BoundField DataField="QianYueKeHu" HeaderText="签约客户"></asp:BoundField>
                        <asp:BoundField DataField="ApplyTime" HeaderText="申请时间"></asp:BoundField>

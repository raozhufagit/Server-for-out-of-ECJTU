  ...
  <LINK href="../Style/Style.css" type="text/css" rel="STYLESHEET">  
    ...
    <SCRIPT language="javascript" event="NotifyCtrlReady" for="FramerControl1">		
        ...
        function insertqianming()
        {
            var wName;
            var RadNum=Math.random();
            wName=window.showModalDialog('../Main/InsertQianMing.aspx?Radstr='+RadNum,'','dialogWidth:400px;DialogHeight=450px;status:no;help:no;resizable:yes;');
            if(wName==null||wName=="")
            {}
            else
            {
     ...
     <table id="PrintHide" style="width: 100%" border="0" cellpadding="0" cellspacing="0">            
            <tr>
                ...
                <td align="right" valign="middle" style="border-bottom: #006633 1px dashed; height: 30px;">
                    下载文件（右键另存为）：<asp:HyperLink ID="HyperLink1" runat="server" Font-Bold="True" Font-Underline="True"
                        ForeColor="Blue">[HyperLink1]</asp:HyperLink>&nbsp;

    ...
    <div>    
     <table style="width: 100%" border="0" cellpadding="0" cellspacing="0">            
            <tr>
                ...
                <a class="hei" href="../Main/MyDesk.aspx">桌面</a>&nbsp;>>&nbsp;内部邮件&nbsp;>>&nbsp;已发送
                </td>
                <td align="right" valign="middle" style="border-bottom: #006633 1px dashed; height: 30px;">
                    主题：<asp:TextBox ID="TextBox1" runat="server" Height="20px" Width="60px"></asp:TextBox>接收人：<asp:TextBox
                        ...
                        OnClick="ImageButton4_Click" />&nbsp;<asp:ImageButton ID="ImageButton3" runat="server"
                            ...
                            OnClientClick="javascript:return CheckDel();" />&nbsp;<asp:ImageButton ID="ImageButton2" runat="server"
                            ImageAlign="AbsMiddle" ImageUrl="../images/Button/BtnReport.jpg" OnClick="ImageButton2_Click" />

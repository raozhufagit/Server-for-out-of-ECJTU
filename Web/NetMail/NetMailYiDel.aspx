<%@ Page Language="C#" AutoEventWireup="true" CodeFile="NetMailYiDel.aspx.cs" Inherits="NetMail_NetMailYiDel" %>
<html>
	<head>
    ...
    <div>    
     <table style="width: 100%" border="0" cellpadding="0" cellspacing="0">            
            <tr>
                ...
                <a class="hei" href="../Main/MyDesk.aspx">桌面</a>&nbsp;>>&nbsp;内部邮件&nbsp;>>&nbsp;已删除
                </td>
                <td align="right" valign="middle" style="border-bottom: #006633 1px dashed; height: 30px;">
                    ...
                    <asp:ImageButton ID="ImageButton5" runat="server" OnClientClick="javascript:return CheckHuiFu();" ImageUrl="../images/Button/ReLoad.jpg" ImageAlign="AbsMiddle" OnClick="ImageButton5_Click" />&nbsp;

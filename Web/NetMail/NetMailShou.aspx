<%@ Page Language="C#" AutoEventWireup="true" CodeFile="NetMailShou.aspx.cs" Inherits="NetMail_NetMailShou" %>
<html>
	<head>
    ...
    <div>    
     <table style="width: 100%" border="0" cellpadding="0" cellspacing="0">            
            <tr>
                ...
                <a class="hei" href="../Main/MyDesk.aspx">桌面</a>&nbsp;>>&nbsp;Internet邮件&nbsp;>>&nbsp;收件箱
                </td>
                <td align="right" valign="middle" style="border-bottom: #006633 1px dashed; height: 30px;">
                    ...
                    <asp:ImageButton ID="ImageButton5" runat="server" ImageUrl="../images/Button/GetMail.jpg" ImageAlign="AbsMiddle" OnClick="ImageButton5_Click" />
                    &nbsp;
        ...
        GridLines="None" style="line-height:22px;"  OnRowDataBound="GVData_RowDataBound" PageSize="15"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="邮件主题">
                            <ItemTemplate>
                                <a href='<%# "NetEmailView.aspx?ID="+ DataBinder.Eval(Container.DataItem, "ID")%>'> <%# DataBinder.Eval(Container.DataItem, "EmailTitle")%> </a>                                 
                            </ItemTemplate>

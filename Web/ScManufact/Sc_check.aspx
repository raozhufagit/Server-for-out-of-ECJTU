<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Sc_check.aspx.cs" Inherits="ScManufact_Sc_check" %>
...
<body>
	...
	<td style="padding-left: 5px; height: 25px; background-color: #ffffff" >
		  <asp:TextBox ID="txtSc_Yij" runat="server" Height="100px" TextMode="MultiLine" Width="400px"></asp:TextBox><BR /><BR />

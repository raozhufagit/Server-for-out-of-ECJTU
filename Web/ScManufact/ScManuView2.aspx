<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ScManuView2.aspx.cs" Inherits="ScManufact_ScManuView2" %>
...
<script type="text/javascript" language="JavaScript">
    $(document).ready(function () {
        ...
        toolbar.addText("info", 0, "生产进度");
        toolbar.addSeparator("sep0", 5);
        toolbar.addButton("rename", 10, "返回进度审核", "debug.gif", "debug_dis.gif");
        toolbar.addSeparator("sep0", 5);

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ScPlan.aspx.cs" Inherits="ScManufact_ScPlan" %>
     ...
     <table style="width: 100%" border="0" cellpadding="0" cellspacing="0">            
            <tr>
                ...
                <td align="right" valign="middle" style="border-bottom: #006633 1px dashed; height: 30px;">
                    ...
                    &nbsp;<asp:ImageButton ID="ImageButton2" runat="server" ImageUrl="../images/Button/BtnReport.jpg" ImageAlign="AbsMiddle" OnClick="ImageButton2_Click" /><img src="../images/Button/JianGe.jpg" />&nbsp;</td>
            </tr>
        </table>
        ...
        GridLines="None" style="line-height:22px;"  OnRowDataBound="GVData_RowDataBound" PageSize="15"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="生产单名称">
                           
                            <ItemTemplate> 
                             <a href='<%# "ScView.aspx?ID="+ DataBinder.Eval(Container.DataItem, "ID")%>'> <%# DataBinder.Eval(Container.DataItem, "Sc_Name")%> </a>
                            </ItemTemplate>                            
                            <ItemStyle HorizontalAlign="Left" />
                        </asp:TemplateField>    
                        <asp:BoundField DataField="Sc_Custmoer" HeaderText="所属客户"  HeaderStyle-Width="100px" >
<HeaderStyle Width="100px"></HeaderStyle>
                        </asp:BoundField>   
                        <asp:BoundField DataField="Sc_Timer" HeaderText="提交日期"  HeaderStyle-Width="120px" >
<HeaderStyle Width="120px"></HeaderStyle>
                        </asp:BoundField> 
                        <asp:BoundField DataField="Sc_Tjr" HeaderText="提交人"   HeaderStyle-Width="60px">
<HeaderStyle Width="60px"></HeaderStyle>
                        </asp:BoundField> 
                        <asp:BoundField DataField="ID" HeaderText="最后版本"   HeaderStyle-Width="60px">
<HeaderStyle Width="60px"></HeaderStyle>
                        </asp:BoundField>
                      <asp:BoundField DataField="ID" HeaderText="进度详情"   HeaderStyle-Width="100px">
<HeaderStyle Width="100px"></HeaderStyle> 
                        </asp:BoundField> 
 
                        <asp:BoundField DataField="Sc_State" HeaderText="操作处理"   HeaderStyle-Width="100px">
<HeaderStyle Width="100px"></HeaderStyle>
                        </asp:BoundField>  
                    </Columns>

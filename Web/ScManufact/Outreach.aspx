<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Outreach.aspx.cs" Inherits="ScManufact_Outreach" %>
        ...
        <table style="width: 100%">
            ...
            <td ><asp:GridView ID="GVData" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False"
                    ...
                    <Columns>
					 ...
					 <asp:BoundField DataField="OutVisitUnit" HeaderText="出访单位" ></asp:BoundField>
					<asp:BoundField DataField="OutVisitGroup" HeaderText="校内单位" ></asp:BoundField>     
					<asp:BoundField DataField="VisitPurpose" HeaderText="出访目的" ></asp:BoundField>  
                        <asp:BoundField DataField="VisitTime" HeaderText="出访时间" ></asp:BoundField>    
                        <asp:BoundField DataField="WorkReport" HeaderText="工作报告" ></asp:BoundField> 
                        <asp:BoundField DataField="WorkProgress" HeaderText="工作进度" ></asp:BoundField> 
                        <asp:BoundField DataField="Attchment" HeaderText="附件" ></asp:BoundField> 
</Columns>

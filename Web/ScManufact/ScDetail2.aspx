<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ScDetail2.aspx.cs" Inherits="ScManufact_ScDetail" %>
     ...
     <table style="width: 100%" border="0" cellpadding="0" cellspacing="0">            
        ...
        GridLines="None" style="line-height:22px;"  OnRowDataBound="GVData_RowDataBound" PageSize="15"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="文件版本名称">                           
                            <ItemTemplate> 
                            <a href='<%# "ScDetailView.aspx?ID="+ DataBinder.Eval(Container.DataItem, "ID")%>'> <%# DataBinder.Eval(Container.DataItem, "Pc_Name")%> </a>  
                            </ItemTemplate>                            
                            <ItemStyle HorizontalAlign="Left" />
                        </asp:TemplateField>    
                        <asp:BoundField DataField="Pc_Vesion" HeaderText="版本号"  HeaderStyle-Width="150px" >
<HeaderStyle Width="150px"></HeaderStyle>
                        </asp:BoundField>      
                        <asp:BoundField DataField="Pc_Timer" HeaderText="发布日期"   HeaderStyle-Width="150px">
<HeaderStyle Width="150px"></HeaderStyle>
                        </asp:BoundField> 
                        <asp:BoundField DataField="Pc_UserName" HeaderText="制单人"   HeaderStyle-Width="150px">
<HeaderStyle Width="150px"></HeaderStyle>
                        </asp:BoundField> 
                        <asp:BoundField DataField="Pc_State" HeaderText="可用操作"   HeaderStyle-Width="100px">

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ScManage.aspx.cs" Inherits="ScManufact_ScManage" %> 
<html>
	<head>
     ...
     <table style="width: 100%" border="0" cellpadding="0" cellspacing="0">            
        ...
        GridLines="None" style="line-height:22px;"  OnRowDataBound="GVData_RowDataBound" PageSize="15"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="Sc_Custmoer" HeaderText="所属客户"  HeaderStyle-Width="150px" >
<HeaderStyle Width="150px"></HeaderStyle>
                        </asp:BoundField>      
                        <asp:BoundField DataField="Sc_Jtime" HeaderText="交货日期"   HeaderStyle-Width="150px">
<HeaderStyle Width="150px"></HeaderStyle>
                        </asp:BoundField> 
                        <asp:BoundField DataField="Sc_Tjr" HeaderText="提交人"   HeaderStyle-Width="150px">
<HeaderStyle Width="150px"></HeaderStyle>
                        </asp:BoundField> 
                        <asp:BoundField DataField="Sc_State" HeaderText="生产单状态"   HeaderStyle-Width="100px">

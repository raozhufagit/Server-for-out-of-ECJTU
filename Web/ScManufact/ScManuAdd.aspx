<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ScManuAdd.aspx.cs" Inherits="ScManufact_ScManuAdd" %>
...
<table style="width: 100%" bgcolor="#999999" border="0" cellpadding="2" cellspacing="1">
	...
	<td style="padding-left: 5px; background-color: #ffffff" class="auto-style2" >
		<asp:TextBox id="txtSc_Jtime" runat="server" onClick="WdatePicker({startDate:'%y-%M-01 00:00:00',dateFmt:'yyyy-MM-dd HH:mm:ss',alwaysUseStartDate:true})" 

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PostManage.aspx.cs" Inherits="Post_PostManage" %>
<html>
	<head>
    ...
    <div>    
     <table style="width: 100%" border="0" cellpadding="0" cellspacing="0">            
            <tr>
                ...
                <a class="hei" href="../Main/MyDesk.aspx">桌面</a>&nbsp;>>&nbsp;挂职管理&nbsp;>>&nbsp;挂职信息
                </td>
        ...
        <table style="width: 100%">
            ...
            <td ><asp:GridView ID="GVData" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="挂职岗位名称">
                            <ItemTemplate>                                
                                <asp:HyperLink ID="HyperLink1" runat="server" Font-Underline="True"
                                    NavigateUrl='<%# "PostView.aspx?ID="+ DataBinder.Eval(Container.DataItem, "ID")%>'><%# DataBinder.Eval(Container.DataItem, "PostJobName")%></asp:HyperLink>
                            </ItemTemplate>                            
                            <ItemStyle HorizontalAlign="Left" />
                        
                        </asp:TemplateField> 
                        <asp:BoundField DataField="PubCompany" HeaderText="挂职单位名称" >
                        </asp:BoundField>  
                        <asp:BoundField DataField="PostJobType" HeaderText="挂职岗位类型" >
                        </asp:BoundField> 
                        <asp:BoundField DataField="PubTime" HeaderText="挂职信息发布时间" >
                        </asp:BoundField> 
                        <asp:BoundField DataField="RequiredProfession" HeaderText="要求专业" >
                        </asp:BoundField> 
                        <asp:BoundField DataField="RequiredAmount" HeaderText="挂职岗位数量" >
                        </asp:BoundField>     
                        <asp:BoundField DataField="PostState" HeaderText="挂职信息状态" >
                        </asp:BoundField>  
                    </Columns>

...
public partial class Post_PostManage : System.Web.UI.Page
{
    ...
    {
        LCX.BLL.Post MyModel = new LCX.BLL.Post();
        string name = LCX.Common.PublicMethod.GetSessionValue("UserName");
        if (Request.QueryString["TypeStr"].ToString().Trim() == "我的挂职")
        {
        ...
        {
            GVData.DataSource = MyModel.GetList("PostJobName Like '%" + this.TextBox1.Text + "%' order by ID desc");
    ...
    protected void ImageButton3_Click(object sender, ImageClickEventArgs e)
    {
        ...
        if (LCX.DBUtility.DbHelperSQL.ExecuteSQL("delete from Post where ID in (" + IDlist + ")") == -1)
        {
    ...
    protected void ImageButton5_Click(object sender, ImageClickEventArgs e)
    {
        ...
        Response.Redirect("PostModify.aspx?ID=" + CheckStrArray[0].ToString());
    }
}
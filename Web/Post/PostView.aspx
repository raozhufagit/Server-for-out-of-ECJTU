<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PostView.aspx.cs" Inherits="Post_PostView" %>
<html>
	<head>
...
<table style="width: 100%" bgcolor="#999999" border="0" cellpadding="2" cellspacing="1">
	...
	<td style="padding-left: 5px; height: 25px; background-color: #ffffff" >
		<asp:label id="PostJobName" runat="server" Width="241px"></asp:label>
        </td></tr>
	<tr>
	...
	<td style="padding-left: 5px; background-color: #ffffff" class="auto-style3" >
		<asp:label ID="PostJobType" runat="server" CssClass="auto-style1" Height="35px" Width="241px">           
        </asp:label>
	...
	<td style="padding-left: 5px; background-color: #ffffff" class="auto-style3" >
		<asp:label id="RequiredAmount" runat="server" ReadOnly="false" Width="241px"></asp:label>
		&nbsp;</td>
	...
	<td style="padding-left: 5px; height: 25px; background-color: #ffffff" >
        ...
        <asp:label id="PostDetail" runat="server" ReadOnly="false" Width="241px" ></asp:label>
	</td>
         </tr>
	<tr>
	<td style="background-color: #D6E2F3" align="right" class="auto-style2">

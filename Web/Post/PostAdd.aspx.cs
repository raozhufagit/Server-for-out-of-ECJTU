...
public partial class Post_PostAdd : System.Web.UI.Page
{
    ...
    protected void ImageButton1_Click(object sender, ImageClickEventArgs e)
    {
       ...
       LCX.BLL.LCXPinShen Approval = new LCX.BLL.LCXPinShen();
        ...
        Demand.DemandName = model.PostJobName;
        ...
        MyRiZhi.DoSomething = "用户添加挂职岗位信息(" + this.PostJobName.Text + ")";
        MyRiZhi.IpStr = System.Web.HttpContext.Current.Request.UserHostAddress.ToString();
        MyRiZhi.Add();

        LCX.Common.MessageBox.ShowAndRedirect(this, "项目信息添加成功！", "Post.aspx?ProjectName= &TypeStr=我发布的挂职岗位");
    }

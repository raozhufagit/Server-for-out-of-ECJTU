<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SelectJieDian.aspx.cs" Inherits="Main_SelectJieDian" %>
                    ...
                    <tr>
                        <td colspan="2" style="height: 31px; text-align: center;">
                            ...
                            <asp:GridView ID="GridView1" runat="server" AllowSorting="True"
                                AutoGenerateColumns="False" BorderWidth="1px" Width="100%" ShowHeader="False" AllowPaging="True" OnPageIndexChanging="GridView1_PageIndexChanging" >
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="NodeName" />
                                </Columns>

...
<body>
<div align="center" style="position: absolute; display:none; width: 100px; height: 16px; z-index: 1; left:50%; top:50%; margin:-150px 0 0 -100px;" id="load"><img src="http://sysimages.tq.cn/images/analysis_images/ajax-loader.gif" style="width:16px; height:16px"/>&nbsp;loading......</div>
 <div>
            ...
            function BuildTree() {
                ...
                var toolbar = new Ext.Toolbar({
                        ...
                        items:[{
                             ...
                             xtype: "tbbutton",
                             minWidth: 80,
                             text: "电子邮件  [<span style=\"color: red\" id=\"mailcount\">0</span>]",
                             cls: "x-btn-text-icon",
                             icon: "../Content/icons/email.png",
                             handler: function (btn, e) {
                                 var tabs = tabpanels;
                                 for (var i = 0; i < tabs.items.length; i++) {
                                     if (tabs.items.items[i].title == "电子邮件") {
                                         tabs.activate(tabs.items.items[i]);
                                         return;
                                     }
                                 }
                                 tabs.add({
                                     ...
                                     html: "<iframe style='visibility:hidden' onreadystatechange=stateChangeIE(this) onload=stateChangeFirefox(this) scrolling='true' width='100%' height='100%'  frameborder='0' src='../LanEmail/LanEmailShou.aspx'></iframe>",
                                     closable: true
                                 });
                             ...
                             handler: function (btn, e) {
                                 ...
                                 tabs.add({
                                     ...
                                     html: "<iframe style='visibility:hidden' onreadystatechange=stateChangeIE(this) onload=stateChangeFirefox(this) scrolling='true' width='100%' height='100%'  frameborder='0' src='../Work/RiCheng.aspx'></iframe>",
                                     closable: true
                                 });
                             ...
                             handler: function (btn, e) {
                                 ...
                                 tabs.add({
                                     ...
                                     html: "<iframe style='visibility:hidden' onreadystatechange=stateChangeIE(this) onload=stateChangeFirefox(this) scrolling='true' width='100%' height='100%'  frameborder='0' src='../Main/OnlineUser.aspx'></iframe>",
                                     closable: true
                                 });
        ...
        ({
            ...
            items:
             ...
             {
                 xtype: 'tbbutton',
                 text: '当前用户： <font color="black"><%= LCX.Common.PublicMethod.GetSessionValue("UserName")%></font>',
                 cls: 'x-btn-text-icon',
       ...
       var panel_west = new Ext.Panel
        ...
        <script type="text/javascript">
                ...
                $.ajax({
                    ...
                    success: function (mes) {
                        if (mes != "null") {
                            ...
                            Txtime = mes.toString().split(',')[2];
                            $(document).everyTime(Txtime, 'C', function () { SendTX(); });
                        } else {
                            alert("帐号过期，请重新登陆！");
            ...
            function ready() {
                ...
                sendRequest();
                SendTX();
                $(document).everyTime(60000, 'A', function (i) { sendRequest(); });
            }
            Ext.onReady(ready);
        </script>
    </div>

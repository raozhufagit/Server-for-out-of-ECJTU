...
public partial class Main : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!Page.IsPostBack)
        {
            ...
            //Response.Write(LCX.Common.PublicMethod.GetSessionValue("QuanXian"));

            //显示自定义导航快捷菜单
            //  this.Label3.Text = LCX.DBUtility.DbHelperSQL.GetSHSL("select top 1 DaoHangList from LCXUser where UserName='" + LCX.Common.PublicMethod.GetSessionValue("UserName") + "'");
            //绑定所有s的菜单项目
            ...
            //显示授权信息文字
            //this.Label1.Text = LCX.Common.DEncrypt.DESEncrypt.Decrypt(LCX.DBUtility.DbHelperSQL.GetSHSL("select top 1 DanWeiStr from LCXSerils"), "www.cnsoftweb.com-13696432490");

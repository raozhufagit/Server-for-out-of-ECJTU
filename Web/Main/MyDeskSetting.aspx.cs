...
public partial class Main_MyDeskSetting : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!Page.IsPostBack)
        {
            ...
            {
                if (LCX.Common.PublicMethod.StrIFIn("|" + ListBox1.Items[i].Value + "|", LCX.Common.PublicMethod.GetSessionValue("QuanXian")) == false)
                {
    ...
    {
        //删除旧有设置
        LCX.DBUtility.DbHelperSQL.ExecuteSQL("delete LCXUserDesk where UserName='" + LCX.Common.PublicMethod.GetSessionValue("UserName")+"'");
        //添加新设置
        ...
        LCX.Common.MessageBox.ShowAndRedirect(this, "修改桌面设置成功！", "MyDesk.aspx");

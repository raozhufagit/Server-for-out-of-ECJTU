<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SelectDanWei.aspx.cs" Inherits="SelectDanWei" %>
<html>
	<head>
		<title>选择部门单位</title> 
...
<body style="text-align: center">
   ...
   <div style="OVERFLOW:auto; padding-bottom:3px; padding-top:0px; padding-left:10px;padding-right:10px;" >
                        　　<asp:TreeView ID="ListTreeView" runat="server"  ShowCheckBoxes="All"　ShowLines="True" ExpandDepth="2" Font-Bold="False" OnSelectedNodeChanged="ListTreeView_SelectedNodeChanged">

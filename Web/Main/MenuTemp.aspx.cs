...
public partial class Main_MenuTemp : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        //while (MyReader.Read())
        //{
        //    string SqlSTr = "insert into LCXUser(xpwd,JiaoSe,Serils,TrueName,UserPwd,ZhiWei,BeiZhuStr,JiaTingDianHua,EmailStr,UserName,IfLogin,TiXingTime,IfTiXing) values('" + MYJiaMi.MD5(MyReader["UserPwd"].ToString(),32) + "','一般员工','" + MyReader["Serils"].ToString() + "','" + MyReader["TrueName"].ToString() + "','" + LCX.Common.DEncrypt.DESEncrypt.Encrypt(MyReader["UserPwd"].ToString()) + "','" + MyReader["ZhiWei"].ToString() + "','" + MyReader["BeiZhuStr"].ToString() + "','" + MyReader["JiaTingDianHua"].ToString() + "','" + MyReader["EmailStr"].ToString() + "','" + MyReader["TrueName"].ToString() + "','是','600','是')";
    ...
    {
        DataSet MYDTDT = LCX.DBUtility.DbHelperSQL.GetDataSet("select UserName from LCXUser");
    ...
    protected void Button3_Click(object sender, EventArgs e)
    {
        ...
        //{
        //    //写入根菜单
        //    LCX.BLL.LCXTreeList Model0 = new LCX.BLL.LCXTreeList();
        ...
        //    {
        //        //写入根菜单
        //        LCX.BLL.LCXTreeList Model1 = new LCX.BLL.LCXTreeList();
        ...
        //        {
        //            //写入根菜单
        //            LCX.BLL.LCXTreeList Model2 = new LCX.BLL.LCXTreeList();

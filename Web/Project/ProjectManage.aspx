                        ...
                        <asp:TemplateField HeaderText="项目名称">
                            <ItemTemplate>                                
                                <asp:HyperLink ID="HyperLink1" runat="server" Font-Underline="True"
                                    NavigateUrl='<%# "ProjectView.aspx?ID="+ DataBinder.Eval(Container.DataItem, "ID")%>'><%# DataBinder.Eval(Container.DataItem, "ProjectName")%></asp:HyperLink>
                            </ItemTemplate>                            
                            <ItemStyle HorizontalAlign="Left" />
                        </asp:TemplateField>                       
                         <asp:BoundField DataField="ProjectSerils" HeaderText="项目状态" >
                        </asp:BoundField>     
                        <asp:BoundField DataField="SuoShuKeHu" HeaderText="所属客户" >
                        </asp:BoundField>      
                        <asp:BoundField DataField="YuJiChengJiaoRiQi" HeaderText="预计成交日" >
                        </asp:BoundField> 
                        <asp:BoundField DataField="FuZeRen" HeaderText="负责人" >
                        </asp:BoundField> 
                        <asp:BoundField DataField="XiangMuJinE" HeaderText="项目金额" >
                        </asp:BoundField>                  
                    </Columns>

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="LiRuiGuanLi.aspx.cs" Inherits="Project_LiRuiGuanLi" %>
    ...
    <div>    
     <table style="width: 100%" border="0" cellpadding="0" cellspacing="0">            
            <tr>
                ...
                <a class="hei" href="../Main/MyDesk.aspx">桌面</a>&nbsp;>>&nbsp;项目管理&nbsp;>>&nbsp;项目利润
                </td>
                        ...
                        <asp:TemplateField HeaderText="项目名称">
                            <ItemTemplate>                                
                                <asp:HyperLink ID="HyperLink1" runat="server" Font-Underline="True"
                                    NavigateUrl='<%# "LiRunView.aspx?ID="+ DataBinder.Eval(Container.DataItem, "ID")%>'><%# DataBinder.Eval(Container.DataItem, "ProjectName")%></asp:HyperLink>
                            </ItemTemplate>                            
                            <ItemStyle HorizontalAlign="Left" />
                        </asp:TemplateField>                       
                         <asp:BoundField DataField="ProjectSerils" HeaderText="项目编号" >
                        </asp:BoundField>     
                        <asp:BoundField DataField="SumJinE" HeaderText="项目总金额" >
                        </asp:BoundField>      
                        <asp:BoundField DataField="FeiYong" HeaderText="项目费用" >
                        </asp:BoundField>  
                        <asp:BoundField DataField="ChengBen" HeaderText="项目成本" >
                        </asp:BoundField>  
                        <asp:BoundField DataField="FangZu" HeaderText="房租费用" >
                        </asp:BoundField>  
                        <asp:BoundField DataField="ShuiE" HeaderText="税额费用" >
                        </asp:BoundField>  
                        <asp:BoundField DataField="GongZi" HeaderText="员工工资" >
                        </asp:BoundField>  
                        <asp:BoundField DataField="TiCheng" HeaderText="业务员提成" >
                        </asp:BoundField>  
                        <asp:BoundField DataField="QiTa" HeaderText="其他费用" >
                        </asp:BoundField>  
                        <asp:BoundField DataField="ShiJi" HeaderText="实际利润" >
                        </asp:BoundField>  

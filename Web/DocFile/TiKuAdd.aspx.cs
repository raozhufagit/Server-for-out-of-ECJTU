...
public partial class DocFile_TiKuAdd : System.Web.UI.Page
{
	...
	protected void ImageButton1_Click(object sender, ImageClickEventArgs e)
	{
        ...
        LCX.Common.MessageBox.ShowAndRedirect(this, "题库管理信息添加成功！", "TiKu.aspx?TiKuID="+Request.QueryString["TiKuID"].ToString()+"&FenLeiStr="+Request.QueryString["FenLeiStr"].ToString());
	}
}

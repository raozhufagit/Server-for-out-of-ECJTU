     ...
     <table style="width: 100%" border="0" cellpadding="0" cellspacing="0">            
        ...
        <table style="width: 100%">
            ...
            <td ><asp:GridView ID="GVData" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False"
					...
					<asp:TemplateField HeaderText="应聘人姓名"> <ItemTemplate> <asp:HyperLink ID="HyperLink1" runat="server" Font-Underline="True" NavigateUrl='<%# "JianLiView.aspx?ID="+ DataBinder.Eval(Container.DataItem, "ID")%>'><%# DataBinder.Eval(Container.DataItem, "YPName")%></asp:HyperLink> </ItemTemplate>   <ItemStyle HorizontalAlign="Left" />  </asp:TemplateField> 
					<asp:BoundField DataField="YPDate" HeaderText="应聘日期" ></asp:BoundField>     
					<asp:BoundField DataField="YPSex" HeaderText="性别" ></asp:BoundField>     
					<asp:BoundField DataField="YPAge" HeaderText="年龄" ></asp:BoundField>     
					<asp:BoundField DataField="XueLi" HeaderText="学历" ></asp:BoundField>     
					<asp:BoundField DataField="ZhuanYe" HeaderText="专业" ></asp:BoundField>     
					<asp:BoundField DataField="YPZhiWei" HeaderText="应聘职位" ></asp:BoundField>     
					<asp:BoundField DataField="YPJieGuo" HeaderText="应聘结果" ></asp:BoundField>   
</Columns>

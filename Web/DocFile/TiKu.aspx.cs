...
public partial class DocFile_TiKu : System.Web.UI.Page
{
	...
	protected void ImageButton2_Click(object sender, ImageClickEventArgs e)
	{
		...
		LCX.Common.DataToExcel.GridViewToExcel(LCX.DBUtility.DbHelperSQL.GetDataSet("select  TitleStr,ItemsA,ItemsB,ItemsC,ItemsD,ItemsE,ItemsF,ItemsG,ItemsH,AnswerStr  from LCXQuestion where ID in (" + IDList + ") order by ID desc"), MyTable, "Excel报表");
	}

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="XueXiXinDeOK.aspx.cs" Inherits="DocFile_XueXiXinDe" %>
<html>
	<head>
     ...
     <table style="width: 100%" border="0" cellpadding="0" cellspacing="0">            
        ...
        <table style="width: 100%">
            ...
            <td ><asp:GridView ID="GVData" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False"
					...
					<asp:TemplateField HeaderText="心得标题"> <ItemTemplate> <asp:HyperLink ID="HyperLink1" runat="server" Font-Underline="True" NavigateUrl='<%# "XueXiXinDeView.aspx?ID="+ DataBinder.Eval(Container.DataItem, "ID")%>'><%# DataBinder.Eval(Container.DataItem, "XinDeTitle")%></asp:HyperLink>&nbsp;<asp:HyperLink ID="HyperLink2" runat="server" ForeColor="Red" Font-Underline="True" NavigateUrl='<%# "XueXiXinDeViewSP.aspx?ID="+ DataBinder.Eval(Container.DataItem, "ID")%>'>[签注意见]</asp:HyperLink> </ItemTemplate>   <ItemStyle HorizontalAlign="Left" />  </asp:TemplateField> 
					<asp:BoundField DataField="ShenPiContent" HeaderText="领导意见" ></asp:BoundField>     
					<asp:BoundField DataField="UserName" HeaderText="撰写用户" ></asp:BoundField>     

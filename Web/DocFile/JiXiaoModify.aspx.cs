...
public partial class DocFile_JiXiaoModify : System.Web.UI.Page
{
	...
	protected void ImageButton1_Click(object sender, ImageClickEventArgs e)
	{
        ...
        //清空上一次的详细记录，然后重新添加。
        LCX.DBUtility.DbHelperSQL.ExecuteSQL("delete from LCXJXDetails where JXID=" + Request.QueryString["ID"].ToString());
		...
		LCX.Common.MessageBox.ShowAndRedirect(this, "绩效考核信息修改成功！", "JiXiao.aspx");
	}
}

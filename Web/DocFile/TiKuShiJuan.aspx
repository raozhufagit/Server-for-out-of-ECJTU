<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TiKuShiJuan.aspx.cs" Inherits="DocFile_TiKuShiJuan" %>
<html>
	<head>
     ...
     <table style="width: 100%" border="0" cellpadding="0" cellspacing="0">            
        ...
        <table style="width: 100%">
            ...
            <td ><asp:GridView ID="GVData" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False"
					...
					<asp:TemplateField HeaderText="试卷标题"> <ItemTemplate> <asp:HyperLink ID="HyperLink1" runat="server" Font-Underline="True" NavigateUrl='<%# "TiKuShiJuanView.aspx?ID="+ DataBinder.Eval(Container.DataItem, "ID")%>'><%# DataBinder.Eval(Container.DataItem, "ShiJuanTitle")%></asp:HyperLink> 
                        <asp:Label ID="Label100" runat="server" Text=""></asp:Label>
					
					
					</ItemTemplate>   <ItemStyle HorizontalAlign="Left" />  </asp:TemplateField> 
					<asp:BoundField DataField="IFSuiJiChuTi" HeaderText="随机出题" ></asp:BoundField>     
					
					<asp:BoundField DataField="KaoShiXianShi" HeaderText="考试限时（分）" ></asp:BoundField>   
					<asp:BoundField DataField="BackInfo" HeaderText="备注说明" ></asp:BoundField>  
</Columns>

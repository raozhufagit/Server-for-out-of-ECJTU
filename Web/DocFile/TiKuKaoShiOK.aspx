<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TiKuKaoShiOK.aspx.cs" Inherits="DocFile_TiKuKaoShi" %>
<html>
	<head>
     ...
     <table style="width: 100%" border="0" cellpadding="0" cellspacing="0">            
        ...
        <table style="width: 100%">
            ...
            <td ><asp:GridView ID="GVData" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False"
					...
					<asp:TemplateField HeaderText="用户名"> <ItemTemplate> <asp:HyperLink ID="HyperLink1" runat="server" Font-Underline="True" NavigateUrl='<%# "TiKuKaoShiView.aspx?ID="+ DataBinder.Eval(Container.DataItem, "ID")%>'><%# DataBinder.Eval(Container.DataItem, "UserName")%></asp:HyperLink> </ItemTemplate>   <ItemStyle HorizontalAlign="Left" />  </asp:TemplateField> 
					<asp:BoundField DataField="ShiJuanName" HeaderText="所用试卷" ></asp:BoundField> 
					<asp:BoundField DataField="TimeStr" HeaderText="考试时间" ></asp:BoundField>     
                        <asp:TemplateField HeaderText="考试总分">                            
                            <ItemTemplate>
                                <asp:Label ID="Label1" runat="server" ></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="电脑阅卷得分">                            
                            <ItemTemplate>
                                <asp:Label ID="Label2" runat="server" ></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="人工阅卷得分">                            
                            <ItemTemplate>
                                <asp:Label ID="Label3" runat="server" ></asp:Label>
                                &nbsp;<asp:HyperLink ID="HyperLink2" runat="server" ForeColor="Blue" Font-Underline="True" NavigateUrl='<%# "TiKuKaoShiViewSP.aspx?ID="+ DataBinder.Eval(Container.DataItem, "ID") %>'>[人工阅卷]</asp:HyperLink>
                            </ItemTemplate>
                        </asp:TemplateField>
</Columns>

...
public partial class DocFile_XinChouView : System.Web.UI.Page
{
	...
	protected void Page_Load(object sender, EventArgs e)
	{
		if (!Page.IsPostBack)
		{
			...
			this.lblXCName.Text=Model.XCName.ToString();
			...
			MyRiZhi.DoSomething = "用户查看薪酬数据信息(" + this.lblXCName.Text + ")";

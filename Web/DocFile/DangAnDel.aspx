<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DangAnDel.aspx.cs" Inherits="DocFile_DangAn" %>
<html>
	<head>
    ...
    <div>    
     <table style="width: 100%" border="0" cellpadding="0" cellspacing="0">            
            <tr>
                ...
                <a class="hei" href="../Main/MyDesk.aspx">桌面</a>&nbsp;>>&nbsp;档案卷库&nbsp;>>&nbsp;档案销毁</td>
                <td align="right" valign="middle" style="border-bottom: #006633 1px dashed; height: 30px;">
                    ...
                    <asp:ImageButton ID="ImageButton3" runat="server" OnClientClick="javascript:return CheckDel();" ImageUrl="~/images/Button/ReLoad.jpg" ImageAlign="AbsMiddle" OnClick="ImageButton3_Click" />
                    <asp:ImageButton ID="ImageButton1" runat="server" OnClientClick="javascript:return CheckDel();" ImageUrl="../images/Button/BtnDel.jpg" ImageAlign="AbsMiddle" OnClick="ImageButton1_Click" />
        ...
        <table style="width: 100%">
            ...
            <td ><asp:GridView ID="GVData" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False"
					...
					<asp:BoundField DataField="TypeStr" HeaderText="文件分类" ></asp:BoundField>     
					<asp:BoundField DataField="GongWenType" HeaderText="公文类别" ></asp:BoundField>   
</Columns>

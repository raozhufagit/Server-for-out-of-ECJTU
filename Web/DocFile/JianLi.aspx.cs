...
public partial class DocFile_JianLi : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!Page.IsPostBack)
        {
            ...
            //设定按钮权限            
            ImageButton1.Visible = LCX.Common.PublicMethod.StrIFIn("|056A|", LCX.Common.PublicMethod.GetSessionValue("QuanXian"));
            ImageButton5.Visible = LCX.Common.PublicMethod.StrIFIn("|056M|", LCX.Common.PublicMethod.GetSessionValue("QuanXian"));
            ImageButton3.Visible = LCX.Common.PublicMethod.StrIFIn("|056D|", LCX.Common.PublicMethod.GetSessionValue("QuanXian"));
            ImageButton2.Visible = LCX.Common.PublicMethod.StrIFIn("|056E|", LCX.Common.PublicMethod.GetSessionValue("QuanXian"));
        }
    }
    #region  分页方法
	...
	{
		LCX.BLL.LCXJianLi MyModel = new LCX.BLL.LCXJianLi();
	...
	protected void ImageButton3_Click(object sender, ImageClickEventArgs e)
	{
		...
		if (LCX.DBUtility.DbHelperSQL.ExecuteSQL("delete from LCXJianLi where ID in (" + IDlist + ")") == -1)
		{
	...
	protected void ImageButton2_Click(object sender, ImageClickEventArgs e)
	{
		...
		LCX.Common.DataToExcel.GridViewToExcel(LCX.DBUtility.DbHelperSQL.GetDataSet("select  YPName,YPDate,YPSex,YPAge,XueLi,ZhuanYe,YPZhiWei,YPJieGuo,BackInfo,FuJianStr,UserName,TimeStr  from LCXJianLi where ID in (" + IDList + ") order by ID desc"), MyTable, "Excel报表");
	}

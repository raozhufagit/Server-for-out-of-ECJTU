<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DangAn.aspx.cs" Inherits="DocFile_DangAn" %>
<html>
	<head>
    ...
    <div>    
     <table style="width: 100%" border="0" cellpadding="0" cellspacing="0">            
            <tr>
                ...
                <a class="hei" href="../Main/MyDesk.aspx">桌面</a>&nbsp;>>&nbsp;档案卷库&nbsp;>>&nbsp;档案管理
                    &nbsp;
                    <asp:Label ID="Label1" runat="server" Font-Bold="True" ForeColor="Blue"></asp:Label></td>

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MianShi.aspx.cs" Inherits="DocFile_MianShi" %>
<html>
	<head>
    ...
    <div>    
     <table style="width: 100%" border="0" cellpadding="0" cellspacing="0">            
            <tr>
                ...
                <a class="hei" href="../Main/MyDesk.aspx">桌面</a>&nbsp;>>&nbsp;面试数据
                </td>
                <td align="right" valign="middle" style="border-bottom: #006633 1px dashed; height: 30px;">
					查询：<asp:DropDownList ID="DropDownList2" runat="server">
					<asp:ListItem Value="MSName">面试人姓名</asp:ListItem>
					<asp:ListItem Value="MSSex">性别</asp:ListItem>
					<asp:ListItem Value="MSAge">年龄</asp:ListItem>
					<asp:ListItem Value="XueLi">学历</asp:ListItem>
					<asp:ListItem Value="ZhuanYe">专业</asp:ListItem>
					<asp:ListItem Value="MSZhiWei">面试职位</asp:ListItem>
					<asp:ListItem Value="MSJieGuo">面试结果</asp:ListItem>
					</asp:DropDownList><asp:TextBox ID="TextBox3" runat="server" Width="80px"></asp:TextBox><img class="HerCss"
					onclick="var wName;var RadNum=Math.random();wName=window.showModalDialog('../Main/SelectCondition.aspx?TableName=LCXInterView&LieName='+document.getElementById('DropDownList2').value+'&Radstr='+RadNum,'','dialogWidth:350px;DialogHeight=400px;status:no;help:no;resizable:yes;');if(wName==null){}else{document.getElementById('TextBox3').value=wName;}"
        ...
        <table style="width: 100%">
            ...
            <td ><asp:GridView ID="GVData" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False"
					...
					<asp:TemplateField HeaderText="面试人姓名"> <ItemTemplate> <asp:HyperLink ID="HyperLink1" runat="server" Font-Underline="True" NavigateUrl='<%# "MianShiView.aspx?ID="+ DataBinder.Eval(Container.DataItem, "ID")%>'><%# DataBinder.Eval(Container.DataItem, "MSName")%></asp:HyperLink> </ItemTemplate>   <ItemStyle HorizontalAlign="Left" />  </asp:TemplateField> 
					<asp:BoundField DataField="MSDate" HeaderText="面试日期" ></asp:BoundField>     
					<asp:BoundField DataField="MSSex" HeaderText="性别" ></asp:BoundField>     
					<asp:BoundField DataField="MSAge" HeaderText="年龄" ></asp:BoundField>     
					<asp:BoundField DataField="XueLi" HeaderText="学历" ></asp:BoundField>     
					<asp:BoundField DataField="ZhuanYe" HeaderText="专业" ></asp:BoundField>     
					<asp:BoundField DataField="MSZhiWei" HeaderText="面试职位" ></asp:BoundField>     
					<asp:BoundField DataField="MSJieGuo" HeaderText="面试结果" ></asp:BoundField>  
</Columns>

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BuMenInfoSerch.aspx.cs" Inherits="SystemManage_BuMenInfo" %>
<html>
	<head>
...
<body>
    ...
    <div>    
     <table style="width: 100%" border="0" cellpadding="0" cellspacing="0">            
            <tr>
                <td valign="middle" style="border-bottom: #006633 1px dashed; height: 30px; width: 263px;">&nbsp;<img src="../images/BanKuaiJianTou.gif" />
                <a class="hei" href="../Main/MyDesk.aspx">桌面</a>&nbsp;>>&nbsp;组织机构 &gt;&gt; 部门信息查询
                </td>
                <td style="border-bottom: #006633 1px dashed; height: 30px; width: 173px;" valign="middle">
                        ...
                        <asp:TemplateField HeaderText="部门名称">
                            <ItemTemplate>
                                ...
                                <asp:HyperLink ID="HyperLink1" runat="server" Font-Underline="True"
                                    NavigateUrl='<%# "BuMenInfoSerch.aspx?View=List&DirID="+ DataBinder.Eval(Container.DataItem, "ID")%>'><%# DataBinder.Eval(Container.DataItem, "BuMenName")%></asp:HyperLink>
                            </ItemTemplate>

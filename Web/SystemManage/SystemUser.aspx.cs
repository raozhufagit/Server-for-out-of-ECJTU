...
public partial class SystemManage_SystemUser : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!Page.IsPostBack)
        {
            ...
            //设定按钮权限
            ImageButton1.Visible = LCX.Common.PublicMethod.StrIFIn("|086A|", LCX.Common.PublicMethod.GetSessionValue("QuanXian"));
            ImageButton5.Visible = LCX.Common.PublicMethod.StrIFIn("|086M|", LCX.Common.PublicMethod.GetSessionValue("QuanXian"));
            ImageButton3.Visible = LCX.Common.PublicMethod.StrIFIn("|086D|", LCX.Common.PublicMethod.GetSessionValue("QuanXian"));
            ImageButton2.Visible = LCX.Common.PublicMethod.StrIFIn("|086E|", LCX.Common.PublicMethod.GetSessionValue("QuanXian"));
    ...
    {
        //string xKeGuanDep = "'"+LCX.DBUtility.DbHelperSQL.GetSHSL("select top 1 xKeGuanDep from LCXUser where UserName='"+LCX.Common.PublicMethod.GetSessionValue("UserName").Replace(",","','")+"'")+"'";
    ...
    protected void GVData_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            MyHyp1.Visible = LCX.Common.PublicMethod.StrIFIn("|086C|", LCX.Common.PublicMethod.GetSessionValue("QuanXian"));
        }
    }
    ...
    protected void ImageButton3_Click(object sender, ImageClickEventArgs e)
    {
        ...
        if (LCX.DBUtility.DbHelperSQL.ExecuteSQL("delete from LCXUser where ID in (" + IDlist + ")") == -1)
        {
    ...
    protected void ImageButton2_Click(object sender, ImageClickEventArgs e)
    {
        ...
        LCX.Common.DataToExcel.GridViewToExcel(LCX.DBUtility.DbHelperSQL.GetDataSet("select UserName,TrueName,Serils,Department,JiaoSe from LCXUser where ID in (" + IDList + ") order by ID desc"), MyTable, "Excel报表");
    }

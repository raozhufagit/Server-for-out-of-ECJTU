<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SystemJiaoSe.aspx.cs" Inherits="SystemManage_SystemJiaoSe" %>
<html>
	<head>
    ...
    <div>    
     <table style="width: 100%" border="0" cellpadding="0" cellspacing="0">            
            <tr>
                ...
                <a class="hei" href="../Main/MyDesk.aspx">桌面</a>&nbsp;>>&nbsp;系统管理&nbsp;>>&nbsp;角色信息管理
                </td>
                        ...
                        <asp:TemplateField HeaderText="角色名称">
                            <ItemTemplate>
                                ...
                                <asp:HyperLink ID="HyperLink1" runat="server" Font-Underline="True"
                                    ...
                                    NavigateUrl='<%# "SystemJiaoSeUser.aspx?JiaoSeName="+ DataBinder.Eval(Container.DataItem, "JiaoSeName") %>'>[设置角色用户]</asp:HyperLink>
                                    
                            </ItemTemplate>                            
                            <ItemStyle HorizontalAlign="Left" />
                        </asp:TemplateField>
                        <asp:BoundField DataField="BackInfo" HeaderText="备注说明" >
                        </asp:BoundField>                        
                    </Columns>

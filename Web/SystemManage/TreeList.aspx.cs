...
public partial class SystemManage_TreeList : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!Page.IsPostBack)
        {
            ...
            //设定按钮权限            
            ImageButton1.Visible = LCX.Common.PublicMethod.StrIFIn("|099A|", LCX.Common.PublicMethod.GetSessionValue("QuanXian"));
            ImageButton5.Visible = LCX.Common.PublicMethod.StrIFIn("|099M|", LCX.Common.PublicMethod.GetSessionValue("QuanXian"));
            ImageButton3.Visible = LCX.Common.PublicMethod.StrIFIn("|099D|", LCX.Common.PublicMethod.GetSessionValue("QuanXian"));
            ImageButton2.Visible = LCX.Common.PublicMethod.StrIFIn("|099E|", LCX.Common.PublicMethod.GetSessionValue("QuanXian"));
        }
    }
    #region  分页方法
	...
	{
		LCX.BLL.LCXTreeList MyModel = new LCX.BLL.LCXTreeList();
	...
	protected void ImageButton3_Click(object sender, ImageClickEventArgs e)
	{
		...
		if (LCX.DBUtility.DbHelperSQL.ExecuteSQL("delete from LCXTreeList where ID in (" + IDlist + ")") == -1)
		{
	...
	protected void ImageButton2_Click(object sender, ImageClickEventArgs e)
	{
		...
		LCX.Common.DataToExcel.GridViewToExcel(LCX.DBUtility.DbHelperSQL.GetDataSet("select  TextStr,ImageUrlStr,ValueStr,NavigateUrlStr,Target,ParentID,QuanXianList,PaiXuStr  from LCXTreeList where ID in (" + IDList + ") order by ID desc"), MyTable, "Excel报表");
	}

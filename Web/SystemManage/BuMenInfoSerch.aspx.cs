...
public partial class SystemManage_BuMenInfo : System.Web.UI.Page
{
    ...
    public void GetDaoHang(int DirID)
    {
        ...
        else
        {
            if (this.Label1.Text.Trim() == "")
            {
                this.Label1.Text = "<a href=\"BuMenInfoSerch.aspx?View=List&DirID=" + DirID.ToString() + "\" >" + LCX.DBUtility.DbHelperSQL.GetSHSL("select BuMenName from LCXDept where ID=" + DirID.ToString()) + "</a>";
            }
            else
            {
                this.Label1.Text = "<a href=\"BuMenInfoSerch.aspx?View=List&DirID=" + DirID.ToString() + "\" >" + LCX.DBUtility.DbHelperSQL.GetSHSL("select BuMenName from LCXDept where ID=" + DirID.ToString()) + "</a>" + "\\" + this.Label1.Text;
            }

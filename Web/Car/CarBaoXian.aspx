<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CarBaoXian.aspx.cs" Inherits="Car_CarBaoXian" %>
<html>
	<head>
     ...
     <table style="width: 100%" border="0" cellpadding="0" cellspacing="0">            
        ...
        <table style="width: 100%">
            ...
            <td ><asp:GridView ID="GVData" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False"
					...
					<asp:TemplateField HeaderText="车辆名称"> <ItemTemplate> <asp:HyperLink ID="HyperLink1" runat="server" Font-Underline="True" NavigateUrl='<%# "CarBaoXianView.aspx?ID="+ DataBinder.Eval(Container.DataItem, "ID")%>'><%# DataBinder.Eval(Container.DataItem, "CarName")%></asp:HyperLink> </ItemTemplate>   <ItemStyle HorizontalAlign="Left" />  </asp:TemplateField> 
					<asp:BoundField DataField="FeiYongName" HeaderText="费用名称" ></asp:BoundField>     
					<asp:BoundField DataField="ProjectName" HeaderText="项目名称" ></asp:BoundField>     
					<asp:BoundField DataField="BaoXianPrice" HeaderText="保险金额" ></asp:BoundField>     
					<asp:BoundField DataField="BaoXianDate" HeaderText="保险日期" ></asp:BoundField>     
					<asp:BoundField DataField="TiXingDate" HeaderText="提醒日期" ></asp:BoundField> 
</Columns>

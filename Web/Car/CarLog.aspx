<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CarLog.aspx.cs" Inherits="Car_CarLog" %>
<html>
	<head>
     ...
     <table style="width: 100%" border="0" cellpadding="0" cellspacing="0">            
        ...
        <table style="width: 100%">
            ...
            <td ><asp:GridView ID="GVData" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False"
					...
					<asp:TemplateField HeaderText="车辆名称"> <ItemTemplate> <asp:HyperLink ID="HyperLink1" runat="server" Font-Underline="True" NavigateUrl='<%# "CarLogView.aspx?ID="+ DataBinder.Eval(Container.DataItem, "ID")%>'><%# DataBinder.Eval(Container.DataItem, "CarName")%></asp:HyperLink> </ItemTemplate>   <ItemStyle HorizontalAlign="Left" />  </asp:TemplateField> 
					<asp:BoundField DataField="LogDate" HeaderText="日志日期" ></asp:BoundField>     
					<asp:BoundField DataField="JingBanUser" HeaderText="经办人" ></asp:BoundField>     
					<asp:BoundField DataField="DriverUser" HeaderText="司机" ></asp:BoundField>     
					<asp:BoundField DataField="ChuCheDate" HeaderText="出车日期" ></asp:BoundField>   
					<asp:BoundField DataField="XingShiTime" HeaderText="行驶时间" ></asp:BoundField>  
					<asp:BoundField DataField="XingShiLiCheng" HeaderText="行驶里程" ></asp:BoundField>     
					<asp:BoundField DataField="YouHaoShu" HeaderText="油耗数" ></asp:BoundField>     
					<asp:BoundField DataField="DaoDaAddress" HeaderText="到达地点" ></asp:BoundField>  
</Columns>

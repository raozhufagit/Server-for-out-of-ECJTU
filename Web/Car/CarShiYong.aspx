<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CarShiYong.aspx.cs" Inherits="Car_CarShiYong" %>
<html>
	<head>
    ...
    <div>    
     <table style="width: 100%" border="0" cellpadding="0" cellspacing="0">            
            <tr>
                ...
                <a class="hei" href="../Main/MyDesk.aspx">桌面</a>&nbsp;>>&nbsp;车辆管理&nbsp;>>&nbsp;车辆使用
                </td>
        ...
        <table style="width: 100%">
            ...
            <td ><asp:GridView ID="GVData" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False"
					...
					<asp:BoundField DataField="JieShuTime" HeaderText="结束时间" ></asp:BoundField>     
					<asp:BoundField DataField="MuDiDi" HeaderText="目的地" ></asp:BoundField> 

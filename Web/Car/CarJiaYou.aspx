<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CarJiaYou.aspx.cs" Inherits="Car_CarJiaYou" %>
<html>
	<head>
    ...
    <div>    
     <table style="width: 100%" border="0" cellpadding="0" cellspacing="0">            
            <tr>
                ...
                <a class="hei" href="../Main/MyDesk.aspx">桌面</a>&nbsp;>>&nbsp;车辆加油记录
                </td>
        ...
        <table style="width: 100%">
            ...
            <td ><asp:GridView ID="GVData" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False"
					...
					<asp:TemplateField HeaderText="车辆名称"> <ItemTemplate> <asp:HyperLink ID="HyperLink1" runat="server" Font-Underline="True" NavigateUrl='<%# "CarJiaYouView.aspx?ID="+ DataBinder.Eval(Container.DataItem, "ID")%>'><%# DataBinder.Eval(Container.DataItem, "CarName")%></asp:HyperLink> </ItemTemplate>   <ItemStyle HorizontalAlign="Left" />  </asp:TemplateField> 
					<asp:BoundField DataField="JYDate" HeaderText="加油日期" ></asp:BoundField>     
					...
					<asp:BoundField DataField="JiaYouAddress" HeaderText="加油地点" ></asp:BoundField>  
					<asp:BoundField DataField="JiaYouNum" HeaderText="加油量" ></asp:BoundField>     
					<asp:BoundField DataField="YouFeiJinE" HeaderText="加油费用" ></asp:BoundField>  
</Columns>

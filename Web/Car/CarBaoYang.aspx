<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CarBaoYang.aspx.cs" Inherits="Car_CarBaoYang" %>
<html>
	<head>
    ...
    <div>    
     <table style="width: 100%" border="0" cellpadding="0" cellspacing="0">            
            <tr>
                ...
                <a class="hei" href="../Main/MyDesk.aspx">桌面</a>&nbsp;>>&nbsp;车辆保养记录
                </td>
        ...
        <table style="width: 100%">
            ...
            <td ><asp:GridView ID="GVData" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False"
					...
					<asp:TemplateField HeaderText="车辆名称"> <ItemTemplate> <asp:HyperLink ID="HyperLink1" runat="server" Font-Underline="True" NavigateUrl='<%# "CarBaoYangView.aspx?ID="+ DataBinder.Eval(Container.DataItem, "ID")%>'><%# DataBinder.Eval(Container.DataItem, "CarName")%></asp:HyperLink> </ItemTemplate>   <ItemStyle HorizontalAlign="Left" />  </asp:TemplateField> 
					<asp:BoundField DataField="BYDate" HeaderText="保养日期" ></asp:BoundField>     
					<asp:BoundField DataField="JingBanUser" HeaderText="经办人" ></asp:BoundField>     
					<asp:BoundField DataField="ZhuGuanUser" HeaderText="主管" ></asp:BoundField>        
					<asp:BoundField DataField="QiYouJinE" HeaderText="汽油金额" ></asp:BoundField>     
					<asp:BoundField DataField="BYJinE" HeaderText="保养金额" ></asp:BoundField>     
					<asp:BoundField DataField="WeiXiuJinE" HeaderText="维修金额" ></asp:BoundField>     
					<asp:BoundField DataField="OtherJinE" HeaderText="其他费用" ></asp:BoundField>  
</Columns>

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BookJieHuan.aspx.cs" Inherits="Office_BookJieHuan" %>
<html>
	<head>
    ...
    <div>    
     <table style="width: 100%" border="0" cellpadding="0" cellspacing="0">            
            <tr>
                ...
                <a class="hei" href="../Main/MyDesk.aspx">桌面</a>&nbsp;>>&nbsp;图书管理&nbsp;>>&nbsp;借阅管理
                </td>
        ...
        <table style="width: 100%">
            ...
            <td ><asp:GridView ID="GVData" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False"
					...
					<asp:BoundField DataField="UserName" HeaderText="借书人" ></asp:BoundField>     
					<asp:BoundField DataField="TimeStr" HeaderText="登记时间" ></asp:BoundField>     
</Columns>

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Officeacc.aspx.cs" Inherits="Office_Officeacc" %>
     ...
     <table style="width: 100%" border="0" cellpadding="0" cellspacing="0">            
            <tr>
                ...
                <td align="right" valign="middle" style="border-bottom: #006633 1px dashed; height: 30px;">
					...
					<asp:ListItem Value="OfficeName">办公用品名称</asp:ListItem>					
					<asp:ListItem Value="TypeStr">办公用品类别</asp:ListItem>
					<asp:ListItem Value="Serils">办公用品编码</asp:ListItem>
					<asp:ListItem Value="DanWei">计量单位</asp:ListItem>
                    <asp:ListItem Value="AcceptDepart">领用部门</asp:ListItem>
					<asp:ListItem Value="AcceptPeople">领用人</asp:ListItem>
					<asp:ListItem Value="UserName">操作员</asp:ListItem>
					</asp:DropDownList><asp:TextBox ID="TextBox3" runat="server" Width="80px"></asp:TextBox><img class="HerCss"
					onclick="var wName;var RadNum=Math.random();wName=window.showModalDialog('../Main/SelectCondition.aspx?TableName=LCXOffice&LieName='+document.getElementById('DropDownList2').value+'&Radstr='+RadNum,'','dialogWidth:350px;DialogHeight=400px;status:no;help:no;resizable:yes;');if(wName==null){}else{document.getElementById('TextBox3').value=wName;}"
        ...
        <table style="width: 100%">
            ...
            <td ><asp:GridView ID="GVData" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False"
					...
					<asp:TemplateField HeaderText="办公用品名称"> <ItemTemplate> <asp:HyperLink ID="HyperLink1" runat="server" Font-Underline="True" NavigateUrl='<%# "OfficeView.aspx?ID="+ DataBinder.Eval(Container.DataItem, "ID")%>'><%# DataBinder.Eval(Container.DataItem, "OfficeName")%></asp:HyperLink> </ItemTemplate>   <ItemStyle HorizontalAlign="Left" />  </asp:TemplateField> 
					
					<asp:BoundField DataField="TypeStr" HeaderText="办公用品类别" ></asp:BoundField>     
					<asp:BoundField DataField="Serils" HeaderText="办公用品编码" ></asp:BoundField>     
					<asp:BoundField DataField="DanWei" HeaderText="计量单位" ></asp:BoundField>  
                    <asp:BoundField DataField="AcceptDepart" HeaderText="领用部门" ></asp:BoundField>  
					<asp:BoundField DataField="AcceptPeople" HeaderText="领用人" ></asp:BoundField>      
					<asp:BoundField DataField="AcceptNum" HeaderText="领用数量" ></asp:BoundField> 
                    <asp:BoundField DataField="TimeStr" HeaderText="领用时间" ></asp:BoundField>       
</Columns>

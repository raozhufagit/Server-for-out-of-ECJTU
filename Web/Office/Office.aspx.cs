...
public partial class Office_Office : System.Web.UI.Page
{
	...
	protected void ImageButton3_Click(object sender, ImageClickEventArgs e)
	{
		...
		else
		{
			...
			MyRiZhi.DoSomething = "用户删除办公用品信息";
	...
	protected void ImageButton2_Click(object sender, ImageClickEventArgs e)
	{
		...
		MyTable.Add("MinNum", "最低警戒库存");
		MyTable.Add("MaxNum", "最高警戒库存");
		MyTable.Add("NowNum", "当前库存");
		MyTable.Add("UserName", "创建人");
		MyTable.Add("TimeStr", "创建时间");
		LCX.Common.DataToExcel.GridViewToExcel(LCX.DBUtility.DbHelperSQL.GetDataSet("select  OfficeName,MiaoShu,FuJianStr,TypeStr,Serils,DanWei,DanJia,GongYingShang,MinNum,MaxNum,NowNum,UserName,TimeStr  from LCXOffice where ID in (" + IDList + ") order by ID desc"), MyTable, "Excel报表");
	}

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Officerk.aspx.cs" Inherits="Office_Officerk" %>
<html>
	<head>
    ...
    <div>    
     <table style="width: 100%" border="0" cellpadding="0" cellspacing="0">            
            <tr>
                ...
                <a class="hei" href="../Main/MyDesk.aspx">桌面</a>&nbsp;>>&nbsp;办公用品入库
                </td>
                <td align="right" valign="middle" style="border-bottom: #006633 1px dashed; height: 30px;">
					...
					<asp:ListItem Value="GongYingShang">供应商</asp:ListItem>
        ...
        <table style="width: 100%">
            ...
            <td ><asp:GridView ID="GVData" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False"
                    ...
                    <asp:BoundField DataField="TotalMoeny" HeaderText="总价" ></asp:BoundField>
					<asp:BoundField DataField="GongYingShang" HeaderText="供应商" ></asp:BoundField>      
					<asp:BoundField DataField="RkNum" HeaderText="入库数量" ></asp:BoundField>       
</Columns>

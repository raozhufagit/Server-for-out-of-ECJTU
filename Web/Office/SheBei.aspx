<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SheBei.aspx.cs" Inherits="Office_SheBei" %>
<html>
	<head>
    ...
    <div>    
     <table style="width: 100%" border="0" cellpadding="0" cellspacing="0">            
            <tr>
                ...
                <a class="hei" href="../Main/MyDesk.aspx">桌面</a>&nbsp;>>&nbsp;仪器设备
                </td>
                <td align="right" valign="middle" style="border-bottom: #006633 1px dashed; height: 30px;">
					查询：<asp:DropDownList ID="DropDownList2" runat="server">
					<asp:ListItem Value="SheBeiName">设备名称</asp:ListItem>
					<asp:ListItem Value="YuanBianHao">原资产编号</asp:ListItem>
					<asp:ListItem Value="CaiWuBianHao">财务编号</asp:ListItem>
					<asp:ListItem Value="JiBuBianHao">技质部编号</asp:ListItem>
					<asp:ListItem Value="SheBeiLeiBie">设备类别</asp:ListItem>
					<asp:ListItem Value="XingHao">型号</asp:ListItem>
					<asp:ListItem Value="XiangMu">项目</asp:ListItem>
					<asp:ListItem Value="ChuChangBianHao">出厂编号</asp:ListItem>
					<asp:ListItem Value="ShiYongBuMen">使用部门</asp:ListItem>
					<asp:ListItem Value="ShengChanChangJia">生产厂家</asp:ListItem>
					<asp:ListItem Value="DanWei">单位</asp:ListItem>
					<asp:ListItem Value="SuYuanFangShi">溯源方式</asp:ListItem>
					<asp:ListItem Value="SuYaunDanWei">溯源单位</asp:ListItem>
					<asp:ListItem Value="ZhengShuBianHao">证书编号</asp:ListItem>
					<asp:ListItem Value="JieGuoPingJia">校准结果评价</asp:ListItem>
					<asp:ListItem Value="ZhengGai">整改内容及结果</asp:ListItem>
					<asp:ListItem Value="CunFangAddr">存放位置</asp:ListItem>
					<asp:ListItem Value="GuanLiUser">管理人</asp:ListItem>
					<asp:ListItem Value="ZhuangTai">设备状态</asp:ListItem>
					<asp:ListItem Value="BeiZhu">备注</asp:ListItem>
					<asp:ListItem Value="HeDuiUser">核对人</asp:ListItem>
					<asp:ListItem Value="TiXingUser">被提醒人</asp:ListItem>
        ...
        <table style="width: 100%">
            ...
            <td ><asp:GridView ID="GVData" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False"
					...
					<asp:TemplateField HeaderText="设备名称"> <ItemTemplate> <asp:HyperLink ID="HyperLink1" runat="server" Font-Underline="True" NavigateUrl='<%# "SheBeiView.aspx?ID="+ DataBinder.Eval(Container.DataItem, "ID")%>'><%# DataBinder.Eval(Container.DataItem, "SheBeiName")%></asp:HyperLink> </ItemTemplate>   <ItemStyle HorizontalAlign="Left" />  </asp:TemplateField> 
					<asp:BoundField DataField="YuanBianHao" HeaderText="原资产编号" ></asp:BoundField>   
					<asp:BoundField DataField="XingHao" HeaderText="型号" ></asp:BoundField>     
					<asp:BoundField DataField="XiangMu" HeaderText="项目" ></asp:BoundField>     
					<asp:BoundField DataField="ChuChangBianHao" HeaderText="出厂编号" ></asp:BoundField>  
					<asp:BoundField DataField="SuYuanZhouQi" HeaderText="溯源周期(月)" ></asp:BoundField>     
					<asp:BoundField DataField="JiHuaSuYaunDate" HeaderText="计划溯源日期" ></asp:BoundField>       
					<asp:BoundField DataField="CunFangAddr" HeaderText="存放位置" ></asp:BoundField>     
					<asp:BoundField DataField="GuanLiUser" HeaderText="管理人" ></asp:BoundField>  
					<asp:BoundField DataField="ZhuangTai" HeaderText="设备状态" ></asp:BoundField>     

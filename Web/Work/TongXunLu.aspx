    ...
    <div>    
     <table style="width: 100%" border="0" cellpadding="0" cellspacing="0">            
            <tr>
                ...
                <a class="hei" href="../Main/MyDesk.aspx">桌面</a>&nbsp;>>&nbsp;通讯簿管理&nbsp;>>&nbsp;<%=Request.QueryString["TypeStr"].ToString()%>
                </td>
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="姓名">
                            <ItemTemplate><asp:HyperLink ID="HyperLink1" runat="server" Font-Underline="True"
                                    NavigateUrl='<%# "TongXunLuView.aspx?ID="+ DataBinder.Eval(Container.DataItem, "ID")%>'><%# DataBinder.Eval(Container.DataItem, "NameStr")%></asp:HyperLink>
                            </ItemTemplate>                            
                            <ItemStyle HorizontalAlign="Left" />
                        </asp:TemplateField>
                        <asp:BoundField DataField="Sex" HeaderText="性别" >                            
                        </asp:BoundField>
                        <asp:BoundField DataField="DanWeiMingCheng" HeaderText="单位名称" >                            
                        </asp:BoundField>
                        <asp:BoundField DataField="DanWieDianHua" HeaderText="单位电话" >                            
                        </asp:BoundField>
                        <asp:BoundField DataField="JiaTingDianHua" HeaderText="家庭电话" >                            
                        </asp:BoundField>
                        <asp:BoundField DataField="ShouJi" HeaderText="手机" >                            
                        </asp:BoundField>
                        <asp:BoundField DataField="Email" HeaderText="电子邮件" >                            
                        </asp:BoundField>
                        <asp:BoundField DataField="IfShare" HeaderText="是否共享" >                            
                        </asp:BoundField>
                    </Columns>

...
public partial class NWorkFlow_PrintWork : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!Page.IsPostBack)
        {
            ...
            this.Label3.Text = this.Label3.Text.Replace("id=Drop", "class=\"SelectList\" id=Drop");//将下拉框的边框去掉
           // this.Label3.Text = this.Label3.Text.Replace("id=Drop", "style=\"width:150px;border:none;margin:-2px;overflow:hidden;background-color:#FFFFFF\" id=Drop");//将下拉框的边框去掉

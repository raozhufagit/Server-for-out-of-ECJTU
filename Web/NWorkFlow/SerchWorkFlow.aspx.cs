...
public partial class NWorkFlow_SerchWorkFlow : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!Page.IsPostBack)
        {
            ...
            //设定按钮权限                        
            ImageButton2.Visible = LCX.Common.PublicMethod.StrIFIn("|018E|", LCX.Common.PublicMethod.GetSessionValue("QuanXian"));
        }
    }
    #region  分页方法

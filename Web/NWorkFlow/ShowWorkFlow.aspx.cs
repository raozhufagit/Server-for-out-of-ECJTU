...
{    
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            ...
            string SQL_GetList = "select * from LCX_WorkFlowNode   where  WorkFlowID=" + Request.QueryString["WorkFlowID"] + "  order by NodeSerils asc,ID desc";
            DataSet MYDT = LCX.DBUtility.DbHelperSQL.GetDataSet(SQL_GetList);
            int i1 = 20;

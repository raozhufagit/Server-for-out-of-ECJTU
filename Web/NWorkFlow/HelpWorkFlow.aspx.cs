...
public partial class NWorkFlow_HelpWorkFlow : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!Page.IsPostBack)
        {
            ...
            //设定按钮权限
            ImageButton3.Visible = LCX.Common.PublicMethod.StrIFIn("|019D|", LCX.Common.PublicMethod.GetSessionValue("QuanXian"));
            ImageButton2.Visible = LCX.Common.PublicMethod.StrIFIn("|019E|", LCX.Common.PublicMethod.GetSessionValue("QuanXian"));
        }
    }
    #region  分页方法
    ...
    protected void GVData_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            MyHyp.Visible = LCX.Common.PublicMethod.StrIFIn("|019M|", LCX.Common.PublicMethod.GetSessionValue("QuanXian"));
        }
    }

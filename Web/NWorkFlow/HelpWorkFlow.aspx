<%@ Page Language="C#" AutoEventWireup="true" CodeFile="HelpWorkFlow.aspx.cs" Inherits="NWorkFlow_HelpWorkFlow" %>
<html>
	<head>
    ...
    <div>    
     <table style="width: 100%" border="0" cellpadding="0" cellspacing="0">            
            <tr>
                ...
                <a class="hei" href="../Main/MyDesk.aspx">桌面</a>&nbsp;>>&nbsp;工作管理&nbsp;>>&nbsp;工作监控
                </td>
        ...
        <table style="width: 100%">
            ...
            <td ><asp:GridView ID="GVData" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False"
					...
					<asp:TemplateField HeaderText="工作名称"> <ItemTemplate> <asp:HyperLink ID="HyperLink1" runat="server" Font-Underline="True" NavigateUrl='<%# "NWorkToDoView.aspx?ID="+ DataBinder.Eval(Container.DataItem, "ID")%>'><%# DataBinder.Eval(Container.DataItem, "WorkName")%></asp:HyperLink>&nbsp;<asp:HyperLink ID="HyperLink2" runat="server" Font-Underline="True" NavigateUrl='<%# "DoWork.aspx?DoType=qiangzhi&ID="+ DataBinder.Eval(Container.DataItem, "ID") %>' Font-Bold="true" ForeColor="Red">[强制办理]</asp:HyperLink> </ItemTemplate>   <ItemStyle HorizontalAlign="Left" />  </asp:TemplateField> 
					...
					<asp:BoundField DataField="ShenPiUserList" HeaderText="当前审批用户" ></asp:BoundField>     
					<asp:BoundField DataField="OKUserList" HeaderText="当前已审批用户" ></asp:BoundField>     

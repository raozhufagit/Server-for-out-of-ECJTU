<%@ Page Language="C#" AutoEventWireup="true" CodeFile="NWorkFlow.aspx.cs" Inherits="NWorkFlow_NWorkFlow" %>
<html>
	<head>
     ...
     <table style="width: 100%" border="0" cellpadding="0" cellspacing="0">            
            <tr>
                <td align="right" style="border-bottom: #006633 1px dashed; height: 30px; text-align: left"
                    valign="middle">
                    &nbsp;<img src="../images/BanKuaiJianTou.gif" /> &nbsp;表单：<asp:Label ID="Label1" runat="server"></asp:Label></td>
                <td align="right" valign="middle" style="border-bottom: #006633 1px dashed; height: 30px;">
					查询：<asp:DropDownList ID="DropDownList2" runat="server">
					<asp:ListItem Value="WorkFlowName">流程名称</asp:ListItem>
        ...
        <table style="width: 100%">
            ...
            <td ><asp:GridView ID="GVData" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False"
					...
					<asp:TemplateField HeaderText="流程名称"> <ItemTemplate> <asp:HyperLink ID="HyperLink1" runat="server" Font-Underline="True" NavigateUrl='<%# "NWorkFlowView.aspx?ID="+ DataBinder.Eval(Container.DataItem, "ID")%>'><%# DataBinder.Eval(Container.DataItem, "WorkFlowName")%></asp:HyperLink> </ItemTemplate>   <ItemStyle HorizontalAlign="Left" />  </asp:TemplateField> 
					...
					<asp:TemplateField HeaderText="相关操作"><ItemTemplate>
                        ...
                        <asp:HyperLink ID="HyperLink10" runat="server" Font-Underline="True" NavigateUrl='<%# "NWorkFlowNode.aspx?FormID="+DataBinder.Eval(Container.DataItem, "FormID")+"&WorkFlowID="+ DataBinder.Eval(Container.DataItem, "ID") %>' ForeColor="Blue">[节点定义]</asp:HyperLink>
                        <asp:HyperLink ID="HyperLink11" runat="server" Font-Underline="True" Target="_blank" NavigateUrl='<%# "NWorkFlowReView.aspx?FormID="+DataBinder.Eval(Container.DataItem, "FormID")+"&WorkFlowID="+ DataBinder.Eval(Container.DataItem, "ID") %>' ForeColor="Blue">[流程预览]</asp:HyperLink>

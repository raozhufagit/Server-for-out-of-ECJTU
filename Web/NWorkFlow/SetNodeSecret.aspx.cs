...
public partial class NWorkFlow_SetNodeSecret : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!Page.IsPostBack)
        {
            ...
            //绑定当前节点已有选定的字段项目
            string[] ZiDuanList1 = LCX.DBUtility.DbHelperSQL.GetSHSL("select top 1 SecretSet from LCX_WorkFlowNode where ID=" + Request.QueryString["ID"].ToString()).Split('|');
    ...
    protected void ImageButton1_Click(object sender, ImageClickEventArgs e)
    {
        ...
        LCX.DBUtility.DbHelperSQL.ExecuteSQL("update LCX_WorkFlowNode set SecretSet='" + CanWriteStr + "' where ID=" + Request.QueryString["ID"].ToString());
        ...
        LCX.Common.MessageBox.ShowAndRedirect(this, "保密字段设置成功！", "NWorkFlowNode.aspx?WorkFlowID=" + Request.QueryString["WorkFlowID"].ToString());
    }
}

...
public partial class NWorkFlow_NFormList : System.Web.UI.Page
{
    ...
    private void BindTree()
    {
        ...
        for (int j = 0; j < MyDataSet1.Tables[0].Rows.Count; j++)
        {
            ...
            //~~~~~~~~~~~~~插入表单子节点
            DataSet MyDataSet = LCX.DBUtility.DbHelperSQL.GetDataSet("select * from LCX_Form where TypeID=" + MyDataSet1.Tables[0].Rows[j]["ID"].ToString() + " order by PaiXuStr asc, ID desc");

...
public partial class NWorkFlow_NFormView : System.Web.UI.Page
{
	...
	protected void Page_Load(object sender, EventArgs e)
	{
		if (!Page.IsPostBack)
		{
            ...
            this.lblTypeID.Text = LCX.DBUtility.DbHelperSQL.GetSHSL("select top 1 TypeName from LCX_FormType where ID=" + Model.TypeID.ToString());

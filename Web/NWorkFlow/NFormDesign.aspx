<%@ Page Language="C#" AutoEventWireup="true" CodeFile="NFormDesign.aspx.cs" Inherits="NWorkFlow_NFormDesign" %>
...
if(str=="20")   //下接列表框
{
    ...
    {           
        ...
        {   
			 if(i==0){
				TempOptionStr=TempOptionStr+'<OPTION value="'+OptionStr[i]+'" selected="selected">'+OptionStr[i]+'</OPTION>';				
			 }else{
               TempOptionStr=TempOptionStr+'<OPTION value="'+OptionStr[i]+'" >'+OptionStr[i]+'</OPTION>';
			 }
        }
	
		editor.execCommand("insertHtml",'<div class="DivSelect"><SELECT id="Drop'+cValue+'"  name="Drop'+cValue+'"  alt="'+document.getElementById("TextBox11").value+'" > '+TempOptionStr+'</SELECT></div>');        
		...
		alert('中文字段名称、下拉字段默认值不可为空！');
	}
}
else if(str=="1")
{
    if(document.getElementById("TextBox5").value.length>0){
   editor.execCommand("insertHtml",'<input id="Text'+cValue+'"  name="Text'+cValue+'" alt="'+document.getElementById("TextBox5").value+'"  type="text"  style="border:0px"/>');
...
else if(str=="2")
{
    if(document.getElementById("TextBox7").value.length>0){
   		editor.execCommand("insertHtml",'<textarea id="TextArea'+cValue+'" name="TextArea'+cValue+'"  alt="'+document.getElementById("TextBox7").value+'"   cols="20" rows="2"  style="SCROLLBAR-FACE-COLOR: #AAAAAA; SCROLLBAR-HIGHLIGHT-COLOR: #D8D8D8; SCROLLBAR-SHADOW-COLOR: #D8D8D8; SCROLLBAR-3DLIGHT-COLOR: #D8D8D8; SCROLLBAR-ARROW-COLOR:   #D8D8D8;   SCROLLBAR-TRACK-COLOR:#D8D8D8;SCROLLBAR-DARKSHADOW-COLOR: #D8D8D8; border:0px">等待输入内容</textarea>');
...
else if(str=="12")
{
   ...
   editor.execCommand("insertHtml",'<input id="Num'+cValue+'"  name="Num'+cValue+'" alt="'+document.getElementById("TextBox6").value+'"    type="text"  style="IME-MODE: disabled;border:0px"  onkeypress="var k=event.keyCode; return (k>=48&&k<=57)||k==46" onpaste="return !/\D/.test(clipboardData.getData(\'text\'))"  ondragenter="return false"/>');
...
else if(str=="13")
{
   ...
   editor.execCommand("insertHtml",'<input id="Date'+cValue+'" name="Date'+cValue+'" alt="'+document.getElementById("TextBox8").value+'"  type="text" onclick="WdatePicker()" value=""  style="border:0px"/>');
...
else if(str=="4")
{
    if(document.getElementById("TextBox1").value.length>0){
			editor.execCommand("insertHtml",'<input readonly id="Text'+cValue+'" name="Text'+cValue+'" alt="'+document.getElementById("TextBox1").value+'" type="text" value="宏控件-用户姓名" style="border:0px"/>');
...
else if(str=="5")
{
   ...
   editor.execCommand("insertHtml",'<input readonly id="Text'+cValue+'" name="Text'+cValue+'" alt="'+document.getElementById("TextBox3").value+'" type="text" value="宏控件-用户部门" style="border:0px;"/>');
...
else if(str=="6")
{
   ...
   editor.execCommand("insertHtml",'<input readonly id="Text'+cValue+'"  name="Text'+cValue+'" alt="'+document.getElementById("TextBox4").value+'"  type="text" value="宏控件-用户角色" style="border:0px;"/>');
...
else if(str=="7")
{
   ...
   editor.execCommand("insertHtml",'<input readonly id="Text'+cValue+'"  name="Text'+cValue+'" alt="'+document.getElementById("TextBox10").value+'" type="text" value="宏控件-用户职位" style="border:0px;"/>');
...
else if(str=="8")
{
   ...
   editor.execCommand("insertHtml",'<input readonly id="Text'+cValue+'"  name="Text'+cValue+'" alt="'+document.getElementById("TextBox12").value+'" type="text" value="宏控件-当前日期" style="border:0px;"/>');
...
else if(str=="101")
{
   ...
   editor.execCommand("insertHtml",'<input readonly id="Text'+cValue+'"  name="Text'+cValue+'" alt="'+document.getElementById("TextBox13").value+'" onclick="selectUser(Text'+cValue+');"  type="text" value="点击选择用户" style="border:0px"/>');
...
else if(str=="102")
{
   ...
   editor.execCommand("insertHtml",'<input readonly id="Text'+cValue+'"  name="Text'+cValue+'" alt="'+document.getElementById("TextBox14").value+'" onclick="selectBuMen(Text'+cValue+');"  type="text" value="点击选择部门" style="border:0px"/>');
...
else if(str=="103")
{
   ...
   editor.execCommand("insertHtml",'<input readonly id="Text'+cValue+'"  name="Text'+cValue+'"  alt="'+document.getElementById("TextBox15").value+'" type="text" value="宏控件-部门主管" style="border:0px"/>');
...
<body>
    ...
    <div>
        <table id="PrintHide" style="width: 100%" border="0" cellpadding="0" cellspacing="0">
            <tr>
                <td valign="middle" style="border-bottom: #006633 1px dashed; height: 30px;">
                    &nbsp;<img src="../images/BanKuaiJianTou.gif" /></img>
                    <a class="hei" href="../Main/MyDesk.aspx">桌面</a>&nbsp;>>&nbsp;流程表单&nbsp;>>&nbsp;表单设计器
                </td>
                <td style="border-bottom: #006633 1px dashed; height: 30px; text-align: right" valign="middle">
        ...
        <table style="width: 100%" bgcolor="#999999" border="0" cellpadding="2" cellspacing="1">
            <tr>
                <td style="width: 208px; height: 25px; background-color: #D6E2F3; text-align: center;
                ...
                <td style="padding-left: 5px; height: 25px; background-color: #ffffff; vertical-align: top;">
                    ...
                    <script type="text/javascript">
                        var editor = new UE.ui.Editor({ id: 'editor', minFrameHeight: 520 }); editor.render("TxtContent");
                    </script>
                    <br />

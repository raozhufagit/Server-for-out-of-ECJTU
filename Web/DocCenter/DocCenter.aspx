<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DocCenter.aspx.cs" Inherits="DocCenter_DocCenter" %>
<html>
	<head>
    ...
    <div>    
     <table style="width: 100%" border="0" cellpadding="0" cellspacing="0">            
            <tr>
                ...
                <a class="hei" href="../Main/MyDesk.aspx">桌面</a>&nbsp;>>&nbsp;文件中心&nbsp;>>&nbsp;<%=Request.QueryString["Type"].ToString() %>
                </td>
                <td align="right" valign="middle" style="border-bottom: #006633 1px dashed; height: 30px;">
                    查询：<asp:TextBox ID="TextBox1" runat="server" Height="20px" Width="100px"></asp:TextBox><asp:ImageButton
                        ...
                        OnClick="ImageButton4_Click" />&nbsp;&nbsp;&nbsp;<asp:ImageButton ID="ImageButton6" runat="server" ImageUrl="../images/Button/BtnAddDir.jpg" ImageAlign="AbsMiddle" OnClick="ImageButton6_Click" />&nbsp;
        ...
        <table style="width: 100%">
            ...
            <td ><asp:GridView ID="GVData" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="BianHao" HeaderText="文档编号" >                            
                        </asp:BoundField>
                        <asp:BoundField DataField="DaXiao" HeaderText="大小(KB)" >                            
                        </asp:BoundField>
                        <asp:BoundField DataField="ShangChuanTime" HeaderText="上传时间" >                            
                        </asp:BoundField>

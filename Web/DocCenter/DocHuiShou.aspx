<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DocHuiShou.aspx.cs" Inherits="DocCenter_DocHuiShou" %>
<html>
	<head>
    ...
    <div>    
     <table style="width: 100%" border="0" cellpadding="0" cellspacing="0">            
            <tr>
                ...
                <a class="hei" href="../Main/MyDesk.aspx">桌面</a>&nbsp;>>&nbsp;文件中心&nbsp;>>&nbsp;回收站
                </td>
                <td align="right" valign="middle" style="border-bottom: #006633 1px dashed; height: 30px;">
                    ...
                    &nbsp;<asp:ImageButton ID="ImageButton1" runat="server" OnClientClick="javascript:return CheckHuiFu();" ImageUrl="~/images/Button/BtnHuiFu.jpg" ImageAlign="AbsMiddle" OnClick="ImageButton1_Click" />

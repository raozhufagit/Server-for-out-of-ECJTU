     ...
     <table style="width: 100%" border="0" cellpadding="0" cellspacing="0">            
         ...
         <tr>
             <td colspan="2" style="border-bottom: #006633 1px dashed; height: 30px" valign="middle">
                 &nbsp; &nbsp; 所属部门：<asp:TextBox ID="TextBox1" runat="server" Height="20px" Width="80px"></asp:TextBox><img
                        class="HerCss" onclick="var wName;var RadNum=Math.random();wName=window.showModalDialog('../Main/SelectDanWei.aspx?TableName=LCXDept&LieName=BuMenName&Radstr='+RadNum,'','dialogWidth:350px;DialogHeight=400px;status:no;help:no;resizable:yes;');if(wName==null){}else{document.getElementById('TextBox1').value=wName;}"
                    ...
                    <asp:ImageButton
                        ...
                        OnClick="ImageButton4_Click" />&nbsp;&nbsp;&nbsp;<span style="color: #0000cc">&nbsp;注：每次只可查询单一部门，不选择即代表所有</span></td>
         </tr>
        </table>

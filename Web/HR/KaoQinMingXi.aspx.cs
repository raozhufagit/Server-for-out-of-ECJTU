...
public partial class HR_KaoQinMingXi : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!Page.IsPostBack)
        {
            ...
            //设定按钮权限            
            ImageButton2.Visible = LCX.Common.PublicMethod.StrIFIn("|107E|", LCX.Common.PublicMethod.GetSessionValue("QuanXian"));
        }
    }
    public void DataBindToGridview()
    {
        LCX.BLL.LCXAttendance MyModel = new LCX.BLL.LCXAttendance();
        GVData.DataSource = MyModel.GetList("UserName ='" + this.TextBox1.Text.Trim() + "' and (KaoQinRiQi BETWEEN '" + this.TextBox2.Text.Trim() + " 00:00:00' and '" + this.TextBox3.Text.Trim() + " 23:59:59')  order by KaoQinRiQi asc");
        GVData.DataBind();

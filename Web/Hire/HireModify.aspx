<%@ Page Language="C#" AutoEventWireup="true" CodeFile="HireModify.aspx.cs" Inherits="HireModify" %>
<html>
	<head>
    ...
    <div>    
     <table id="PrintHide" style="width: 100%" border="0" cellpadding="0" cellspacing="0">            
            <tr>
                ...
                <a class="hei" href="../Main/MyDesk.aspx">桌面</a>&nbsp;>>&nbsp;人才招聘信息管理&nbsp;>>&nbsp;添加人才招聘信息
                </td>
...
<table style="width: 100%" bgcolor="#999999" border="0" cellpadding="2" cellspacing="1">
	...
	<td style="padding-left: 5px; height: 25px; background-color: #ffffff" >
		<asp:TextBox id="HireJobName" runat="server" Width="241px"></asp:TextBox>
        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="HireJobName"
	...
	<td style="padding-left: 5px; background-color: #ffffff" class="auto-style3" >
		<asp:DropDownList ID="HireJobType" runat="server" CssClass="auto-style1" Height="35px" Width="241px">
	...
	<td style="padding-left: 5px; background-color: #ffffff" class="auto-style3" >
		...
		&nbsp;<asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ControlToValidate="ContactPerson"
	...
	<td style="padding-left: 5px; height: 25px; background-color: #ffffff" >
		<asp:TextBox id="HireDetail" runat="server" Width="245px" Height="90px" TextMode="MultiLine"></asp:TextBox>&nbsp;
	    <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ControlToValidate="HireDetail"

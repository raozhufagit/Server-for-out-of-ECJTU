<%@ Page Language="C#" AutoEventWireup="true" CodeFile="HireView.aspx.cs" Inherits="HireView" %>
<html>
	<head>
    ...
    <div>    
     <table id="PrintHide" style="width: 100%" border="0" cellpadding="0" cellspacing="0">            
            <tr>
                ...
                <a class="hei" href="../Main/MyDesk.aspx">桌面</a>&nbsp;>>&nbsp;人才招聘信息管理&nbsp;>>&nbsp;查看人才招聘信息
                </td>
...
<table style="width: 100%" bgcolor="#999999" border="0" cellpadding="2" cellspacing="1">
	...
	<td style="padding-left: 5px; background-color: #ffffff" class="auto-style3" >
		<asp:label id="HireJobName" runat="server" Width="241px"></asp:label>
        </td></tr>
	<tr>
	<td style="background-color: #D6E2F3" align="right" class="auto-style2">
		岗位类型：
	...
	<td style="padding-left: 5px; background-color: #ffffff" class="auto-style3" >
		<asp:label ID="HireJobType" runat="server" CssClass="auto-style1" Height="35px" Width="241px">           
        </asp:label>
	...
	<td style="padding-left: 5px; background-color: #ffffff" class="auto-style3" >
		<asp:label ID="RequiredAmount" runat="server" CssClass="auto-style1" Height="35px" Width="241px">
        </asp:label></td>
          </tr>
	<tr>
	<td style="background-color: #D6E2F3" align="right" class="auto-style2">
	...
	<td style="padding-left: 5px; height: 25px; background-color: #ffffff" >
        ...
        <asp:label id="HireDetail" runat="server" ReadOnly="false" Width="241px" ></asp:label>
	</td>
         </tr>
	<tr>
	<td style="background-color: #D6E2F3" align="right" class="auto-style2">

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="HireMange.aspx.cs" Inherits="HireMange" %>
<html>
	<head>
    ...
    <div>    
     <table style="width: 100%" border="0" cellpadding="0" cellspacing="0">            
            <tr>
                ...
                <a class="hei" href="../Main/MyDesk.aspx">桌面</a>&nbsp;>>&nbsp;人才聘请信息管理&nbsp;
                </td>
        ...
        <table style="width: 100%">
            ...
            <td ><asp:GridView ID="GVData" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="招聘岗位名称">
                            <ItemTemplate>                                
                                <asp:HyperLink ID="HyperLink1" runat="server" Font-Underline="True"
                                    NavigateUrl='<%# "TechnologyPurchaseView.aspx?ID="+ DataBinder.Eval(Container.DataItem, "ID")%>'><%# DataBinder.Eval(Container.DataItem, "HireJobName")%></asp:HyperLink>
                            </ItemTemplate>                            
                            <ItemStyle HorizontalAlign="Left" />
                        
                        </asp:TemplateField> 
                        <asp:BoundField DataField="PubCompany" HeaderText="单位名称" >
                        </asp:BoundField>  
                        <asp:BoundField DataField="HireJobType" HeaderText="岗位类型" >
                        </asp:BoundField> 
                        <asp:BoundField DataField="PubTime" HeaderText="招聘信息发布时间" >
                        </asp:BoundField> 
                        <asp:BoundField DataField="RequiredProfession" HeaderText="要求专业" >
                        </asp:BoundField> 
                        <asp:BoundField DataField="RequiredAmount" HeaderText="招聘人数" >
                        </asp:BoundField> 
                        <asp:BoundField DataField="HireState" HeaderText="招聘信息状态" >
                        </asp:BoundField>  
                    </Columns>

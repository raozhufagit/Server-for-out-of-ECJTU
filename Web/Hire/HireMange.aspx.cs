...
public partial class HireMange : System.Web.UI.Page
{
    ...
    {
        LCX.BLL.Hire MyModel = new LCX.BLL.Hire();
        ...
        // }*/
        GVData.DataSource = MyModel.GetList(" HireJobName Like '%" + this.TextBox1.Text + "%' order by ID desc");
        GVData.DataBind();
    ...
    {
        Response.Redirect("HireAdd.aspx");
    }
    protected void ImageButton3_Click(object sender, ImageClickEventArgs e)
    {
        string IDlist = LCX.Common.PublicMethod.CheckCbx(this.GVData, "CheckSelect", "LabVisible");
        if (LCX.DBUtility.DbHelperSQL.ExecuteSQL("delete from Hire where ID in (" + IDlist + ")") == -1)
        {
    ...
    protected void ImageButton5_Click(object sender, ImageClickEventArgs e)
    {
        ...
        Response.Redirect("HireModify.aspx?ID=" + CheckStrArray[0].ToString());
    }
}
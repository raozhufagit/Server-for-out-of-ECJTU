...
public partial class HireAdd : System.Web.UI.Page
{
    ...
    protected void ImageButton1_Click(object sender, ImageClickEventArgs e)
    {
       ...
       LCX.BLL.LCXPinShen Approval = new LCX.BLL.LCXPinShen();
        Approval.ProjectName = model.HireJobName;
        Approval.ProjectSerils = model.HireState.ToString(); 
        ...
        Demand.DemandName = model.HireJobName;
        ...
        Demand.DemandState = model.HireState;
        ...
        MyRiZhi.DoSomething = "用户添加人才聘请信息(" + this.HireJobName.Text + ")";
        MyRiZhi.IpStr = System.Web.HttpContext.Current.Request.UserHostAddress.ToString();
        MyRiZhi.Add();

        LCX.Common.MessageBox.ShowAndRedirect(this, "人才聘请信息添加成功！", "HireMange.aspx?ProjectName= &TypeStr=我发布的人才聘请");
    }

...
namespace LCX.BLL
{
	...
	public class LCXCProduct
	{
        ...
        public LCXCProduct(int idstr)
		{
			...
			strSql.Append(" FROM LCXCProduct ");
		...
		return DbHelperSQL.GetMaxID("ID", "LCXCProduct"); 
		}
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select count(1) from LCXCProduct");
			strSql.Append(" where ID=@ID ");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into LCXCProduct(");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update LCXCProduct set ");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from LCXCProduct ");
			strSql.Append(" where ID=@ID ");
			SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)};
            parameters[0].Value = idstr;

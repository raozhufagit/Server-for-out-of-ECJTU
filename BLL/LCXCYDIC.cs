...
namespace LCX.BLL
{
	...
	public class LCXCYDIC
	{
		...
		return DbHelperSQL.GetMaxID("ID", "LCXCYDIC"); 
		}
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select count(1) from LCXCYDIC");
			strSql.Append(" where ID=@ID ");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into LCXCYDIC(");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update LCXCYDIC set ");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from LCXCYDIC ");
			strSql.Append(" where ID=@ID ");
			SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)};
            parameters[0].Value = idstr;

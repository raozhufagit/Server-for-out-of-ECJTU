...
namespace LCX.BLL
{
	...
	/// 类LCXCarPeccancy。
	/// </summary>
	public class LCXCarPeccancy
	{
		public LCXCarPeccancy()
		{}
		#region Model
		private int _id;
		...
		return DbHelperSQL.GetMaxID("ID", "LCXCarPeccancy"); 
		}
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select count(1) from LCXCarPeccancy");
			strSql.Append(" where ID=@ID ");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into LCXCarPeccancy(");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update LCXCarPeccancy set ");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from LCXCarPeccancy ");
			strSql.Append(" where ID=@ID ");
			SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)};
            parameters[0].Value = idstr;

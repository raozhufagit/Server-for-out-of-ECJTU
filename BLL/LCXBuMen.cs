...
namespace LCX.BLL
{
    ...
    public class LCXDept
    {
        ...
        public int GetMaxId()
        {
            ...
            return DbHelperSQL.GetMaxID("ID", "LCXDept");
        }
        ...
        public bool Exists(int idstr)
        {
            ...
            strSql.Append("select count(1) from LCXDept");
        ...
        /// 
        /// </summary>
        /// <param name="idstr">当前部门ID</param>
        /// <returns></returns>
        public bool childExists(int idstr)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select count(1) from LCXDept");
            strSql.Append(" where DirID=@ID ");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("insert into LCXDept(");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update LCXDept set ");

...
namespace LCX.BLL
{
    ...
    public class LCXPinShen
    {
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select count(1) from LCXPinShen");
            strSql.Append(" where ID=@ID ");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("insert into LCXPinShen(");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update LCXPinShen set ");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete LCXPinShen ");
            strSql.Append(" where ID=@ID ");
            SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)};
            parameters[0].Value = idstr;

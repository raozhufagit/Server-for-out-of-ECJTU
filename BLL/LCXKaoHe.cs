...
namespace LCX.BLL
{
	...
	public class LCXKaoHe
	{
		...
		return DbHelperSQL.GetMaxID("ID", "LCXKaoHe"); 
		}
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select count(1) from LCXKaoHe");
			strSql.Append(" where ID=@ID ");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into LCXKaoHe(");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update LCXKaoHe set ");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from LCXKaoHe ");
			strSql.Append(" where ID=@ID ");
			SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)};
			parameters[0].Value = ID;

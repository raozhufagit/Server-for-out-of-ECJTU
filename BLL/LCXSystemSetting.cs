...
namespace LCX.BLL
{
    ...
    /// 类LCXSystem_Set。
    /// </summary>
    public class LCXSystem_Set
    {
        public LCXSystem_Set()
        { }
        #region Model
        private int _id;
        ...
        public bool Exists(int idstr)
        {
            ...
            strSql.Append("select count(1) from LCXSystem_Set");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("insert into LCXSystem_Set(");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update LCXSystem_Set set ");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete LCXSystem_Set ");
            strSql.Append(" where ID=@ID ");
            SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)				};
            parameters[0].Value = idstr;
        ...
        public void GetModel()
        {
            ...
            strSql.Append(" FROM LCXSystem_Set ");            
            SqlParameter[] parameters = {};           

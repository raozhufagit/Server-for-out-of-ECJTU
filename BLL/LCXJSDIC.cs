...
namespace LCX.BLL
{
	...
	public class LCXJSDIC
	{
		...
		return DbHelperSQL.GetMaxID("ID", "LCXJSDIC"); 
		}
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select count(1) from LCXJSDIC");
			strSql.Append(" where ID=@ID ");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into LCXJSDIC(");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update LCXJSDIC set ");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from LCXJSDIC ");
			strSql.Append(" where ID=@ID ");
			SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)};
            parameters[0].Value = idstr;

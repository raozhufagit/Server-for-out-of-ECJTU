...
namespace LCX.BLL
{
    ...
    public class LCXWork_P
    {
        ...
        public bool Exists(int idstr)
        {
            ...
            strSql.Append("select count(1) from LCXWork_P");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("insert into LCXWork_P(");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update LCXWork_P set ");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete LCXWork_P ");
            strSql.Append(" where ID=@ID ");
            SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)				};
            parameters[0].Value = idstr;

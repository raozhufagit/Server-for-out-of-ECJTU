...
namespace LCX.BLL
{
    ...
    /// 类LCXGuDingJiLu。
    /// </summary>
    public class LCXGuDingJiLu
    {
        public LCXGuDingJiLu()
        { }
        #region Model
        private int _id;
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select count(1) from LCXGuDingJiLu");
            strSql.Append(" where ID=@ID ");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("insert into LCXGuDingJiLu(");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update LCXGuDingJiLu set ");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete from LCXGuDingJiLu ");
            strSql.Append(" where ID=@ID ");
            SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)};
            parameters[0].Value = idstr;

...
namespace LCX.BLL
{
    ...
    /// 类LCXTalkOnlineUser。
    /// </summary>
    public class LCXTalkOnlineUser
    {
        public LCXTalkOnlineUser()
        { }
        #region Model
        private int _id;
        ...
        public bool Exists(int idstr)
        {
            ...
            strSql.Append("select count(1) from LCXTalkOnlineUser");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("insert into LCXTalkOnlineUser(");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update LCXTalkOnlineUser set ");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete LCXTalkOnlineUser ");
            strSql.Append(" where ID=@ID ");
            SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)				};
            parameters[0].Value = idstr;
        ...
        public void GetModel(int idstr)
        {
            ...
            strSql.Append(" FROM LCXTalkOnlineUser ");
            strSql.Append(" where ID=@ID ");
            SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)				};
            parameters[0].Value = idstr;

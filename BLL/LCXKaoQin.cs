...
namespace LCX.BLL
{
    ...
    /// 类LCXAttendance。
    /// </summary>
    public class LCXAttendance
    {
        public LCXAttendance()
        { }
        #region Model
        private int _id;
        ...
        public bool Exists(int idstr)
        {
            ...
            strSql.Append("select count(1) from LCXAttendance");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("insert into LCXAttendance(");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update LCXAttendance set ");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete LCXAttendance ");
            strSql.Append(" where ID=@ID ");
            SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)				};
            parameters[0].Value = idstr;
        ...
        public void GetModel(int idstr)
        {
            ...
            strSql.Append(" FROM LCXAttendance ");
            strSql.Append(" where ID=@ID ");
            SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)				};
            parameters[0].Value = idstr;

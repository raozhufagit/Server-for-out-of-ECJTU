...
namespace LCX.BLL
{
    ...
    public class LCXMobile
    {
        ...
        public bool Exists(int idstr)
        {
            ...
            strSql.Append("select count(1) from LCXMobile");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("insert into LCXMobile(");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update LCXMobile set ");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete LCXMobile ");
            strSql.Append(" where ID=@ID ");
            SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)				};
            parameters[0].Value = idstr;

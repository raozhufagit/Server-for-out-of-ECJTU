...
namespace LCX.BLL
{
    ...
    /// 类LCXQuestionType。
    /// </summary>
    public class LCXQuestionType
    {
        public LCXQuestionType()
        { }
        #region Model
        private int _id;
        ...
        /// 得到一个对象实体
        /// </summary>
        public LCXQuestionType(int idstr)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select ID,TiKuName,PaiXu ");
            strSql.Append(" FROM LCXQuestionType ");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select count(1) from LCXQuestionType");
            strSql.Append(" where ID=@ID ");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("insert into LCXQuestionType(");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update LCXQuestionType set ");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete from LCXQuestionType ");
            strSql.Append(" where ID=@ID ");
            SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)};
            parameters[0].Value = idstr;

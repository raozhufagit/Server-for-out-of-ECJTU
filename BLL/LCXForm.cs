...
namespace LCX.BLL
{
    ...
    public class LCXForm
    {
        ...
        public bool Exists(int ID)
        {
            ...
            strSql.Append("select count(1) from LCXForm");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("insert into LCXForm(");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update LCXForm set ");

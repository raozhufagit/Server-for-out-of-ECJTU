...
namespace LCX.BLL
{
	...
	/// 类LCXTrainXiaoGuo。
	/// </summary>
	public class LCXTrainXiaoGuo
	{
		public LCXTrainXiaoGuo()
		{}
		#region Model
		private int _id;
		...
		return DbHelperSQL.GetMaxID("ID", "LCXTrainXiaoGuo"); 
		}
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select count(1) from LCXTrainXiaoGuo");
			strSql.Append(" where ID=@ID ");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into LCXTrainXiaoGuo(");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update LCXTrainXiaoGuo set ");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from LCXTrainXiaoGuo ");
			strSql.Append(" where ID=@ID ");
			SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)};
            parameters[0].Value = idstr;

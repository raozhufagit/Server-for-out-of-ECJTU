...
namespace LCX.BLL
{
	...
	public class LCXSongYang
	{
        ...
        public LCXSongYang(int idstr)
		{
			...
			strSql.Append(" FROM LCXSongYang ");
		...
		return DbHelperSQL.GetMaxID("ID", "LCXSongYang"); 
		}
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select count(1) from LCXSongYang");
			strSql.Append(" where ID=@ID ");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into LCXSongYang(");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update LCXSongYang set ");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete LCXSongYang ");
			strSql.Append(" where ID=@ID ");
			SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)};
            parameters[0].Value = idstr;

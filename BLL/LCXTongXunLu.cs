...
namespace LCX.BLL
{
    ...
    public class LCXMail_List
    {
        ...
        public bool Exists(int idstr)
        {
            ...
            strSql.Append("select count(1) from LCXMail_List");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("insert into LCXMail_List(");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update LCXMail_List set ");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete LCXMail_List ");
            strSql.Append(" where ID=@ID ");
            SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)				};
            parameters[0].Value = idstr;
        ...
        public void GetModel(int idstr)
        {
            ...
            strSql.Append(" FROM LCXMail_List ");
            strSql.Append(" where ID=@ID ");
            SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)				};
            parameters[0].Value = idstr;

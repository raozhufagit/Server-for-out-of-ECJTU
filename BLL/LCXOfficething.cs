...
namespace LCX.BLL
{
    ...
    /// 类LCXOfficething。
    /// </summary>
    public class LCXOfficething
    {
        public LCXOfficething()
        { }
        #region Model
        private int _id;
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select count(1) from LCXOfficething");
            strSql.Append(" where ID=@ID ");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("insert into LCXOfficething(");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update LCXOfficething set ");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete from LCXOfficething ");
            strSql.Append(" where ID=@ID ");
            SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)};
            parameters[0].Value = ID;

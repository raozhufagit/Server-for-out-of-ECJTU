...
namespace LCX.BLL
{
	...
	public class LCXInterView
	{
        ...
        public LCXInterView(int idstr)
		{
			...
			strSql.Append(" FROM LCXInterView ");
		...
		return DbHelperSQL.GetMaxID("ID", "LCXInterView"); 
		}
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select count(1) from LCXInterView");
			strSql.Append(" where ID=@ID ");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into LCXInterView(");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update LCXInterView set ");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from LCXInterView ");
			strSql.Append(" where ID=@ID ");
			SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)};
            parameters[0].Value = idstr;

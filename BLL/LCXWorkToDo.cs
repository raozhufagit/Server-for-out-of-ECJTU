...
namespace LCX.BLL
{
    ...
    public class LCXWorkToDo
    {
        ...
        public bool Exists(int ID)
        {
            ...
            strSql.Append("select count(1) from LCXWorkToDo");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("insert into LCXWorkToDo(");
            strSql.Append("WorkName,FormName,UserName,TimeStr,WorkFlowID,FormContent,FuJianList,ShenPiYiJian,JieDianID,JieDianName,ShenPiUserList,TongGuoRenList,StateNow)");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update LCXWorkToDo set ");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete LCXWorkToDo ");
            strSql.Append(" where ID=" + ID + " ");
            SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)				};
            parameters[0].Value = ID;
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select ID,WorkName,FormName,UserName,TimeStr,WorkFlowID,FormContent,FuJianList,ShenPiYiJian,JieDianID,JieDianName,ShenPiUserList,TongGuoRenList,StateNow ");
            strSql.Append(" FROM LCXWorkToDo ");
            strSql.Append(" where ID=" + ID + " ");
            SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)				};
            parameters[0].Value = ID;

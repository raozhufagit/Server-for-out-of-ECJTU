...
namespace LCX.BLL
{
	...
	/// 类LCXC_FeedBack。
	/// </summary>
	public class LCXC_FeedBack
	{
		public LCXC_FeedBack()
		{}
		#region Model
		private int _id;
		...
		/// 得到一个对象实体
		/// </summary>
        public LCXC_FeedBack(int idstr)
		{
			...
			strSql.Append(" FROM LCXC_FeedBack ");
		...
		return DbHelperSQL.GetMaxID("ID", "LCXC_FeedBack"); 
		}
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select count(1) from LCXC_FeedBack");
			strSql.Append(" where ID=@ID ");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into LCXC_FeedBack(");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update LCXC_FeedBack set ");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete LCXC_FeedBack ");
			strSql.Append(" where ID=@ID ");
			SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)};
            parameters[0].Value = idstr;

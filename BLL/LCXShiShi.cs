...
namespace LCX.BLL
{
    ...
    public class LCXShiShi
    {
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select count(1) from LCXShiShi");
            strSql.Append(" where ID=@ID ");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("insert into LCXShiShi(");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update LCXShiShi set ");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete LCXShiShi ");
            strSql.Append(" where ID=@ID ");
            SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)};
            parameters[0].Value = idstr;

...
namespace LCX.BLL
{
    ...
    public class LCXVote
    {
        ...
        public bool Exists(int idstr)
        {
            ...
            strSql.Append("select count(1) from LCXVote");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("insert into LCXVote(");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update LCXVote set ");

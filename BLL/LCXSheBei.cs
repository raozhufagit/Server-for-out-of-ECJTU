...
namespace LCX.BLL
{
	...
	public class LCXSheBei
	{
        ...
        private string _leaseStates;//租赁状态
        /// <summary>
        /// 
        /// </summary>
        public int ID
        ...
        ///租赁状态
        /// </summary>
        public string LeaseStates
        {
            set { _leaseStates = value; }
            get { return _leaseStates; }
        }
        #endregion Model
        ...
        public LCXSheBei(int idstr)
		{
			...
			if(ds.Tables[0].Rows.Count>0)
			{
                ...
                LeaseStates= ds.Tables[0].Rows[0]["LeaseStates"].ToString();
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select count(1) from LCXSheBei");
			strSql.Append(" where ID=@ID ");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into LCXSheBei(");
			...
			SqlParameter[] parameters = {
                    ...
                    new SqlParameter("@LeaseStates",SqlDbType.VarChar,10)};
            ...
            parameters[38].Value = LeaseStates;
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update LCXSheBei set ");
            ...
            strSql.Append("@LeaseStates=LeaseStates ");
			strSql.Append(" where ID=@ID ");
			SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4),
					new SqlParameter("@SheBeiName", SqlDbType.VarChar,50),
            ...
            parameters[39].Value = LeaseStates;
		...
		public int UpdateS()
        {
            ...
            SqlParameter[] parameters = {
                    ...
                    new SqlParameter("@LeaseStates",SqlDbType.VarChar,10)};
            parameters[0].Value = ID;
            parameters[1].Value = LeaseStates;
            return DbHelperSQL.ExecuteSql(strSql.ToString(), parameters);
        }
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from LCXSheBei ");
			strSql.Append(" where ID=@ID ");
			SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)};
            parameters[0].Value = idstr;

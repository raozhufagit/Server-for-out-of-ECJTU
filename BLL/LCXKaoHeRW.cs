...
namespace LCX.BLL
{
	...
	public class LCXKaoHeRW
	{
		...
		return DbHelperSQL.GetMaxID("ID", "LCXKaoHeRW"); 
		}
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select count(1) from LCXKaoHeRW");
			strSql.Append(" where ID=@ID ");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into LCXKaoHeRW(");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update LCXKaoHeRW set ");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from LCXKaoHeRW ");
			strSql.Append(" where ID=@ID ");
			SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)};
			parameters[0].Value = ID;

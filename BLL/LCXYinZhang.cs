...
namespace LCX.BLL
{
    ...
    public class LCXSeal
    {
        ...
        public bool Exists(int idstr)
        {
            ...
            strSql.Append("select count(1) from LCXSeal");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("insert into LCXSeal(");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update LCXSeal set ");

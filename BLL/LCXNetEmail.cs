...
namespace LCX.BLL
{
    ...
    public class LCXNetEmail
    {
        ...
        public bool Exists(int idstr)
        {
            ...
            strSql.Append("select count(1) from LCXNetEmail");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("insert into LCXNetEmail(");
            strSql.Append("EmailTitle,TimeStr,EmailContent,FuJian,FromUser,ToUser,EmailState)");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update LCXNetEmail set ");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete LCXNetEmail ");
            strSql.Append(" where ID=@ID ");
            SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)				};
            parameters[0].Value = idstr;
        ...
        public void GetModel(int idstr)
        {
            ...
            strSql.Append(" FROM LCXNetEmail ");
            strSql.Append(" where ID=@ID ");
            SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)				};
            parameters[0].Value = idstr;

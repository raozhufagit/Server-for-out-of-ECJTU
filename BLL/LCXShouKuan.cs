...
namespace LCX.BLL
{
    ...
    public class LCXShouKuan
    {
        ...
        public LCXShouKuan(int idstr)
        {
            ...
            strSql.Append(" FROM LCXShouKuan ");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select count(1) from LCXShouKuan");
            strSql.Append(" where ID=@ID ");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("insert into LCXShouKuan(");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update LCXShouKuan set ");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete LCXShouKuan ");
            strSql.Append(" where ID=@ID ");
            SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)};
            parameters[0].Value = idstr;

...
namespace LCX.BLL
{
	...
	public class LCXLinkMan
	{
		...
		return DbHelperSQL.GetMaxID("ID", "LCXLinkMan"); 
		}
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select count(1) from LCXLinkMan");
			strSql.Append(" where ID=@ID ");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into LCXLinkMan(");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update LCXLinkMan set ");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete LCXLinkMan ");
			strSql.Append(" where ID=@ID ");
			SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)};
            parameters[0].Value = idstr;

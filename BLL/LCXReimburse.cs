...
namespace LCX.BLL
{
    public class LCXReimburse
    {
        ...
        public LCXReimburse(int idstr)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select * from LCXReimburse where ID=@ID ");
		...
		public int GetMaxId()
		{
            return DbHelperSQL.GetMaxID("ID", "LCXReimburse"); 
		}
		...
		{
			StringBuilder strSql=new StringBuilder();
            strSql.Append("select count(1) from LCXReimburse");
		...
		{
			StringBuilder strSql=new StringBuilder();
            strSql.Append("insert into LCXReimburse( ");
		...
		{
			StringBuilder strSql=new StringBuilder();
            strSql.Append("update LCXReimburse set ");
		...
		{
			StringBuilder strSql=new StringBuilder();
            strSql.Append("delete from LCXReimburse ");
			strSql.Append(" where ID=@ID ");
			SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)};
            parameters[0].Value = idstr;
        ...
        public void GetModel(int idstr)
		{
            ...
            strSql.Append(" from LCXReimburse ");
			strSql.Append(" where ID=@ID ");
			SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)};
            parameters[0].Value = idstr;

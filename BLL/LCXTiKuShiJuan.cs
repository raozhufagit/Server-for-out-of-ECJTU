...
namespace LCX.BLL
{
    ...
    /// 类LCXQuestionSJ。
    /// </summary>
    public class LCXQuestionSJ
    {
        public LCXQuestionSJ()
        { }
        #region Model
        private int _id;
        ...
        /// 得到一个对象实体
        /// </summary>
        public LCXQuestionSJ(int idstr)
        {
            ...
            strSql.Append(" FROM LCXQuestionSJ ");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select count(1) from LCXQuestionSJ");
            strSql.Append(" where ID=@ID ");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("insert into LCXQuestionSJ(");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update LCXQuestionSJ set ");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete from LCXQuestionSJ ");
            strSql.Append(" where ID=@ID ");
            SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)};
            parameters[0].Value = idstr;

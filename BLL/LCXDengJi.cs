...
namespace LCX.BLL
{
    ...
    public class LCXDengJi
    {
        ...
        public bool Exists(int ID)
        {
            ...
            strSql.Append("select count(1) from LCXDengJi");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("insert into LCXDengJi(");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update LCXDengJi set ");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete LCXDengJi ");
            strSql.Append(" where ID=" + ID + " ");
            SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)				};
            parameters[0].Value = ID;

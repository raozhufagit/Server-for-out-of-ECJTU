...
namespace LCX.BLL
{
    ...
    public class LCXProduct
    {
        ...
        public int GetMaxId()
        {
            ...
            return DbHelperSQL.GetMaxID("ID", "LCXProduct");
        }
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select count(1) from LCXProduct");
            strSql.Append(" where ID=@ID ");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("insert into LCXProduct(");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update LCXProduct set ");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete from LCXProduct ");
            strSql.Append(" where ID=@ID ");
            SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)};
            parameters[0].Value = idstr;

...
namespace LCX.BLL
{
    ...
    public class LCXMeet
    {
        ...
        public bool Exists(int idstr)
        {
            ...
            strSql.Append("select count(1) from LCXMeet");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("insert into LCXMeet(");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update LCXMeet set ");

...
namespace LCX.BLL
{
    ...
    public class LCXArrange
    {
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select count(1) from LCXArrange");
            strSql.Append(" where ID=@ID ");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("insert into LCXArrange(");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update LCXArrange set ");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete LCXArrange ");
            strSql.Append(" where ID=@ID ");
            SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)};
            parameters[0].Value = idstr;

...
namespace LCX.BLL
{
	...
	public class LCXCarJiaYou
	{
        ...
        public LCXCarJiaYou(int idstr)
		{
			...
			strSql.Append(" FROM LCXCarJiaYou ");
		...
		return DbHelperSQL.GetMaxID("ID", "LCXCarJiaYou"); 
		}
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select count(1) from LCXCarJiaYou");
			strSql.Append(" where ID=@ID ");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into LCXCarJiaYou(");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update LCXCarJiaYou set ");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from LCXCarJiaYou ");
			strSql.Append(" where ID=@ID ");
			SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)};
            parameters[0].Value = idstr;

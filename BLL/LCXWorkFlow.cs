...
namespace LCX.BLL
{
    ...
    public class LCXWorkFlow
    {
        ...
        public bool Exists(int ID)
        {
            ...
            strSql.Append("select count(1) from LCXWorkFlow");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("insert into LCXWorkFlow(");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update LCXWorkFlow set ");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete LCXWorkFlow ");
            strSql.Append(" where ID=" + ID + " ");
            SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)				};
            parameters[0].Value = ID;
        ...
        public void GetModel(int ID)
        {
            ...
            strSql.Append(" FROM LCXWorkFlow ");
            strSql.Append(" where ID=" + ID + " ");
            SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)				};
            parameters[0].Value = ID;

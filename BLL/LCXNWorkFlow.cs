...
namespace LCX.BLL
{
	...
	public class LCX_WorkFlow
	{
        ...
        public LCX_WorkFlow(int idstr)
		{
			...
			strSql.Append(" FROM LCX_WorkFlow ");
		...
		return DbHelperSQL.GetMaxID("ID", "LCX_WorkFlow"); 
		}
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select count(1) from LCX_WorkFlow");
			strSql.Append(" where ID=@ID ");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into LCX_WorkFlow(");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update LCX_WorkFlow set ");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from LCX_WorkFlow ");
			strSql.Append(" where ID=@ID ");
			SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)};
            parameters[0].Value = idstr;

...
namespace LCX.BLL
{
	...
	public class LCXTrainRiJi
	{
		...
		return DbHelperSQL.GetMaxID("ID", "LCXTrainRiJi"); 
		}
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select count(1) from LCXTrainRiJi");
			strSql.Append(" where ID=@ID ");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into LCXTrainRiJi(");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update LCXTrainRiJi set ");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from LCXTrainRiJi ");
			strSql.Append(" where ID=@ID ");
			SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)};
            parameters[0].Value = idstr;

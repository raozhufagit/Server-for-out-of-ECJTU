...
namespace LCX.BLL
{
    ...
    /// 类LCXCompany_Info。
    /// </summary>
    public class LCXCompany_Info
    {
        public LCXCompany_Info()
        { }
        #region Model
        private int _id;
        ...
        public bool Exists(int idstr)
        {
            ...
            strSql.Append("select count(1) from LCXCompany_Info");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("insert into LCXCompany_Info(");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update LCXCompany_Info set ");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete LCXCompany_Info ");
            strSql.Append(" where ID=@ID ");
            SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)				};
            parameters[0].Value = idstr;
        ...
        public void GetModel(int idstr)
        {
            ...
            strSql.Append(" FROM LCXCompany_Info ");
            strSql.Append(" where ID=@ID ");
            SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)				};
            parameters[0].Value = idstr;

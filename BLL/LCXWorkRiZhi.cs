...
namespace LCX.BLL
{
    ...
    public class LCXWork_Log
    {
        ...
        public bool Exists(int idstr)
        {
            ...
            strSql.Append("select count(1) from LCXWork_Log");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("insert into LCXWork_Log(");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update LCXWork_Log set ");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete LCXWork_Log ");
            strSql.Append(" where ID=@ID ");
            SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)				};
            parameters[0].Value = idstr;
        ...
        public void GetModel(int idstr)
        {
            ...
            strSql.Append(" FROM LCXWork_Log ");
            strSql.Append(" where ID=@ID ");
            SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)				};
            parameters[0].Value = idstr;

...
namespace LCX.BLL
{
	...
	/// 类LCXJiXiaoCanShu。
	/// </summary>
	public class LCXJiXiaoCanShu
	{
		public LCXJiXiaoCanShu()
		{}
		#region Model
		private int _id;
		...
		/// 得到一个对象实体
		/// </summary>
        public LCXJiXiaoCanShu(int idstr)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select ID,ItemName,BackInfo,UserName,TimeStr ");
			strSql.Append(" FROM LCXJiXiaoCanShu ");
		...
		return DbHelperSQL.GetMaxID("ID", "LCXJiXiaoCanShu"); 
		}
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select count(1) from LCXJiXiaoCanShu");
			strSql.Append(" where ID=@ID ");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into LCXJiXiaoCanShu(");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update LCXJiXiaoCanShu set ");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from LCXJiXiaoCanShu ");
			strSql.Append(" where ID=@ID ");
			SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)};
            parameters[0].Value = idstr;

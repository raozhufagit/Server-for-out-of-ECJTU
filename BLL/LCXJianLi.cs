...
namespace LCX.BLL
{
	...
	public class LCXJianLi
	{
		...
		return DbHelperSQL.GetMaxID("ID", "LCXJianLi"); 
		}
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select count(1) from LCXJianLi");
			strSql.Append(" where ID=@ID ");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into LCXJianLi(");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update LCXJianLi set ");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from LCXJianLi ");
			strSql.Append(" where ID=@ID ");
			SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)};
            parameters[0].Value = idstr;

...
namespace LCX.BLL
{
    ...
    public class LCXMoBan
    {
        ...
        public bool Exists(int ID)
        {
            ...
            strSql.Append("select count(1) from LCXMoBan");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("insert into LCXMoBan(");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update LCXMoBan set ");

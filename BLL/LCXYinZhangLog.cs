...
namespace LCX.BLL
{
    ...
    public class LCXSealLog
    {
        ...
        public bool Exists(int idstr)
        {
            ...
            strSql.Append("select count(1) from LCXSealLog");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("insert into LCXSealLog(");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update LCXSealLog set ");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete LCXSealLog ");
            strSql.Append(" where ID=@ID ");
            SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)				};
            parameters[0].Value = idstr;

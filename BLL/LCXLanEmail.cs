...
namespace LCX.BLL
{
    ...
    public class LCXLanEmail
    {
        ...
        public bool Exists(int idstr)
        {
            ...
            strSql.Append("select count(1) from LCXLanEmail");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("insert into LCXLanEmail(");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update LCXLanEmail set ");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete LCXLanEmail ");
            strSql.Append(" where ID=@ID ");
            SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)				};
            parameters[0].Value = idstr;
        ...
        public void GetModel(int idstr)
        {
            ...
            strSql.Append(" FROM LCXLanEmail ");
            strSql.Append(" where ID=@ID ");
            SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)				};
            parameters[0].Value = idstr;

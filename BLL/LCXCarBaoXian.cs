...
namespace LCX.BLL
{
	...
	public class LCXCarBX
	{
		...
		return DbHelperSQL.GetMaxID("ID", "LCXCarBX"); 
		}
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select count(1) from LCXCarBX");
			strSql.Append(" where ID=@ID ");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into LCXCarBX(");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update LCXCarBX set ");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from LCXCarBX ");
			strSql.Append(" where ID=@ID ");
			SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)};
            parameters[0].Value = idstr;

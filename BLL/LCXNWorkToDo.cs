...
namespace LCX.BLL
{
	...
	public class LCX_WorkToDo
	{
        ...
        public void UpdateBD()
        {
            ...
            strSql.Append("update LCX_WorkToDo set ");
		...
		/// 得到一个对象实体
		/// </summary>
        public LCX_WorkToDo(int idstr)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select ID,WorkName,FormID,WorkFlowID,UserName,TimeStr,FormContent,FuJianList,ShenPiYiJian,JieDianID,JieDianName,ShenPiUserList,OKUserList,StateNow,LateTime ");
			strSql.Append(" FROM LCX_WorkToDo ");
			strSql.Append(" where ID=@ID ");
			SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)};
		...
		return DbHelperSQL.GetMaxID("ID", "LCX_WorkToDo"); 
		}
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select count(1) from LCX_WorkToDo");
			strSql.Append(" where ID=@ID ");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into LCX_WorkToDo(");
			strSql.Append("WorkName,FormID,WorkFlowID,UserName,TimeStr,FormContent,FuJianList,ShenPiYiJian,JieDianID,JieDianName,ShenPiUserList,OKUserList,StateNow,LateTime)");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from LCX_WorkToDo ");
			strSql.Append(" where ID=@ID ");
			SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)};
            parameters[0].Value = idstr;
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 ID,WorkName,FormID,WorkFlowID,UserName,TimeStr,FormContent,FuJianList,ShenPiYiJian,JieDianID,JieDianName,ShenPiUserList,OKUserList,StateNow,LateTime ");
			strSql.Append(" FROM LCX_WorkToDo ");
			strSql.Append(" where ID=@ID ");
			SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)};

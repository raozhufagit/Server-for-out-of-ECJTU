...
namespace LCX.BLL
{
	...
	public class LCXKaoHeXM
	{
		...
		return DbHelperSQL.GetMaxID("ID", "LCXKaoHeXM"); 
		}
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select count(1) from LCXKaoHeXM");
			strSql.Append(" where ID=@ID ");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into LCXKaoHeXM(");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update LCXKaoHeXM set ");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from LCXKaoHeXM ");
			strSql.Append(" where ID=@ID ");
			SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)};
			parameters[0].Value = ID;

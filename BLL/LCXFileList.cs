...
namespace LCX.BLL
{
    ...
    public class LCXFileList
    {
        ...
        public LCXFileList(int idstr)
        {
            ...
            strSql.Append(" FROM LCXFileList ");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select count(1) from LCXFileList");
            strSql.Append(" where ID=@ID ");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("insert into LCXFileList(");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update LCXFileList set ");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete from LCXFileList ");
            strSql.Append(" where ID=@ID ");
            SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)};
            parameters[0].Value = idstr;

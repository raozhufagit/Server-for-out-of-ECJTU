...
namespace LCX.BLL
{
    ...
    public class LCXRedHead
    {
        ...
        public bool Exists(int idstr)
        {
            ...
            strSql.Append("select count(1) from LCXRedHead");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("insert into LCXRedHead(");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update LCXRedHead set ");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete LCXRedHead ");
            strSql.Append(" where ID=@ID ");
            SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)				};
            parameters[0].Value = idstr;

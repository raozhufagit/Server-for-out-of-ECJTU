...
namespace LCX.BLL
{
	...
	public class LCXComplaint
	{
        ...
        public LCXComplaint(int idstr)
		{
			...
			strSql.Append(" FROM LCXComplaint ");
		...
		return DbHelperSQL.GetMaxID("ID", "LCXComplaint"); 
		}
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select count(1) from LCXComplaint");
			strSql.Append(" where ID=@ID ");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into LCXComplaint(");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update LCXComplaint set ");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete LCXComplaint ");
			strSql.Append(" where ID=@ID ");
			SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)};
            parameters[0].Value = idstr;

...
namespace LCX.BLL
{
	...
	public class LCXCarWeiHu
	{
        ...
        public LCXCarWeiHu(int idstr)
		{
			...
			strSql.Append(" FROM LCXCarWeiHu ");
		...
		return DbHelperSQL.GetMaxID("ID", "LCXCarWeiHu"); 
		}
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select count(1) from LCXCarWeiHu");
			strSql.Append(" where ID=@ID ");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into LCXCarWeiHu(");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update LCXCarWeiHu set ");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from LCXCarWeiHu ");
			strSql.Append(" where ID=@ID ");
			SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)};
            parameters[0].Value = idstr;

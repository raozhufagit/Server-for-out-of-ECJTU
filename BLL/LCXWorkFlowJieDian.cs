...
namespace LCX.BLL
{
    ...
    /// 类LCXWorkFlowJieDian。
    /// </summary>
    public class LCXWorkFlowJieDian
    {
        public LCXWorkFlowJieDian()
        { }
        #region Model
        private int _id;
        ...
        public bool Exists(int ID)
        {
            ...
            strSql.Append("select count(1) from LCXWorkFlowJieDian");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("insert into LCXWorkFlowJieDian(");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update LCXWorkFlowJieDian set ");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete LCXWorkFlowJieDian ");
            strSql.Append(" where ID=" + ID + " ");
            SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)				};
            parameters[0].Value = ID;
        ...
        public void GetModel(int ID)
        {
            ...
            strSql.Append(" FROM LCXWorkFlowJieDian ");
            strSql.Append(" where ID=" + ID + " ");
            SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)				};
            parameters[0].Value = ID;

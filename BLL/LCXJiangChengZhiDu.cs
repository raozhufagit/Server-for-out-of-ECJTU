...
namespace LCX.BLL
{
	...
	/// 类LCXPunishmentZhiDu。
	/// </summary>
	public class LCXPunishmentZhiDu
	{
		public LCXPunishmentZhiDu()
		{}
		#region Model
		private int _id;
		...
		return DbHelperSQL.GetMaxID("ID", "LCXPunishmentZhiDu"); 
		}
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select count(1) from LCXPunishmentZhiDu");
			strSql.Append(" where ID=@ID ");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into LCXPunishmentZhiDu(");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update LCXPunishmentZhiDu set ");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from LCXPunishmentZhiDu ");
			strSql.Append(" where ID=@ID ");
			SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)};
            parameters[0].Value = idstr;

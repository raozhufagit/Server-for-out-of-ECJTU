...
namespace LCX.BLL
{
    ...
    public class LCXHuiBao
    {
        ...
        public bool Exists(int idstr)
        {
            ...
            strSql.Append("select count(1) from LCXHuiBao");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("insert into LCXHuiBao(");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update LCXHuiBao set ");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete LCXHuiBao ");
            strSql.Append(" where ID=@ID ");
            SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)				};
            parameters[0].Value = idstr;

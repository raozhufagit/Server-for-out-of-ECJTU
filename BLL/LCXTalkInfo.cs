...
namespace LCX.BLL
{
    ...
    public class LCXTalkInfo
    {
        ...
        public bool Exists(int idstr)
        {
            ...
            strSql.Append("select count(1) from LCXTalkInfo");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("insert into LCXTalkInfo(");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update LCXTalkInfo set ");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete LCXTalkInfo ");
            strSql.Append(" where ID=@ID ");
            SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)				};
            parameters[0].Value = idstr;
        ...
        public void GetModel(int idstr)
        {
            ...
            strSql.Append(" FROM LCXTalkInfo ");
            strSql.Append(" where ID=@ID ");
            SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)				};
            parameters[0].Value = idstr;

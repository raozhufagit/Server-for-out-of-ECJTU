...
namespace LCX.BLL
{
    ...
    public class LCXTreeList
    {
        ...
        public LCXTreeList(int idstr)
        {
            ...
            strSql.Append(" FROM LCXTreeList ");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select count(1) from LCXTreeList");
            strSql.Append(" where ID=@ID ");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("insert into LCXTreeList(");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update LCXTreeList set ");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete from LCXTreeList ");
            strSql.Append(" where ID=@ID ");
            SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)};
            parameters[0].Value = idstr;

...
namespace LCX.BLL
{
    ...
    public class LCXQuestion
    {
        ...
        public LCXQuestion(int idstr)
        {
            ...
            strSql.Append(" FROM LCXQuestion ");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select count(1) from LCXQuestion");
            strSql.Append(" where ID=@ID ");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("insert into LCXQuestion(");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update LCXQuestion set ");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete from LCXQuestion ");
            strSql.Append(" where ID=@ID ");
            SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)};
            parameters[0].Value = idstr;

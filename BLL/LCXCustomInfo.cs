...
namespace LCX.BLL
{
    ...
    /// 类LCXCustomInfo。
    /// </summary>
    public class LCXCustomInfo
    {
        public LCXCustomInfo()
        { }
        #region Model
        private int _id;
        ...
        /// 得到一个对象实体
        /// </summary>
        public LCXCustomInfo(int idstr)
        {
            ...
            strSql.Append(" FROM LCXCustomInfo ");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select count(1) from LCXCustomInfo");
            strSql.Append(" where ID=@ID ");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("insert into LCXCustomInfo(");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update LCXCustomInfo set ");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete from LCXCustomInfo ");
            strSql.Append(" where ID=@ID ");
            SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)};
            parameters[0].Value = idstr;

...
namespace LCX.BLL
{
    public class LCXContractImple
    {
        public LCXContractImple()
        { }
        #region  Model
        private int _id;
        ...
        /// 得到一个对象实体
        /// </summary>
        public LCXContractImple(int idstr)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select ID,ContractName,PhaseName,StartTime,EndTime,CompletionDegree,ChargePerson,SubmitPerson,SubmitTime,Remarks,Attachment");
            strSql.Append(" FROM LCXContractImple ");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select count(1) from LCXContractImple");
            strSql.Append(" where ID=@ID ");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("insert into LCXContractImple(");
            strSql.Append("ContractName,PhaseName,StartTime,EndTime,CompletionDegree,ChargePerson,SubmitPerson,SubmitTime,Remarks,Attachment)");
            ...
            parameters[0].Value = ContractName;
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update LCXContractImple set ");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete from LCXContractImple ");
            strSql.Append(" where ID=@ID ");
            SqlParameter[] parameters = {
                    new SqlParameter("@ID", SqlDbType.Int,4)};
            parameters[0].Value = idstr;
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select  top 1 ID,ContractName,PhaseName,StartTime,EndTime,CompletionDegree,ChargePerson,SubmitPerson,SubmitTime,Remarks,Attachment");
            strSql.Append(" FROM LCXContractImple ");
            strSql.Append(" where ID=@ID ");
            SqlParameter[] parameters = {
                    new SqlParameter("@ID", SqlDbType.Int,4)};

...
namespace LCX.BLL
{
    ...
    public class LCXRiZhi
    {
        ...
        public bool Exists(int idstr)
        {
            ...
            strSql.Append("select count(1) from LCXRiZhi");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("insert into LCXRiZhi(");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update LCXRiZhi set ");

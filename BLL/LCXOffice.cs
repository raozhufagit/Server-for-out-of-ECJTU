    ...
    public class LCXOffice
    {
        ...
        public LCXOffice(int idstr)
        {
            ...
            if (ds.Tables[0].Rows.Count > 0)
            {
                ...
                MinNum =Double.Parse(ds.Tables[0].Rows[0]["MinNum"].ToString());
                MaxNum = Double.Parse(ds.Tables[0].Rows[0]["MaxNum"].ToString());
                NowNum = Double.Parse(ds.Tables[0].Rows[0]["NowNum"].ToString());
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select count(1) from LCXOffice");
            strSql.Append(" where ID=@ID ");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("insert into LCXOffice(");
            ...
            SqlParameter[] parameters = {
					...
					new SqlParameter("@MinNum", SqlDbType.Float),
					new SqlParameter("@MaxNum", SqlDbType.Float),
					new SqlParameter("@NowNum", SqlDbType.Float),
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update LCXOffice set ");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete from LCXOffice ");
            strSql.Append(" where ID=@ID ");
            SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)};
            parameters[0].Value = idstr;
        ...
        /// 更新办公用品库存数量
        /// </summary>
        /// <param name="serils"></param>
        /// <param name="num"></param>
        public int UpdateNum(String serils,double num)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("Update LCXOffice set NowNum=(NowNum+@NowNum)");
            strSql.Append(" where Serils=@Serils ");
            SqlParameter[] parameters = {
					new SqlParameter("@NowNum", SqlDbType.Float),
                    new SqlParameter("@Serils", SqlDbType.VarChar,100)             
                                        };

...
namespace LCX.BLL
{
    ...
    /// 类LCXBookBorrow。
    /// </summary>
    public class LCXBookBorrow
    {
        public LCXBookBorrow()
        { }
        #region Model
        private int _id;
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select count(1) from LCXBookBorrow");
            strSql.Append(" where ID=@ID ");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("insert into LCXBookBorrow(");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update LCXBookBorrow set ");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete from LCXBookBorrow ");
            strSql.Append(" where ID=@ID ");
            SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)};
            parameters[0].Value = idstr;

...
namespace LCX.BLL
{
    ...
    public class LCXBBSCard
    {
        ...
        public bool Exists(int idstr)
        {
            ...
            strSql.Append("select count(1) from LCXBBSCard");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("insert into LCXBBSCard(");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update LCXBBSCard set ");            
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete LCXBBSCard ");
            strSql.Append(" where ID=@ID ");
            SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)				};
            parameters[0].Value = idstr;

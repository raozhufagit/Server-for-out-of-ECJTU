...
namespace LCX.BLL
{
	...
	/// 类LCXStudyXinDe。
	/// </summary>
	public class LCXStudyXinDe
	{
		public LCXStudyXinDe()
		{}
		#region Model
		private int _id;
		...
		return DbHelperSQL.GetMaxID("ID", "LCXStudyXinDe"); 
		}
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select count(1) from LCXStudyXinDe");
			strSql.Append(" where ID=@ID ");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into LCXStudyXinDe(");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update LCXStudyXinDe set ");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from LCXStudyXinDe ");
			strSql.Append(" where ID=@ID ");
			SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)};
            parameters[0].Value = idstr;

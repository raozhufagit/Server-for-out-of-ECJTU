...
namespace LCX.BLL
{
    ...
    /// 类LCXQuestionKSJG。
    /// </summary>
    public class LCXQuestionKSJG
    {
        public LCXQuestionKSJG()
        { }
        #region Model
        private int _id;
        ...
        /// 得到一个对象实体
        /// </summary>
        public LCXQuestionKSJG(int idstr)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select ID,KaoShiID,TiMuID,DaAn,UserDaAn,DeFen ");
            strSql.Append(" FROM LCXQuestionKSJG ");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select count(1) from LCXQuestionKSJG");
            strSql.Append(" where ID=@ID ");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("insert into LCXQuestionKSJG(");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update LCXQuestionKSJG set ");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete from LCXQuestionKSJG ");
            strSql.Append(" where ID=@ID ");
            SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)};
            parameters[0].Value = idstr;

...
namespace LCX.BLL
{
    public class LCXOutagreeImple
    {
        public LCXOutagreeImple()
        { }
        #region  Model
        private int _id;
        private string _outagreeName;//合同名称
        ...
        ///合同名称
        ///</summary>
        public string OutagreeName
        {
            set { _outagreeName = value; }
            get { return _outagreeName; }
        }
        ///<summary>
        ///阶段名称
        ///</summary>
        ...
        /// 得到一个对象实体
        /// </summary>
        public LCXOutagreeImple(int idstr)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select ID,OutagreeName,PhaseName,StartTime,EndTime,CompletionDegree,ChargePerson,SubmitPerson,SubmitTime,Remarks,Attachment");
            strSql.Append(" FROM LCXOutagreeImple ");
            ...
            if (ds.Tables[0].Rows.Count > 0)
            {
                ...
                OutagreeName = ds.Tables[0].Rows[0]["OutagreeName"].ToString();
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select count(1) from LCXOutagreeImple");
            strSql.Append(" where ID=@ID ");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("insert into LCXOutagreeImple(");
            strSql.Append("OutagreeName,PhaseName,StartTime,EndTime,CompletionDegree,ChargePerson,SubmitPerson,SubmitTime,Remarks,Attachment)");
            strSql.Append(" values (");
            strSql.Append("@OutagreeName,@PhaseName,@StartTime,@EndTime,@CompletionDegree,@ChargePerson,@SubmitPerson,@SubmitTime,@Remarks,@Attachment)");
            strSql.Append(";select @@IDENTITY");
            SqlParameter[] parameters = {
                    new SqlParameter("@OutagreeName", SqlDbType.VarChar,50),
            ...
            parameters[0].Value = OutagreeName;
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update LCXOutagreeImple set ");
            strSql.Append("OutagreeName=@OutagreeName,");
            ...
            parameters[1].Value = OutagreeName;
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete from LCXOutagreeImple ");
            strSql.Append(" where ID=@ID ");
            SqlParameter[] parameters = {
                    new SqlParameter("@ID", SqlDbType.Int,4)};
            parameters[0].Value = idstr;
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select  top 1 ID,OutagreeName,PhaseName,StartTime,EndTime,CompletionDegree,ChargePerson,SubmitPerson,SubmitTime,Remarks,Attachment");
            strSql.Append(" FROM LCXOutagreeImple ");
            strSql.Append(" where ID=@ID ");
            SqlParameter[] parameters = {
                    new SqlParameter("@ID", SqlDbType.Int,4)};

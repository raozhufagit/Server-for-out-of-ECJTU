...
namespace LCX.BLL
{
	...
	/// 类LCX_WorkFlowNode。
	/// </summary>
	public class LCX_WorkFlowNode
	{
		public LCX_WorkFlowNode()
		{}
		#region Model
		private int _id;
		...
		/// 得到一个对象实体
		/// </summary>
        public LCX_WorkFlowNode(int idstr)
		{
			...
			strSql.Append(" FROM LCX_WorkFlowNode ");
		...
		return DbHelperSQL.GetMaxID("ID", "LCX_WorkFlowNode"); 
		}
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select count(1) from LCX_WorkFlowNode");
			strSql.Append(" where ID=@ID ");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into LCX_WorkFlowNode(");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update LCX_WorkFlowNode set ");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from LCX_WorkFlowNode ");
			strSql.Append(" where ID=@ID ");
			SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)};
            parameters[0].Value = idstr;

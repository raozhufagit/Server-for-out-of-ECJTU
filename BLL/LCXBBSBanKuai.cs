...
namespace LCX.BLL
{
    ...
    /// 类LCXBBSSection。
    /// </summary>
    public class LCXBBSSection
    {
        public LCXBBSSection()
        { }
        #region Model
        private int _id;
        ...
        public bool Exists(int idstr)
        {
            ...
            strSql.Append("select count(1) from LCXBBSSection");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("insert into LCXBBSSection(");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update LCXBBSSection set ");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete LCXBBSSection ");
            strSql.Append(" where ID=@ID ");
            SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)				};
            parameters[0].Value = idstr;
        ...
        public void GetModel(int idstr)
        {
            ...
            strSql.Append(" FROM LCXBBSSection ");
            strSql.Append(" where ID=@ID ");
            SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)				};
            parameters[0].Value = idstr;

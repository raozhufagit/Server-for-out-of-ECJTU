...
namespace LCX.BLL
{
    ...
    public class LCXLiRun
    {
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select count(1) from LCXLiRun");
            strSql.Append(" where ID=@ID ");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("insert into LCXLiRun(");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update LCXLiRun set ");

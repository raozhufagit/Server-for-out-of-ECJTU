...
{
    /// <summary>
    /// 类LCXAttendanceSetting。
    /// </summary>
    public class LCXAttendanceSetting
    {
        public LCXAttendanceSetting()
        { }
        #region Model
        private int _id;
        ...
        public bool Exists(int idstr)
        {
            ...
            strSql.Append("select count(1) from LCXAttendanceSetting");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("insert into LCXAttendanceSetting(");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update LCXAttendanceSetting set ");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete LCXAttendanceSetting ");
            strSql.Append(" where ID=@ID ");
            SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)				};
            parameters[0].Value = idstr;
        ...
        public void GetModel(int idstr)
        {
            ...
            strSql.Append(" FROM LCXAttendanceSetting ");
            strSql.Append(" where ID=@ID ");
            SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)				};
            parameters[0].Value = idstr;

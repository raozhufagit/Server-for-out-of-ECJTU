...
namespace LCX.BLL
{
    ...
    public class LCXUserDesk
    {
        ...
        public bool Exists(int idstr)
        {
            ...
            strSql.Append("select count(1) from LCXUserDesk");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("insert into LCXUserDesk(");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update LCXUserDesk set ");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete LCXUserDesk ");
            strSql.Append(" where ID=@ID ");
            SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)				};
            parameters[0].Value = idstr;
        ...
        public void GetModel(int idstr)
        {
            ...
            strSql.Append(" FROM LCXUserDesk ");
            strSql.Append(" where ID=@ID ");
            SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)				};
            parameters[0].Value = idstr;

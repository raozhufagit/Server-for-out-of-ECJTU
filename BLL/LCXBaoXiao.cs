...
namespace LCX.BLL
{
    ...
    public class LCXBaoXiao
    {
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select count(1) from LCXBaoXiao");
            strSql.Append(" where ID=@ID ");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("insert into LCXBaoXiao(");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update LCXBaoXiao set ");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete LCXBaoXiao ");
            strSql.Append(" where ID=@ID ");
            SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)};
            parameters[0].Value = idstr;

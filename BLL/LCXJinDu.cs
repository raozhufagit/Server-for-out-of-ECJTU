...
namespace LCX.BLL
{
    ...
    public class LCXJinDu
    {
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select count(1) from LCXJinDu");
            strSql.Append(" where ID=@ID ");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("insert into LCXJinDu(");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update LCXJinDu set ");
